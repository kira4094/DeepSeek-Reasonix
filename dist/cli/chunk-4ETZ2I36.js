...
var EN = {
  ...
  ui: {
    ...
    systemPromptChangedDetail: "REASONIX.md or a memory file changed \u2014 the first turn will be a full cache miss. Use /new to start fresh with the updated context.",
  ...
  slash: {
    ...
    "max-tokens": {
      description: "cap output tokens per turn \u2014 limits runaway reasoning. Off by default. Bare shows status.",
      argsHint: "[N|off]"
    },
    diff: {
      description: "configure how edit_file / write_file diffs are displayed: summary (path +stats, default) \xB7 full (unified diff) \xB7 none (checkmark only)",
    ...
    "session-persist": {
      description: "toggle whether reasonix resumes the last session on launch. /session-persist off = always start fresh",
      argsHint: "<on|off>"
    },
    ...
    telegram: {
      description: "connect, inspect, or disconnect the Telegram channel for this session (first connect guides bot token setup)",
      argsHint: "[connect [botToken]|status|disconnect]"
    },
    weixin: {
      description: "connect, inspect, or disconnect the Weixin channel for this session (first connect uses iLink QR login)",
  ...
  app: {
    ...
    explicitPlanIntentArmed: "\u25B8 explicit plan-first request detected \u2014 strict lifecycle enabled. Use /plan off to leave.",
    lifecyclePlanSuggestion: "\u25B8 high-risk engineering task detected - use /plan strict to require an approved plan first.",
  ...
  loop: {
    ...
    iterLimitReached: "Reached the per-turn iteration cap ({max} tool-call rounds). Forcing a summary of what was gathered. Override with maxIterPerTurn in config or REASONIX_MAX_ITER env var."
  },
  errors: {
  ...
  handlers: {
    ...
    sessions: {
      ...
      persistSetOn: "\u25B8 session-persist set to on \u2014 next `reasonix code/chat` will resume the last session.",
      persistSetOff: "\u25B8 session-persist set to off \u2014 next launch starts fresh. Use -c/--continue to resume.",
    ...
    qq: {
      ...
      runtimeBound: "QQ temporarily bound this run to first sender {openid}. If you want this account to stay fixed, set it in QQ settings.",
    ...
    telegram: {
      ...
      promptBotToken: "Telegram setup: enter your bot token from BotFather, then press Enter. Type /cancel to abort.",
      ...
      status: "Telegram: {connected}, auto-start {enabled}, token {configured}, botToken {botToken}, access {access}, current mode {mode}.",
      ...
      lockAlreadyRunning: "Telegram channel is already running in process {pid}. Stop that process before starting another Telegram channel.",
      unauthorizedMessage: "Telegram ignored message from unauthorized user {userId}. Current access: {access}.",
      runtimeBound: "Telegram temporarily bound this run to first sender {userId}. Set `telegram.ownerUserId` in config to persist access.",
      missingBotToken: "Telegram bot token is required. Run `/telegram connect` to configure.",
      accessRequired: "Telegram requires access control before it can start. Set `telegram.ownerUserId` or `telegram.allowlist` in config.",
      rateLimited: "Telegram rate-limited authorized user {userId}: more than 5 messages in {seconds}s.",
      rateLimitedReply: "Telegram is receiving messages too quickly. Please wait {seconds}s before sending more."
    },
    weixin: {
      ...
      usage: "Usage: /weixin connect | /weixin connect manual [token accountId [baseUrl]] | /weixin status | /weixin disconnect",
      promptCredentials: "Weixin manual setup: enter iLink token and account id separated by a space, then press Enter. Type /cancel to abort.",
      ...
      status: "Weixin: {connected}, auto-start {enabled}, credentials {configured}, token {token}, account {accountId}, access {access}, current mode {mode}.",
      ...
      accessRuntime: "first-sender (runtime only, {owner})",
      accessRequiredShort: "access control required",
      lockAlreadyRunning: "Weixin channel is already running in process {pid}. Stop that process before starting another Weixin channel.",
      unauthorizedMessage: "Weixin ignored message from unauthorized user {userId}. Current access: {access}.",
      runtimeBound: "Weixin temporarily bound this run to first sender {userId}. Set `weixin.ownerUserId` in config to persist access.",
      ...
      accessRequired: "Weixin requires access control before it can start. Set `weixin.ownerUserId` or `weixin.allowlist` in config.",
      rateLimited: "Weixin rate-limited authorized user {userId}: more than 5 messages in {seconds}s."
    },
    admin: {
    ...
    model: {
      ...
      maxTokensNoCap: "max-tokens \u2192 no cap  (server default applies \xB7 /max-tokens <N> to set)",
      ...
      maxTokensUsage: "usage: /max-tokens <positive integer>   e.g. /max-tokens 4096  \xB7  /max-tokens off"
    },
    diff: {
    ...
    permissions: {
      ...
      addGlobalInfo: "\u25B8 added to global allowlist: {prefix}\n  \u2192 next `{prefix}` invocation runs without prompting in every project.",
      removeGlobalEmpty: "\u25B8 no global allowlist entries to remove.",
      clearGlobalConfirm: "about to drop {count} global allowlist entr{plural}. Re-run with the word 'confirm': /permissions clear --global confirm",
    ...
    webSearchEngine: {
      ...
      usageBingIntl: "  /search-engine bing-intl          use Bing international (www.bing.com, indexes GitHub/Wikipedia/Stack Overflow)",
      ...
      usageBaidu: "  /search-engine baidu               use Baidu AI Search API (free 1500/mo in Baidu docs \u2014 set BAIDU_API_KEY or QIANFAN_API_KEY)",
      ...
      switchedBaiduNote: " Set BAIDU_API_KEY, QIANFAN_API_KEY, or `baiduApiKey` in config; Baidu docs list 1500 free searches per month.",
  ...
  webErrors: {
    status: "web_search {status} \u2014 try: the search backend returned an error; rephrase the query, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    forbidden403: "web_search 403 \u2014 try: the search backend is blocking this client; switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama, or wait and retry later",
    ...
    bingBlocked: "web_search: Bing anti-bot page \u2014 rate-limited or blocked \u2014 try: wait 30s and retry, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    bingNoResults: "web_search: 0 results but response doesn't look like a real empty page ({chars} chars, first 120: {preview}) \u2014 try: rephrase the query with simpler terms, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    cannotReach: "web_search: Cannot reach SearXNG server at {endpoint} \u2014 try: install and start SearXNG (https://github.com/searxng/searxng, e.g. `docker run -d -p 8080:8080 searxng/searxng`), or switch to another engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    searxngNoResults: "web_search: 0 results but SearXNG response doesn't look like an empty results page ({chars} chars) \u2014 try: rephrase the query with simpler terms, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    metasoServerError: "web_search: Metaso server error ({status}) \u2014 try again later, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    baiduMissingKey: "web_search: Baidu AI Search requires an API key \u2014 set BAIDU_API_KEY or QIANFAN_API_KEY env var, configure `baiduApiKey` in ~/.reasonix/config.json, or run /search-engine baidu <key>. Get one from Baidu Cloud Qianfan.",
    baiduUnauthorized: "web_search: Baidu AI Search API key rejected \u2014 check BAIDU_API_KEY, QIANFAN_API_KEY, or `baiduApiKey`.",
    baiduRateLimit: "web_search: Baidu AI Search rate-limited or quota exceeded \u2014 wait and retry, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    baiduServerError: "web_search: Baidu AI Search server error ({status}) \u2014 try again later, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    baiduParseError: "web_search: Baidu AI Search returned an unparseable response (HTTP {status}) \u2014 try again later",
    ...
    tavilyRateLimit: "web_search: Tavily rate-limited or monthly quota exceeded \u2014 wait, switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama, or upgrade your Tavily plan",
    tavilyServerError: "web_search: Tavily server error ({status}) \u2014 try again later, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    perplexityRateLimit: "web_search: Perplexity rate-limited \u2014 wait and retry, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    perplexityServerError: "web_search: Perplexity server error ({status}) \u2014 try again later, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    exaServerError: "web_search: Exa server error ({status}) \u2014 try again later, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    braveServerError: "web_search: Brave Search server error ({status}) \u2014 try again later, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    braveParseError: "web_search: Brave Search returned unparseable response (HTTP {status}) \u2014 try again later",
    ollamaMissingKey: "Ollama requires an API key \u2014 set OLLAMA_API_KEY env var or `ollamaApiKey` in ~/.reasonix/config.json; get one at https://ollama.com/settings/keys",
    ollamaUnauthorized: "Ollama API key rejected \u2014 check OLLAMA_API_KEY or get one at https://ollama.com/settings/keys",
    ollamaRateLimit: "Ollama rate-limited or quota exceeded \u2014 wait and retry, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ollamaServerError: "Ollama server error ({status}) for {url} \u2014 try again later, or switch engine with /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ollamaParseError: "Ollama returned unparseable response (HTTP {status}) for {url} \u2014 try again later",
    fetchOllamaMissingKey: "web_fetch: Ollama fetch requires an API key \u2014 set OLLAMA_API_KEY env var or `ollamaApiKey` in ~/.reasonix/config.json; get one at https://ollama.com/settings/keys",
    fetchOllamaUnauthorized: "web_fetch: Ollama API key rejected \u2014 check OLLAMA_API_KEY or get one at https://ollama.com/settings/keys",
    fetchOllamaRateLimit: "web_fetch: Ollama fetch is rate-limited or quota exceeded \u2014 wait and retry",
    fetchOllamaServerError: "web_fetch: Ollama fetch server error ({status}) for {url} \u2014 try again later",
    fetchOllamaParseError: "web_fetch: Ollama fetch returned unparseable response (HTTP {status}) for {url} \u2014 try again later",
...
var JA = {
  ...
  run: {
    ...EN.run,
    missingApiKey: "DEEPSEEK_API_KEY \u304C\u8A2D\u5B9A\u3055\u308C\u3066\u304A\u3089\u305A\u3001stdin \u304C TTY \u3067\u306F\u3042\u308A\u307E\u305B\u3093\uFF08\u30D7\u30ED\u30F3\u30D7\u30C8\u3092\u8868\u793A\u3067\u304D\u307E\u305B\u3093\uFF09\u3002\n\u74B0\u5883\u5909\u6570\u3092\u8A2D\u5B9A\u3059\u308B\u304B\u3001`reasonix chat` \u3092\u4E00\u5EA6\u5BFE\u8A71\u7684\u306B\u5B9F\u884C\u3057\u3066\u30AD\u30FC\u3092\u4FDD\u5B58\u3057\u3066\u304F\u3060\u3055\u3044\u3002\n"
  },
  sessions: {
    ...EN.sessions,
    emptyHint: "\u4FDD\u5B58\u3055\u308C\u305F\u30BB\u30C3\u30B7\u30E7\u30F3\u306F\u307E\u3060\u3042\u308A\u307E\u305B\u3093 \u2014 `reasonix chat` \u3092\u5B9F\u884C\u3057\u3066\u304F\u3060\u3055\u3044\uFF08--no-session \u3092\u4ED8\u3051\u306A\u3044\u9650\u308A\u81EA\u52D5\u4FDD\u5B58\u3055\u308C\u307E\u3059\uFF09\u3002",
  ...
  ui: {
    ...
    taglineSub: "\u30AD\u30E3\u30C3\u30B7\u30E5\u30D5\u30A1\u30FC\u30B9\u30C8 \xB7 \u30D5\u30E9\u30C3\u30B7\u30E5\u30D5\u30A1\u30FC\u30B9\u30C8",
    ...
    openDashboardHint: "\u30B5\u30FC\u30D0\u30FC\u306E\u6E96\u5099\u304C\u3067\u304D\u6B21\u7B2C\u3001\u30C7\u30D5\u30A9\u30EB\u30C8\u30D6\u30E9\u30A6\u30B6\u3067\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9URL\u3092\u958B\u304D\u307E\u3059\u3002--no-dashboard \u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u308B\u5834\u5408\u306F\u4F55\u3082\u3057\u307E\u305B\u3093\u3002",
    dashboardPortHint: "\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u3092\u56FA\u5B9A\u30DD\u30FC\u30C8 (1\uFF5E65535) \u306B\u56FA\u5B9A\u3057\u307E\u3059\u3002\u518D\u8D77\u52D5\u5F8C\u3082\u5B89\u5B9A \u2014 SSH\u30C8\u30F3\u30CD\u30EB\u306B\u5FC5\u8981\u3002\u30C7\u30D5\u30A9\u30EB\u30C8: \u30A8\u30D5\u30A7\u30E1\u30E9\u30EB\u3002",
    dashboardPortInvalid: "\u25B2 --dashboard-port={value} \u3092\u7121\u8996\u3057\u307E\u3059\uFF081\uFF5E65535\u306E\u6574\u6570\u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\uFF09\u2014 \u30A8\u30D5\u30A7\u30E1\u30E9\u30EB\u306B\u30D5\u30A9\u30FC\u30EB\u30D0\u30C3\u30AF",
    dashboardAutoStartFailed: "\u25B2 \u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u306E\u81EA\u52D5\u8D77\u52D5\u306B\u5931\u6557\u3057\u307E\u3057\u305F ({reason}) \u2014 /dashboard \u3092\u8A66\u3059\u304B\u3001--no-dashboard \u3067\u6291\u5236\u3057\u3066\u304F\u3060\u3055\u3044",
    systemAppendHint: "\u30B3\u30FC\u30C9\u30B7\u30B9\u30C6\u30E0\u30D7\u30ED\u30F3\u30D7\u30C8\u306B\u6307\u793A\u3092\u8FFD\u52A0\u3057\u307E\u3059\u3002\u30C7\u30D5\u30A9\u30EB\u30C8\u30D7\u30ED\u30F3\u30D7\u30C8\u3092\u7F6E\u304D\u63DB\u3048\u308B\u306E\u3067\u306F\u306A\u304F\u3001\u305D\u306E\u5F8C\u308D\u306B\u8FFD\u52A0\u3057\u307E\u3059\u3002",
    systemAppendFileHint: "\u30B3\u30FC\u30C9\u30B7\u30B9\u30C6\u30E0\u30D7\u30ED\u30F3\u30D7\u30C8\u306B\u30D5\u30A1\u30A4\u30EB\u306E\u5185\u5BB9\u3092\u8FFD\u52A0\u3057\u307E\u3059\u3002\u30C7\u30D5\u30A9\u30EB\u30C8\u30D7\u30ED\u30F3\u30D7\u30C8\u306F\u7F6E\u304D\u63DB\u3048\u307E\u305B\u3093\u3002UTF-8\u3001cwd\u304B\u3089\u306E\u76F8\u5BFE\u30D1\u30B9\u307E\u305F\u306F\u7D76\u5BFE\u30D1\u30B9\u3002",
    resumedSession: '\u25B8 \u30BB\u30C3\u30B7\u30E7\u30F3 "{name}" \u3092\u518D\u958B\u3057\u307E\u3057\u305F\uFF08{count}\u4EF6\u306E\u65E2\u5B58\u30E1\u30C3\u30BB\u30FC\u30B8\uFF09\xB7 /new \u3067\u65B0\u898F\u958B\u59CB \xB7 /sessions \u3067\u7BA1\u7406',
    newSession: '\u25B8 \u30BB\u30C3\u30B7\u30E7\u30F3 "{name}" (\u65B0\u898F) \u2014 \u30C1\u30E3\u30C3\u30C8\u306B\u5FDC\u3058\u3066\u81EA\u52D5\u4FDD\u5B58 \xB7 /sessions \u3067\u540D\u524D\u5909\u66F4\u307E\u305F\u306F\u524A\u9664',
    ephemeralSession: "\u25B8 \u30A8\u30D5\u30A7\u30E1\u30E9\u30EB\u30C1\u30E3\u30C3\u30C8\uFF08\u30BB\u30C3\u30B7\u30E7\u30F3\u6C38\u7D9A\u5316\u306A\u3057\uFF09\u2014 --no-session \u3092\u5916\u3059\u3068\u6709\u52B9\u306B\u306A\u308A\u307E\u3059",
    restoredEdits: "\u25B8 \u4E2D\u65AD\u3055\u308C\u305F\u524D\u56DE\u306E\u5B9F\u884C\u304B\u3089 {count} \u4EF6\u306E\u4FDD\u7559\u4E2D\u7DE8\u96C6\u30D6\u30ED\u30C3\u30AF\u3092\u5FA9\u5143\u3057\u307E\u3057\u305F \u2014 /apply \u3067\u30B3\u30DF\u30C3\u30C8\u3001/discard \u3067\u7834\u68C4\u3002",
    resumedPlan: "\u30D7\u30E9\u30F3\u3092\u518D\u958B\u3057\u307E\u3057\u305F \xB7 {when}{summary}",
    tipEditBindings: {
      ...
      footer: "\u73FE\u5728\u306E\u30E2\u30FC\u30C9\u306F\u4E0B\u90E8\u30B9\u30C6\u30FC\u30BF\u30B9\u30D0\u30FC\u306B\u8868\u793A \xB7 /keys \u3067\u5168\u30EA\u30D5\u30A1\u30EC\u30F3\u30B9"
    },
    tipMouseClipboard: {
    ...
    keysReference: {
      ...
      sections: [
        {
          ...
          rows: [
            ...
            {
              key: "\u2191 / \u2193",
              text: "\u524D/\u6B21\u306E\u30D7\u30ED\u30F3\u30D7\u30C8\u5C65\u6B74 \xB7 \u8907\u6570\u884C\u30C9\u30E9\u30D5\u30C8\u3067\u306F\u30AB\u30FC\u30BD\u30EB\u4E0A\u4E0B"
            },
            ...
            { key: "Tab", text: "@\u30E1\u30F3\u30B7\u30E7\u30F3\u88DC\u5B8C \xB7 \u30D5\u30A9\u30EB\u30C0\u5C55\u958B \xB7 \u30B9\u30E9\u30C3\u30B7\u30E5\u30B3\u30DE\u30F3\u30C9\u78BA\u5B9A" },
            { key: "Shift+Tab", text: "\u7DE8\u96C6\u30B2\u30FC\u30C8: review \u2194 AUTO \u30E2\u30FC\u30C9\u5207\u66FF" },
            { key: "Esc", text: "\u30D4\u30C3\u30AB\u30FC\u3092\u9589\u3058\u308B \xB7 \u5B9F\u884C\u4E2D\u306E\u30E2\u30C7\u30EB\u30BF\u30FC\u30F3\u3092\u4E2D\u65AD" },
            {
              key: "Ctrl+C",
        ...
        },
        {
          ...
          rows: [
            ...
            {
              key: "\u30B3\u30D4\u30FC",
              text: "Ctrl+Shift+C (Win/Linux) \xB7 Cmd+C (macOS) \u2014 \u307E\u305F\u306F\u7AEF\u672B\u304C\u81EA\u52D5\u30B3\u30D4\u30FC\u3059\u308B\u5834\u5408\u3082\u3042\u308A\u307E\u3059"
            },
            { key: "\u8CBC\u308A\u4ED8\u3051", text: "Ctrl+V \u307E\u305F\u306F Ctrl+Shift+V (Win/Linux) \xB7 Cmd+V (macOS)" },
            {
              key: "\u30D6\u30E9\u30B1\u30C3\u30C8\u8CBC\u308A\u4ED8\u3051",
      ...
      footer: "\u307B\u3068\u3093\u3069\u306E\u7AEF\u672B\u3067\u30DB\u30A4\u30FC\u30EB\u30B9\u30AF\u30ED\u30FC\u30EB\u304C\u52D5\u4F5C\u3057\u307E\u3059\uFF08Web/\u30AF\u30E9\u30A6\u30C9/SSH\u542B\u3080\uFF09\u2014 SGR\u30DE\u30A6\u30B9\u30C8\u30E9\u30C3\u30AD\u30F3\u30B0\u306F\u30C7\u30D5\u30A9\u30EB\u30C8\u3067\u6709\u52B9\u3067\u3001\u30CD\u30A4\u30C6\u30A3\u30D6\u306E\u30C9\u30E9\u30C3\u30B0\u9078\u629E\u3084\u53F3\u30AF\u30EA\u30C3\u30AF\u3092\u59A8\u3052\u307E\u305B\u3093\u3002--no-mouse \u3067\u30AA\u30D7\u30C8\u30A2\u30A6\u30C8\u3002"
    },
    tipShownOnce: "\u4E00\u5EA6\u3060\u3051\u8868\u793A",
    ...
    yoloHint: "\u3053\u306E\u5B9F\u884C\u3067\u30D7\u30E9\u30F3\u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8\u3092\u81EA\u52D5\u627F\u8A8D\uFF08editMode=yolo \u76F8\u5F53\u3001\u8A2D\u5B9A\u306F\u5909\u66F4\u3057\u307E\u305B\u3093\uFF09"
  },
  code: {
    ...EN.code,
    workspaceConflict: "\u26A0 \u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u306B\u5225\u306E\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0\u306E\u30D5\u30A1\u30A4\u30EB ({platforms}) \u304C\u542B\u307E\u308C\u3066\u3044\u307E\u3059\u3002Reasonix Code \u304C\u305D\u308C\u3089\u3092\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30B3\u30F3\u30C6\u30F3\u30C4\u3068\u3057\u3066\u8AAD\u307F\u53D6\u308B\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002\u610F\u56F3\u3057\u306A\u3044\u5834\u5408\u306F --dir <your-project> \u3067\u518D\u8D77\u52D5\u3057\u3066\u304F\u3060\u3055\u3044\u3002\n",
    systemAppendEmpty: "--system-append \u304C\u7A7A\u3067\u3059 \u2014 \u30D7\u30ED\u30F3\u30D7\u30C8\u30C6\u30AD\u30B9\u30C8\u306F\u8FFD\u52A0\u3055\u308C\u307E\u305B\u3093\n",
    systemAppendFileReadError: '\u30A8\u30E9\u30FC: --system-append-file "{filePath}" \u3092\u8AAD\u307F\u53D6\u308C\u307E\u305B\u3093: {errorDetails}\n'
  },
  slash: {
    ...EN.slash,
    ...
    effort: {
      ...EN.slash.effort,
      description: "reasoning_effort \u306E\u4E0A\u9650 (low|medium|high|max); high \u306F vLLM/Azure \u3067\u5B89\u5168\u306A\u30C7\u30D5\u30A9\u30EB\u30C8",
      argsHint: "<low|medium|high|max>"
    },
    ...
    budget: {
      ...EN.slash.budget,
      description: "\u30BB\u30C3\u30B7\u30E7\u30F3USD\u4E0A\u9650 \u2014 80%\u3067\u8B66\u544A\u3001100%\u3067\u6B21\u306E\u30BF\u30FC\u30F3\u3092\u62D2\u5426\u3002\u30C7\u30D5\u30A9\u30EB\u30C8\u306F\u30AA\u30D5\u3002/budget \u5358\u4F53\u3067\u73FE\u5728\u306E\u72B6\u614B\u3092\u8868\u793A",
      argsHint: "[usd|off]"
    },
    mcp: {
      ...EN.slash.mcp,
    ...
    hooks: {
      ...EN.slash.hooks,
      description: "\u30A2\u30AF\u30C6\u30A3\u30D6\u306A\u30D5\u30C3\u30AF\u3092\u4E00\u89A7 (.reasonix/ \u4E0B\u306E settings.json) \xB7 reload \u3067\u30C7\u30A3\u30B9\u30AF\u304B\u3089\u518D\u8AAD\u8FBC",
      argsHint: "[reload]"
    },
    permissions: {
      ...EN.slash.permissions,
      description: "\u30B7\u30A7\u30EB\u8A31\u53EF\u30EA\u30B9\u30C8\u306E\u8868\u793A/\u7DE8\u96C6\uFF08\u30D3\u30EB\u30C8\u30A4\u30F3\u306F\u8AAD\u53D6\u5C02\u7528 \xB7 \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u6BCE: ~/.reasonix/config.json\uFF09",
      argsHint: "[list|add <prefix>|remove <prefix|N>|clear confirm]"
    },
    dashboard: {
      ...EN.slash.dashboard,
    ...
    stats: {
      ...EN.slash.stats,
      description: "\u30BB\u30C3\u30B7\u30E7\u30F3\u6A2A\u65AD\u306E\u30B3\u30B9\u30C8\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\uFF08\u4ECA\u65E5/\u9031/\u6708/\u5168\u671F\u9593 \xB7 \u30AD\u30E3\u30C3\u30B7\u30E5\u30D2\u30C3\u30C8 \xB7 Claude\u6BD4\u8F03\uFF09"
    },
    cost: {
      ...EN.slash.cost,
      description: "\u5F15\u6570\u306A\u3057 \u2192 \u524D\u56DE\u30BF\u30FC\u30F3\u306E\u6D88\u8CBB (Usage\u30AB\u30FC\u30C9); \u30C6\u30AD\u30B9\u30C8\u4ED8\u304D \u2192 \u305D\u306E\u30C6\u30AD\u30B9\u30C8\u3092\u9001\u4FE1\u3057\u305F\u5834\u5408\u306E\u30B3\u30B9\u30C8\u898B\u7A4D\u3082\u308A\uFF08\u6700\u60AA\u30B1\u30FC\u30B9 + \u30AD\u30E3\u30C3\u30B7\u30E5\u30D2\u30C3\u30C8\u60F3\u5B9A\uFF09",
      argsHint: "[text]"
    },
    doctor: {
      ...EN.slash.doctor,
    ...
    compact: {
      ...EN.slash.compact,
      description: "\u30ED\u30B0\u5185\u306E\u5927\u304D\u3059\u304E\u308B\u30C4\u30FC\u30EB\u7D50\u679C\u3068\u30C4\u30FC\u30EB\u547C\u3073\u51FA\u3057\u5F15\u6570\u3092\u7E2E\u5C0F; \u30C8\u30FC\u30AF\u30F3\u6570\u306E\u4E0A\u9650\u3001\u30C7\u30D5\u30A9\u30EB\u30C84000",
      argsHint: "[tokens]"
    },
    cwd: {
      ...EN.slash.cwd,
      description: "\u30BB\u30C3\u30B7\u30E7\u30F3\u4E2D\u306B\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u30EB\u30FC\u30C8\u3092\u5207\u308A\u66FF\u3048 \u2014 fs / shell / memory \u30C4\u30FC\u30EB\u306E\u5411\u304D\u5148\u3092\u5909\u66F4\u3001\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30D5\u30C3\u30AF\u3092\u518D\u8AAD\u8FBC\u3001@\u30E1\u30F3\u30B7\u30E7\u30F3\u306E\u30A6\u30A9\u30FC\u30AB\u30FC\u3092\u66F4\u65B0",
      argsHint: "[path]"
    },
    ...
    qq: {
      ...EN.slash.qq,
      description: "\u3053\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u306EQQ\u30C1\u30E3\u30F3\u30CD\u30EB\u3092\u63A5\u7D9A\u3001\u691C\u67FB\u3001\u307E\u305F\u306F\u5207\u65AD\uFF08\u521D\u56DE\u63A5\u7D9A\u6642\u306BApp ID / App Secret\u306E\u8A2D\u5B9A\u3092\u30AC\u30A4\u30C9\uFF09",
      argsHint: "[connect [appId appSecret [sandbox]]|status|disconnect]"
    },
    ...
    loop: {
      ...
      argsHint: "<5s..6h> <prompt>  \xB7  stop  \xB7  (\u5F15\u6570\u306A\u3057 = \u72B6\u614B\u8868\u793A)"
    },
    exit: { ...EN.slash.exit, description: "TUI\u3092\u7D42\u4E86" },
    init: {
      ...EN.slash.init,
      description: "\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3092\u30B9\u30AD\u30E3\u30F3\u3057\u3066\u30D9\u30FC\u30B9\u30E9\u30A4\u30F3\u306E REASONIX.md \u3092\u751F\u6210\uFF08\u30E2\u30C7\u30EB\u304C\u4F5C\u6210; /apply \u3067\u30EC\u30D3\u30E5\u30FC\uFF09\u3002`force` \u3067\u65E2\u5B58\u30D5\u30A1\u30A4\u30EB\u3092\u4E0A\u66F8\u304D\u3002",
      argsHint: "[force]"
    },
    apply: {
      ...EN.slash.apply,
      description: "\u4FDD\u7559\u4E2D\u306E\u7DE8\u96C6\u30D6\u30ED\u30C3\u30AF\u3092\u30C7\u30A3\u30B9\u30AF\u306B\u30B3\u30DF\u30C3\u30C8\uFF08\u5F15\u6570\u306A\u3057 \u2192 \u3059\u3079\u3066; `1`, `1,3`, `1-4` \u2192 \u305D\u306E\u30B5\u30D6\u30BB\u30C3\u30C8\u3001\u6B8B\u308A\u306F\u4FDD\u7559\uFF09",
      argsHint: "[N|N,M|N-M]"
    },
    discard: {
      ...EN.slash.discard,
    ...
    walk: {
      ...EN.slash.walk,
      description: "\u4FDD\u7559\u4E2D\u306E\u7DE8\u96C6\u30921\u30D6\u30ED\u30C3\u30AF\u305A\u3064\u78BA\u8A8D\uFF08git-add-p \u30B9\u30BF\u30A4\u30EB: \u30D6\u30ED\u30C3\u30AF\u3054\u3068\u306B y/n\u3001a \u3067\u6B8B\u308A\u3092\u9069\u7528\u3001A \u3067AUTO\u306B\u5207\u66FF\uFF09"
    },
    ...
    checkpoint: {
      ...EN.slash.checkpoint,
      description: "\u30BB\u30C3\u30B7\u30E7\u30F3\u304C\u89E6\u308C\u305F\u5168\u30D5\u30A1\u30A4\u30EB\u306E\u30B9\u30CA\u30C3\u30D7\u30B7\u30E7\u30C3\u30C8\uFF08Cursor\u30B9\u30BF\u30A4\u30EB\u306E\u5185\u90E8\u30B9\u30C8\u30A2\u3001git\u3067\u306F\u3042\u308A\u307E\u305B\u3093\uFF09\u3002/checkpoint \u5358\u4F53\u3067\u4E00\u89A7\u8868\u793A\u3002",
      argsHint: "[name|list|forget <id>]"
    },
    restore: {
      ...EN.slash.restore,
    ...
    mode: {
      ...EN.slash.mode,
      description: "\u7DE8\u96C6\u30B2\u30FC\u30C8: review\uFF08\u30AD\u30E5\u30FC\uFF09\xB7 auto\uFF08\u9069\u7528+\u53D6\u308A\u6D88\u3057\uFF09\xB7 yolo\uFF08\u9069\u7528+\u30B7\u30A7\u30EB\u81EA\u52D5\u5B9F\u884C\uFF09\u3002Shift+Tab\u3067\u5207\u308A\u66FF\u3048\u3002",
      argsHint: "[review|auto|yolo]"
    },
    jobs: {
      ...EN.slash.jobs,
    ...
    "search-engine": {
      description: "Web\u691C\u7D22\u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u3092\u5207\u308A\u66FF\u3048 \u2014 bing\uFF08\u30C7\u30D5\u30A9\u30EB\u30C8\u3001\u30D7\u30ED\u30AD\u30B7\u306A\u3057\u3067\u4E2D\u56FD\u304B\u3089\u5229\u7528\u53EF\uFF09\u3001bing-intl\uFF08\u56FD\u969B\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9\uFF09\u3001searxng\uFF08\u30BB\u30EB\u30D5\u30DB\u30B9\u30C8\uFF09\u3001metaso\uFF08\u7121\u6599100\u56DE/\u65E5\uFF09\u3001baidu\uFF08Baidu AI Search\u3001\u516C\u5F0F\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u3067\u306F1500\u56DE/\u6708\u7121\u6599\uFF09\u3001tavily\uFF08\u7121\u65991000\u56DE/\u6708\uFF09\u3001perplexity\uFF08AI\u30CD\u30A4\u30C6\u30A3\u30D6\uFF09\u3001exa\uFF08AI\u30CD\u30A4\u30C6\u30A3\u30D6\uFF09\u3001brave\uFF08\u72EC\u7ACB\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9\uFF09\u3001ollama\uFF08Ollama\u30AF\u30E9\u30A6\u30C9Web\u691C\u7D22\uFF09",
      argsHint: "<bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama> [<key>]"
    }
  },
  wizard: {
    ...
    apiKeyRejected: "DeepSeek\u304C\u3053\u306EAPI\u30AD\u30FC\u3092\u62D2\u5426\u3057\u307E\u3057\u305F\u3002\u6709\u52B9\u306A\u30AD\u30FC\u3092\u8CBC\u308A\u4ED8\u3051\u308B\u304B\u3001Esc\u3067\u30BB\u30C3\u30C8\u30A2\u30C3\u30D7\u3092\u30AD\u30E3\u30F3\u30BB\u30EB\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    apiKeyCheckFailed: "\u73FE\u5728\u3053\u306EAPI\u30AD\u30FC\u3092\u78BA\u8A8D\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F ({message})\u3002\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    apiKeyPreview: "\u30D7\u30EC\u30D3\u30E5\u30FC: {redacted}",
    themeTitle: "\u30C6\u30FC\u30DE\u3092\u9078\u629E",
    themeSubtitle: "\u64CD\u4F5C\u306B\u5FDC\u3058\u3066\u30D7\u30EC\u30D3\u30E5\u30FC\u304C\u30E9\u30A4\u30D6\u66F4\u65B0\u3055\u308C\u307E\u3059\u3002\u5F8C\u3067 /theme \u3067\u5909\u66F4\u53EF\u80FD\u3067\u3059\u3002",
    themeSampleHeading: "\u30B5\u30F3\u30D7\u30EB",
    themeFooter: "[\u2191\u2193] \u79FB\u52D5 \xB7 [Enter] \u78BA\u5B9A \xB7 [Esc] \u30AD\u30E3\u30F3\u30BB\u30EB",
    themeName: {
      graphite: "\u30B0\u30E9\u30D5\u30A1\u30A4\u30C8",
      ember: "\u30A8\u30F3\u30D0\u30FC",
      aurora: "\u30AA\u30FC\u30ED\u30E9",
    ...
    mcpFooterMulti: "[\u2191\u2193] \u79FB\u52D5  \xB7  [Space] \u5207\u66FF  \xB7  [Enter] \u78BA\u5B9A  \xB7  [Esc] \u30AD\u30E3\u30F3\u30BB\u30EB  \xB7  \u7A7A = \u30B9\u30AD\u30C3\u30D7",
    mcpArgsTitle: "{name} \u306E\u8A2D\u5B9A",
    mcpArgsDirMissing: "\u30C7\u30A3\u30EC\u30AF\u30C8\u30EA {path} \u304C\u5B58\u5728\u3057\u307E\u305B\u3093\u3002",
    mcpArgsDirCreateHint: "[Y/Enter] \u4F5C\u6210 (mkdir -p) \xB7 [N/Esc] \u5225\u306E\u30D1\u30B9\u3092\u5165\u529B",
    ...
    reviewFooter: "[Enter] \u4FDD\u5B58 \xB7 [Esc] \u30AD\u30E3\u30F3\u30BB\u30EB",
    savedTitle: "\u25B8 \u4FDD\u5B58\u3057\u307E\u3057\u305F\u3002",
    savedShellHint: "\u30E2\u30C7\u30EB\u304C\u5B9F\u884C\u3057\u305F\u3044\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u306F\u6BCE\u56DE\u78BA\u8A8D\u3055\u308C\u307E\u3059 \u2014 \u30D7\u30ED\u30F3\u30D7\u30C8\u3067 `allow always` \u3092\u9078\u629E\u3059\u308B\u3068\u3001\u305D\u306E\u30B3\u30DE\u30F3\u30C9\u3092\u3053\u306E\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3067\u8A31\u53EF\u3067\u304D\u307E\u3059\u3002\u8A2D\u8A08\u4E0A\u3001\u5168\u8A31\u53EF\u30D5\u30E9\u30B0\u306F\u3042\u308A\u307E\u305B\u3093\u3002",
    savedFooter: "[Enter] \u3067\u7D42\u4E86",
    selectFooter: "[\u2191\u2193] \u79FB\u52D5 \xB7 [Enter] \u78BA\u5B9A \xB7 [Esc] \u30AD\u30E3\u30F3\u30BB\u30EB",
    stepCounter: "\u30B9\u30C6\u30C3\u30D7 {step}/{total} \xB7 ",
    exitHint: "/exit \u3067\u4E2D\u65AD",
    apiKeyPlaceholder: "sk-...",
  ...
  themePicker: {
    ...EN.themePicker,
    header: "\u30C6\u30FC\u30DE",
    footer: "\u2191\u2193 \u9078\u629E \xB7 \u23CE \u78BA\u5B9A \xB7 esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    autoLabel: "\u81EA\u52D5",
    currentPref: "\u73FE\u5728\u306E\u8A2D\u5B9A",
    activeNow: "\u73FE\u5728\u9069\u7528\u4E2D",
  ...
  planFlow: {
    ...
    openQuestionsBanner: "\u25B2 \u30D7\u30E9\u30F3\u306B\u672A\u89E3\u6C7A\u306E\u8CEA\u554F\u307E\u305F\u306F\u30EA\u30B9\u30AF\u304C\u3042\u308A\u307E\u3059 \u2014 \u30E2\u30C7\u30EB\u304C\u9032\u3080\u524D\u306B {refine} \u3092\u9078\u3093\u3067\u5177\u4F53\u7684\u306A\u56DE\u7B54\u3092\u66F8\u3044\u3066\u304F\u3060\u3055\u3044\u3002",
    ...
    refineFooter: "\u23CE \u9001\u4FE1  \xB7  esc \u3067\u30D4\u30C3\u30AB\u30FC\u306B\u623B\u308B",
    ...
    stepList: {
      ...
      counterDone: "{done}/{total} \u5B8C\u4E86 ({pct}%) \xB7 {total} \u30B9\u30C6\u30C3\u30D7",
      counterDoneSingular: "{done}/{total} \u5B8C\u4E86 ({pct}%) \xB7 {total} \u30B9\u30C6\u30C3\u30D7"
    },
    ...
    detailScrollHint: "PgUp/PgDn \u3067\u8A73\u7D30\u30B9\u30AF\u30ED\u30FC\u30EB \xB7 Home/End \u3067\u30B8\u30E3\u30F3\u30D7",
    reviseTitle: "\u30D7\u30E9\u30F3\u3092\u7DE8\u96C6",
    reviseSteps: "{count} \u30B9\u30C6\u30C3\u30D7",
    reviseFooter: "\u2191\u2193 \u30D5\u30A9\u30FC\u30AB\u30B9  \xB7  space \u3067\u30B9\u30AD\u30C3\u30D7\u5207\u66FF  \xB7  k/j \u79FB\u52D5  \xB7  \u23CE \u78BA\u5B9A  \xB7  esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    riskMed: " \u4E2D",
    riskHigh: " \u9AD8",
    completeMsg: "\u25B8 \u30D7\u30E9\u30F3\u5B8C\u4E86 \u2014 \u5168 {total} \u30B9\u30C6\u30C3\u30D7\u5B8C\u4E86 \xB7 \u30A2\u30FC\u30AB\u30A4\u30D6\u6E08\u307F"
  },
  app: {
    ...EN.app,
    walkCancelledRemaining: "\u25B8 \u30A6\u30A9\u30FC\u30AF\u3092\u30AD\u30E3\u30F3\u30BB\u30EB\u3057\u307E\u3057\u305F \u2014 {count} \u30D6\u30ED\u30C3\u30AF\u304C\u307E\u3060\u4FDD\u7559\u4E2D\u3067\u3059\u3002",
    walkCancelled: "\u25B8 \u30A6\u30A9\u30FC\u30AF\u3092\u30AD\u30E3\u30F3\u30BB\u30EB\u3057\u307E\u3057\u305F\u3002",
    editModeYolo: "\u25B8 \u7DE8\u96C6\u30E2\u30FC\u30C9: YOLO \u2014 \u7DE8\u96C6\u3068\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u304C\u81EA\u52D5\u5B9F\u884C\u3055\u308C\u307E\u3059\u3002/undo \u3067\u7DE8\u96C6\u306E\u30ED\u30FC\u30EB\u30D0\u30C3\u30AF\u306F\u53EF\u80FD\u3067\u3059\u3002\u6CE8\u610F\u3057\u3066\u4F7F\u7528\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    editModeAuto: "\u25B8 \u7DE8\u96C6\u30E2\u30FC\u30C9: AUTO \u2014 \u7DE8\u96C6\u304C\u5373\u6642\u9069\u7528\u3055\u308C\u307E\u3059; 5\u79D2\u4EE5\u5185\u306B u \u3092\u62BC\u3059\u3068\u5143\u306B\u623B\u305B\u307E\u3059\uFF08\u30B9\u30DA\u30FC\u30B9\u3067\u30BF\u30A4\u30DE\u30FC\u4E00\u6642\u505C\u6B62\uFF09\u3002\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u306F\u78BA\u8A8D\u3042\u308A\u3002",
    ...
    checkpointSaved: "\u26C1 \u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8\u4FDD\u5B58 \xB7 {id} \xB7 {count} \u30D5\u30A1\u30A4\u30EB \xB7 /restore {id} \u3067\u3053\u306E\u30B9\u30C6\u30C3\u30D7\u3092\u30ED\u30FC\u30EB\u30D0\u30C3\u30AF",
    continuingAfter: "\u25B8 {label}{counter} \u306E\u5F8C\u306B\u7D9A\u884C",
    planStoppedAt: "\u25B8 {label}{counter} \u3067\u30D7\u30E9\u30F3\u3092\u505C\u6B62",
    revisingAfter: "\u25B8 {label} \u306E\u5F8C\u306B\u4FEE\u6B63 \u2014 {feedback}",
    explicitPlanIntentArmed: "\u25B8 \u660E\u793A\u7684\u306A plan-first \u30EA\u30AF\u30A8\u30B9\u30C8\u3092\u691C\u51FA \u2014 strict lifecycle \u3092\u6709\u52B9\u5316\u3057\u307E\u3057\u305F\u3002/plan off \u3067\u7D42\u4E86\u3067\u304D\u307E\u3059\u3002",
    lifecyclePlanSuggestion: "\u25B8 \u9AD8\u30EA\u30B9\u30AF\u306E\u30A8\u30F3\u30B8\u30CB\u30A2\u30EA\u30F3\u30B0\u4F5C\u696D\u3092\u691C\u51FA - /plan strict \u3067\u627F\u8A8D\u6E08\u307F\u30D7\u30E9\u30F3\u3092\u5148\u306B\u8981\u6C42\u3067\u304D\u307E\u3059\u3002",
    historyScrollHint: " \u2191 \u5C65\u6B74\u3092\u8AAD\u8FBC\u4E2D \xB7 End / PgDn \u3067\u6700\u4E0B\u90E8\u306B\u623B\u308B \xB7 \u2193 \u30671\u884C\u9032\u3080",
    editHistoryTitle: "\u7DE8\u96C6\u5C65\u6B74\uFF08\u53E4\u3044\u9806\uFF09:",
    editHistoryNoCodeMode: "\u30B3\u30FC\u30C9\u30E2\u30FC\u30C9\u3067\u306F\u3042\u308A\u307E\u305B\u3093",
    editHistoryNoEdits: "\u3053\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u3067\u306F\u307E\u3060\u7DE8\u96C6\u304C\u8A18\u9332\u3055\u308C\u3066\u3044\u307E\u305B\u3093",
    editHistoryNoShowId: "\u4F7F\u3044\u65B9: /show [id] [path]   \uFF08id\u3092\u7701\u7565\u3059\u308B\u3068\u6700\u65B0; path \u306F\u30D5\u30A1\u30A4\u30EB\u5225\u30B5\u30DE\u30EA\u30FC\u304B\u3089\uFF09",
    ...
    editHistoryHelpShow: "/show <id>            \u2192 \u30D5\u30A1\u30A4\u30EB\u5225\u30B5\u30DE\u30EA\u30FC    \xB7    /show <id> <path>  \u2192 1\u30D5\u30A1\u30A4\u30EB\u306E\u5B8C\u5168\u306A\u5DEE\u5206",
    editHistoryHelpUndo: "/undo                 \u2192 \u6700\u65B0\u306E\u672A\u53D6\u308A\u6D88\u3057   \xB7    /undo <id> [path]  \u2192 \u7279\u5B9A\u306E\u30D0\u30C3\u30C1\u307E\u305F\u306F\u30D5\u30A1\u30A4\u30EB\u3092\u5BFE\u8C61",
    ...
    noPendingEdits: "\u4FDD\u7559\u4E2D\u306E\u7DE8\u96C6\u306F\u3042\u308A\u307E\u305B\u3093 \u2014 \u6700\u5F8C\u306E /apply \u307E\u305F\u306F /discard \u4EE5\u964D\u3001\u30E2\u30C7\u30EB\u306F\u7DE8\u96C6\u3092\u63D0\u6848\u3057\u3066\u3044\u307E\u305B\u3093\u3002",
    noMatchedApply: "\u25B8 \u3069\u306E\u7DE8\u96C6\u3082\u305D\u308C\u3089\u306E\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9\u306B\u4E00\u81F4\u3057\u307E\u305B\u3093\u3067\u3057\u305F \u2014 \u4F55\u3082\u9069\u7528\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002\u5F15\u6570\u306A\u3057\u306E /apply \u3067\u3059\u3079\u3066\u30B3\u30DF\u30C3\u30C8\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    noPendingDiscard: "\u7834\u68C4\u3059\u308B\u4FDD\u7559\u4E2D\u306E\u7DE8\u96C6\u306F\u3042\u308A\u307E\u305B\u3093\u3002",
    noMatchedDiscard: "\u25B8 \u3069\u306E\u7DE8\u96C6\u3082\u305D\u308C\u3089\u306E\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9\u306B\u4E00\u81F4\u3057\u307E\u305B\u3093\u3067\u3057\u305F \u2014 \u4F55\u3082\u7834\u68C4\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002",
    blocksStillPending: "\u25B8 {count} \u4EF6\u306E\u7DE8\u96C6\u30D6\u30ED\u30C3\u30AF\u304C\u307E\u3060\u4FDD\u7559\u4E2D\u3067\u3059 \u2014 /apply \u307E\u305F\u306F /discard \u3067\u30AF\u30EA\u30A2\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    ...
    sidecarHint: "\uFF08\u30BB\u30C3\u30B7\u30E7\u30F3\u306F\u6700\u521D\u306E\u30BF\u30FC\u30F3\u3067\u30B5\u30A4\u30C9\u30AB\u30FC\u3092\u81EA\u52D5\u4F5C\u6210\u3057\u307E\u3059 \u2014 \u3053\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u306F\u307E\u3060\u5B9F\u884C\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u304B\uFF1F\uFF09"
  },
  hooks: {
    ...EN.hooks,
  ...
  summary: {
    ...EN.summary,
    status: "\u53CE\u96C6\u5185\u5BB9\u3092\u30B5\u30DE\u30EA\u30FC\u4E2D\u2026",
    hallucinatedFallback: "\uFF08\u30E2\u30C7\u30EB\u304C\u6563\u6587\u30B5\u30DE\u30EA\u30FC\u306E\u4EE3\u308F\u308A\u306B\u507D\u306E\u30C4\u30FC\u30EB\u547C\u3073\u51FA\u3057\u30DE\u30FC\u30AF\u30A2\u30C3\u30D7\u3092\u51FA\u529B\u3057\u307E\u3057\u305F \u2014 \u3088\u308A\u72ED\u3044\u8CEA\u554F\u3067 /retry \u3059\u308B\u304B\u3001/think \u3067R1\u306E\u63A8\u8AD6\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\uFF09",
    failedAfterReason: "{label} \u306E\u5F8C\u3001\u30D5\u30A9\u30FC\u30EB\u30D0\u30C3\u30AF\u30B5\u30DE\u30EA\u30FC\u547C\u3073\u51FA\u3057\u304C\u5931\u6557\u3057\u307E\u3057\u305F: {message}\u3002/clear \u3092\u5B9F\u884C\u3057\u3066\u3088\u308A\u72ED\u3044\u8CEA\u554F\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001--max-tool-iters \u3092\u5897\u3084\u3057\u3066\u304F\u3060\u3055\u3044\u3002"
  },
  loop: {
    ...EN.loop,
    budgetExhausted: "\u30BB\u30C3\u30B7\u30E7\u30F3\u4E88\u7B97\u3092\u4F7F\u3044\u5207\u308A\u307E\u3057\u305F \u2014 \u6D88\u8CBB ${spent} \u2265 \u4E0A\u9650 ${cap}\u3002/budget <usd> \u3067\u4E0A\u9650\u3092\u5F15\u304D\u4E0A\u3052\u308B\u304B\u3001/budget off \u3067\u30AF\u30EA\u30A2\u3059\u308B\u304B\u3001\u30BB\u30C3\u30B7\u30E7\u30F3\u3092\u7D42\u4E86\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    budget80Pct: "\u25B2 \u4E88\u7B97\u306E80%\u3092\u4F7F\u7528 \u2014 ${spent} / ${cap}\u3002\u6B21\u306E1\u301C2\u30BF\u30FC\u30F3\u3067\u4E0A\u9650\u306B\u9054\u3059\u308B\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002",
    proArmed: "\u21E7 /pro \u6B66\u88C5 \u2014 \u3053\u306E\u30BF\u30FC\u30F3\u306F deepseek-v4-pro \u3067\u5B9F\u884C\uFF081\u56DE\u9650\u308A \xB7 \u30BF\u30FC\u30F3\u5F8C\u306B\u89E3\u9664\uFF09",
    toolUploadStatus: "\u30C4\u30FC\u30EB\u7D50\u679C\u3092\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9\u3057\u307E\u3057\u305F \xB7 \u6B21\u306E\u5FDC\u7B54\u524D\u306B\u30E2\u30C7\u30EB\u304C\u601D\u8003\u4E2D\u2026",
    turnStartFoldStatus: "\u30BF\u30FC\u30F3\u958B\u59CB: \u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u304C\u4E0A\u9650\u306B\u63A5\u8FD1\u4E2D\u3001\u5C65\u6B74\u3092\u5727\u7E2E\u4E2D\u2026",
    turnStartFolded: "\u30BF\u30FC\u30F3\u958B\u59CB: \u30EA\u30AF\u30A8\u30B9\u30C8 ~{estimate}/{ctxMax} \u30C8\u30FC\u30AF\u30F3 ({pct}%) \u2014 {beforeMessages} \u30E1\u30C3\u30BB\u30FC\u30B8 \u2192 {afterMessages} \u306B\u5727\u7E2E\u3002\u9001\u4FE1\u4E2D\u3002",
    harvestStatus: "\u63A8\u8AD6\u304B\u3089\u30D7\u30E9\u30F3\u72B6\u614B\u3092\u62BD\u51FA\u4E2D\u2026",
    repeatToolCallWarning: "\u7E70\u308A\u8FD4\u3057\u30C4\u30FC\u30EB\u547C\u3073\u51FA\u3057\u3092\u691C\u51FA \u2014 \u30E2\u30C7\u30EB\u306B\u554F\u984C\u3092\u8A8D\u8B58\u3055\u305B\u3001\u5225\u306E\u30A2\u30D7\u30ED\u30FC\u30C1\u3067\u518D\u8A66\u884C\u3055\u305B\u307E\u3059\u3002",
    stormStuck: "\u30B9\u30BF\u30C3\u30AF\u3057\u305F\u30EA\u30C8\u30E9\u30A4\u30EB\u30FC\u30D7\u3092\u505C\u6B62 \u2014 \u30E2\u30C7\u30EB\u304C\u81EA\u5DF1\u4FEE\u6B63\u306E\u4FC3\u3057\u5F8C\u3082\u540C\u3058\u30C4\u30FC\u30EB\u3092\u540C\u4E00\u5F15\u6570\u3067\u547C\u3073\u7D9A\u3051\u307E\u3057\u305F\u3002/retry \u3092\u8A66\u3059\u304B\u3001\u8A00\u3044\u63DB\u3048\u308B\u304B\u3001\u6839\u672C\u7684\u306A\u30D6\u30ED\u30C3\u30AB\u30FC\u3092\u89E3\u6C7A\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    stormSuppressed: "{count} \u4EF6\u306E\u7E70\u308A\u8FD4\u3057\u30C4\u30FC\u30EB\u547C\u3073\u51FA\u3057\u3092\u6291\u5236 \u2014 \u540C\u3058\u540D\u524D+\u5F15\u6570\u304C3\u56DE\u4EE5\u4E0A\u767A\u884C\u3055\u308C\u307E\u3057\u305F\u3002",
    compactingHistoryStatus: "\u5C65\u6B74\u3092\u5727\u7E2E\u4E2D{aggressiveTag}\u2026",
    aggressiveTag: "\uFF08\u5F37\u5236\uFF09",
    foldedHistory: "\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8 {before}/{ctxMax} ({pct}%) \u2014 {beforeMessages} \u30E1\u30C3\u30BB\u30FC\u30B8 \u2192 {afterMessages} \u306B\u6298\u308A\u305F\u305F\u307F\uFF08\u30B5\u30DE\u30EA\u30FC {summaryChars} \u6587\u5B57\uFF09\u3002\u7D9A\u884C\u3057\u307E\u3059\u3002",
    aggressivelyFoldedHistory: "\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8 {before}/{ctxMax} ({pct}%) \u2014 {beforeMessages} \u30E1\u30C3\u30BB\u30FC\u30B8 \u2192 {afterMessages} \u306B\u5F37\u5236\u6298\u308A\u305F\u305F\u307F\uFF08\u30B5\u30DE\u30EA\u30FC {summaryChars} \u6587\u5B57\uFF09\u3002\u7D9A\u884C\u3057\u307E\u3059\u3002",
    forcingSummary: "\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8 {before}/{ctxMax} ({pct}%) \u2014 \u53CE\u96C6\u5185\u5BB9\u304B\u3089\u30B5\u30DE\u30EA\u30FC\u3092\u5F37\u5236\u751F\u6210\u4E2D\u3002/compact\u3001/clear\u3001\u307E\u305F\u306F /new \u3067\u30EA\u30BB\u30C3\u30C8\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    iterLimitReached: "\u30BF\u30FC\u30F3\u3042\u305F\u308A\u306E\u53CD\u5FA9\u4E0A\u9650\uFF08{max} \u56DE\u306E\u30C4\u30FC\u30EB\u547C\u51FA\u3057\u30E9\u30A6\u30F3\u30C9\uFF09\u306B\u9054\u3057\u307E\u3057\u305F\u3002\u53CE\u96C6\u5185\u5BB9\u306E\u30B5\u30DE\u30EA\u30FC\u3092\u5F37\u5236\u751F\u6210\u4E2D\u3002maxIterPerTurn \u8A2D\u5B9A\u307E\u305F\u306F REASONIX_MAX_ITER \u74B0\u5883\u5909\u6570\u3067\u4E0A\u66F8\u304D\u3067\u304D\u307E\u3059\u3002"
  },
  errors: {
    ...EN.errors,
    contextOverflow: "\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u30AA\u30FC\u30D0\u30FC\u30D5\u30ED\u30FC (DeepSeek 400): \u30BB\u30C3\u30B7\u30E7\u30F3\u5C65\u6B74\u304C {requested} \u3067\u3001\u30E2\u30C7\u30EB\u306E\u30D7\u30ED\u30F3\u30D7\u30C8\u5236\u9650\uFF08V4: 1M\u30C8\u30FC\u30AF\u30F3; \u65E7\u6765\u306Echat/reasoner: 131k\uFF09\u3092\u8D85\u3048\u3066\u3044\u307E\u3059\u3002\u901A\u5E38\u3001\u5358\u4E00\u306E\u30C4\u30FC\u30EB\u7D50\u679C\u304C\u5927\u304D\u3059\u304E\u308B\u306E\u304C\u539F\u56E0\u3067\u3059\u3002Reasonix\u306F\u65B0\u3057\u3044\u30C4\u30FC\u30EB\u7D50\u679C\u30928k\u30C8\u30FC\u30AF\u30F3\u306B\u5236\u9650\u3057\u3001\u30BB\u30C3\u30B7\u30E7\u30F3\u8AAD\u307F\u8FBC\u307F\u6642\u306B\u5927\u304D\u3059\u304E\u308B\u5C65\u6B74\u3092\u81EA\u52D5\u4FEE\u5FA9\u3057\u307E\u3059 \u2014 \u518D\u8D77\u52D5\u3067\u89E3\u6C7A\u3059\u308B\u3053\u3068\u304C\u591A\u3044\u3067\u3059\u3002\u305D\u308C\u3067\u3082\u30AA\u30FC\u30D0\u30FC\u30D5\u30ED\u30FC\u3059\u308B\u5834\u5408\u306F\u3001/new \u3067\u65B0\u898F\u958B\u59CB\u3059\u308B\u304B\u3001/sessions \u3092\u958B\u3044\u3066 [d] \u3067\u3053\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u3092\u524A\u9664\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    contextOverflowTooMany: "\u30C8\u30FC\u30AF\u30F3\u304C\u591A\u3059\u304E\u307E\u3059",
    auth401: "\u8A8D\u8A3C\u306B\u5931\u6557\u3057\u307E\u3057\u305F (DeepSeek 401): {inner}\u3002API\u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F\u3002`reasonix setup` \u307E\u305F\u306F `export DEEPSEEK_API_KEY=sk-...` \u3067\u4FEE\u6B63\u3057\u3066\u304F\u3060\u3055\u3044\u3002https://platform.deepseek.com/api_keys \u304B\u3089\u53D6\u5F97\u3067\u304D\u307E\u3059\u3002",
    balance402: "\u6B8B\u9AD8\u4E0D\u8DB3 (DeepSeek 402): {inner}\u3002https://platform.deepseek.com/top_up \u3067\u30C1\u30E3\u30FC\u30B8\u3057\u3066\u304F\u3060\u3055\u3044 \u2014 \u6B8B\u9AD8\u304C\u30BC\u30ED\u3067\u306A\u304F\u306A\u308B\u3068\u30D1\u30CD\u30EB\u30D8\u30C3\u30C0\u30FC\u306B\u8868\u793A\u3055\u308C\u307E\u3059\u3002",
    badparam422: "\u7121\u52B9\u306A\u30D1\u30E9\u30E1\u30FC\u30BF (DeepSeek 422): {inner}",
    badrequest400: "\u4E0D\u6B63\u306A\u30EA\u30AF\u30A8\u30B9\u30C8 (DeepSeek 400): {inner}",
    concurrency429: "DeepSeek\u306E\u540C\u6642\u5B9F\u884C\u5236\u9650\u306B\u9054\u3057\u307E\u3057\u305F (429): {inner}\u3002\u30A2\u30AB\u30A6\u30F3\u30C8\u306E\u51E6\u7406\u4E2D\u30EA\u30AF\u30A8\u30B9\u30C8\u304C\u591A\u3059\u304E\u307E\u3059\uFF08\u4E0A\u9650: v4-pro\u306F500\u3001v4-flash\u306F2500\u3001\u30A2\u30AB\u30A6\u30F3\u30C8\u5168\u4F53\u306EAPI\u30AD\u30FC\u5408\u8A08\uFF09\u3002\u901A\u5E38\u3001\u5225\u306EReasonix\u30D7\u30ED\u30BB\u30B9\u304C\u540C\u3058\u30AD\u30FC\u3092\u5171\u6709\u3057\u3066\u3044\u308B\u304B\u3001\u4E26\u5217\u30B5\u30D6\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8\u306E\u30D5\u30A1\u30F3\u30A2\u30A6\u30C8\u304C\u8D85\u904E\u3057\u305F\u3053\u3068\u3092\u610F\u5473\u3057\u307E\u3059\u3002\u6570\u79D2\u5F85\u3063\u3066\u518D\u8A66\u884C\u3059\u308B\u304B\u3001\u4E26\u5217\u5EA6\u3092\u4E0B\u3052\u308B\u304B\u3001https://platform.deepseek.com \u3067\u3088\u308A\u9AD8\u3044\u4E0A\u9650\u3092\u30EA\u30AF\u30A8\u30B9\u30C8\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    deepseek5xxHead: "DeepSeek\u30B5\u30FC\u30D3\u30B9\u5229\u7528\u4E0D\u53EF ({status}) \u2014 \u3053\u308C\u306FDeepSeek\u5074\u306E\u554F\u984C\u3067\u3042\u308A\u3001Reasonix\u306E\u554F\u984C\u3067\u306F\u3042\u308A\u307E\u305B\u3093\u3002\u30D0\u30C3\u30AF\u30AA\u30D5\u4ED8\u304D\u30674\u56DE\u518D\u8A66\u884C\u6E08\u307F\u3067\u3059\u3002",
    deepseek5xxReachable: " DeepSeek\u306E\u30E1\u30A4\u30F3API\u306F\u30D8\u30EB\u30B9\u30C1\u30A7\u30C3\u30AF\u306B\u5FDC\u7B54\u3057\u307E\u3057\u305F\u304C\u3001/chat/completions \u304C\u5931\u6557\u3057\u3066\u3044\u307E\u3059 \u2014 \u90E8\u5206\u7684\u306A\u969C\u5BB3\u304C\u767A\u751F\u3057\u3066\u3044\u307E\u3059\u3002",
    deepseek5xxUnreachable: " DeepSeek API\u306B\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u304B\u3089\u5230\u9054\u3067\u304D\u307E\u305B\u3093 \u2014 \u5E83\u7BC4\u306ADS\u969C\u5BB3\u304B\u3001\u30ED\u30FC\u30AB\u30EB\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u306E\u554F\u984C\u306E\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002",
    deepseek5xxActionNetwork: " \u5BFE\u51E6: (1) \u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u3092\u78BA\u8A8D, (2) 30\u79D2\u5F85\u3063\u3066\u518D\u8A66\u884C, (3) \u30B9\u30C6\u30FC\u30BF\u30B9\u30DA\u30FC\u30B8: https://status.deepseek.com",
    deepseek5xxActionRetry: " \u5BFE\u51E6: (1) 30\u79D2\u5F85\u3063\u3066\u518D\u8A66\u884C, (2) /model \u3067\u30E2\u30C7\u30EB\u5207\u66FF, (3) \u30B9\u30C6\u30FC\u30BF\u30B9\u30DA\u30FC\u30B8: https://status.deepseek.com",
    upstream5xxHead: "\u30A2\u30C3\u30D7\u30B9\u30C8\u30EA\u30FC\u30E0\u30B5\u30FC\u30D3\u30B9\u5229\u7528\u4E0D\u53EF ({status}) at {host} \u2014 \u8A2D\u5B9A\u3055\u308C\u305FAPI\u30A8\u30F3\u30C9\u30DD\u30A4\u30F3\u30C8\u304C\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC\u3092\u8FD4\u3057\u307E\u3057\u305F\u3002Reasonix\u306E\u30D0\u30B0\u3067\u306F\u3042\u308A\u307E\u305B\u3093\u3002\u30D0\u30C3\u30AF\u30AA\u30D5\u4ED8\u304D\u30674\u56DE\u518D\u8A66\u884C\u6E08\u307F\u3067\u3059\u3002",
    upstream5xxActionRetry: " \u5BFE\u51E6: (1) \u30ED\u30FC\u30AB\u30EB/\u30D7\u30ED\u30AD\u30B7\u30E2\u30C7\u30EB\u30B5\u30FC\u30D0\u30FC\u304C\u8D77\u52D5\u3057\u3066\u3044\u308B\u304B\u78BA\u8A8D, (2) \u5F85\u3063\u3066\u518D\u8A66\u884C, (3) /model \u3067\u30E2\u30C7\u30EB\u5207\u66FF\u3002",
    innerNoMessage: "(\u30E1\u30C3\u30BB\u30FC\u30B8\u306A\u3057)",
    reasonAborted: "[\u30E6\u30FC\u30B6\u30FC\u306B\u3088\u308A\u4E2D\u65AD (Esc) \u2014 \u3053\u3053\u307E\u3067\u306E\u8ABF\u67FB\u5185\u5BB9\u3092\u30B5\u30DE\u30EA\u30FC\u3057\u307E\u3059]",
    reasonContextGuard: "[\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u6B8B\u91CF\u304C\u4F4E\u4E0B \u2014 \u6B21\u306E\u547C\u3073\u51FA\u3057\u304C\u30AA\u30FC\u30D0\u30FC\u30D5\u30ED\u30FC\u3059\u308B\u524D\u306B\u30B5\u30DE\u30EA\u30FC\u3057\u307E\u3059]",
    reasonStuck: "[\u7E70\u308A\u8FD4\u3057\u30C4\u30FC\u30EB\u547C\u3073\u51FA\u3057\u3067\u30B9\u30BF\u30C3\u30AF \u2014 \u8A66\u307F\u305F\u5185\u5BB9\u3068\u9032\u884C\u3092\u59A8\u3052\u3066\u3044\u308B\u3082\u306E\u3092\u8AAC\u660E\u3057\u307E\u3059]",
  ...
  handlers: {
    ...
    basic: {
      ...EN.handlers.basic,
      newInfo: "\u25B8 \u65B0\u3057\u3044\u4F1A\u8A71 \u2014 \u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u304B\u3089 {count} \u4EF6\u306E\u30E1\u30C3\u30BB\u30FC\u30B8\u3092\u524A\u9664\u3057\u307E\u3057\u305F\u3002\u540C\u3058\u30BB\u30C3\u30B7\u30E7\u30F3\u3001\u65B0\u898F\u306E\u72B6\u614B\u3067\u3059\u3002",
      newInfoArchived: '\u25B8 \u65B0\u3057\u3044\u4F1A\u8A71 \u2014 \u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u304B\u3089 {count} \u4EF6\u306E\u30E1\u30C3\u30BB\u30FC\u30B8\u3092\u524A\u9664\u3057\u307E\u3057\u305F\u3002\u4EE5\u524D\u306E\u30C8\u30E9\u30F3\u30B9\u30AF\u30EA\u30D7\u30C8\u306F "{archived}" \u3068\u3057\u3066\u30A2\u30FC\u30AB\u30A4\u30D6\u3055\u308C\u307E\u3057\u305F\uFF08Sessions \u3067\u8868\u793A\u53EF\u80FD\uFF09\u3002',
      newInfoSystemReloaded: " \xB7 REASONIX.md / \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30E1\u30E2\u30EA\u3092\u518D\u8AAD\u307F\u8FBC\u307F\u3057\u307E\u3057\u305F\uFF08\u6B21\u306E\u30BF\u30FC\u30F3\u3067\u30AD\u30E3\u30C3\u30B7\u30E5\u30DF\u30B91\u56DE\uFF09",
      helpTitle: "\u30B3\u30DE\u30F3\u30C9:",
      helpShellTitle: "\u30B7\u30A7\u30EB\u30B7\u30E7\u30FC\u30C8\u30AB\u30C3\u30C8:",
      helpShell: "  !<cmd>                   \u30B5\u30F3\u30C9\u30DC\u30C3\u30AF\u30B9\u30EB\u30FC\u30C8\u3067 <cmd> \u3092\u5B9F\u884C; \u51FA\u529B\u306F",
      helpShellDetail: "                             \u4F1A\u8A71\u306B\u6E21\u3055\u308C\u3001\u6B21\u306E\u30BF\u30FC\u30F3\u3067\u30E2\u30C7\u30EB\u304C\u53C2\u7167\u3067\u304D\u307E\u3059\u3002",
      helpShellConsent: "                             \u8A31\u53EF\u30EA\u30B9\u30C8\u306F\u4E0D\u8981 \u2014 \u30E6\u30FC\u30B6\u30FC\u5165\u529B = \u660E\u793A\u7684\u540C\u610F\u3002",
      ...
      helpShellGateDetail: "                             / `deny` \u306E\u30D7\u30ED\u30F3\u30D7\u30C8\u3092\u8868\u793A\u3002`allow always` \u3067",
      helpShellGatePolicy: "                             \u305D\u306E\u30B3\u30DE\u30F3\u30C9\u30D7\u30EC\u30D5\u30A3\u30C3\u30AF\u30B9\u3092\u3053\u306E\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3067\u8A31\u53EF\u3002\u5168\u8A31\u53EF\u30D5\u30E9\u30B0\u306F\u3042\u308A\u307E\u305B\u3093\u3002",
      helpMemoryTitle: "\u30AF\u30A4\u30C3\u30AF\u30E1\u30E2\u30EA:",
      helpMemoryPin: "  #<note>                  <note> \u3092 <project>/REASONIX.md \u306B\u8FFD\u8A18\uFF08\u30B3\u30DF\u30C3\u30C8\u53EF\u80FD\uFF09\u3002",
      helpMemoryPinEx: "                             \u4F8B: #findByEmail \u306F\u5927\u6587\u5B57\u5C0F\u6587\u5B57\u3092\u533A\u5225\u3057\u306A\u3044",
      helpMemoryGlobal: "  #g <note>                <note> \u3092 ~/.reasonix/REASONIX.md \u306B\u8FFD\u8A18\uFF08\u30B0\u30ED\u30FC\u30D0\u30EB\u3001\u30B3\u30DF\u30C3\u30C8\u4E0D\u53EF\uFF09\u3002",
      helpMemoryGlobalEx: "                             \u4F8B: #g npm \u3067\u306F\u306A\u304F pnpm \u3092\u4F7F\u3046",
      helpMemoryPinBoth: "                             \u3069\u3061\u3089\u3082\u4ECA\u5F8C\u306E\u5168\u30BB\u30C3\u30B7\u30E7\u30F3\u306E\u30D7\u30EC\u30D5\u30A3\u30C3\u30AF\u30B9\u306B\u30D4\u30F3\u7559\u3081\u3055\u308C\u307E\u3059\u3002/memory \u3088\u308A\u9AD8\u901F\u3002",
      helpMemoryEscape: "                             `\\#text` \u3067\u30EA\u30C6\u30E9\u30EB\u306E `#text` \u3092\u30E2\u30C7\u30EB\u306B\u9001\u4FE1\u3002",
      helpFileTitle: "\u30D5\u30A1\u30A4\u30EB\u53C2\u7167\uFF08\u30B3\u30FC\u30C9\u30E2\u30FC\u30C9\uFF09:",
      helpFile: "  @path/to/file            \u9001\u4FE1\u6642\u306B\u30D5\u30A1\u30A4\u30EB\u5185\u5BB9\u3092 [Referenced files] \u306B\u30A4\u30F3\u30E9\u30A4\u30F3\u5C55\u958B\u3002",
      helpFilePicker: "                             `@` \u3092\u5165\u529B\u3059\u308B\u3068\u30D4\u30C3\u30AB\u30FC\u304C\u958B\u304D\u307E\u3059\uFF08\u2191\u2193 \u79FB\u52D5\u3001Tab/Enter \u9078\u629E\uFF09\u3002",
      helpUrlTitle: "URL\u53C2\u7167:",
      helpUrl: "  @https://example.com     URL\u3092\u53D6\u5F97\u3057\u3001HTML\u3092\u9664\u53BB\u3057\u3066 [Referenced URLs] \u306B\u30A4\u30F3\u30E9\u30A4\u30F3\u5C55\u958B\u3002",
      helpUrlCache: "                             \u540C\u3058URL\u306F\u30BB\u30C3\u30B7\u30E7\u30F3\u5185\u30671\u56DE\u306E\u307F\u53D6\u5F97\uFF08\u30A4\u30F3\u30E1\u30E2\u30EA\u30AD\u30E3\u30C3\u30B7\u30E5\uFF09\u3002",
      ...
      loopNoActiveHint: "\u30A2\u30AF\u30C6\u30A3\u30D6\u306A\u30EB\u30FC\u30D7\u306F\u3042\u308A\u307E\u305B\u3093\u3002`/loop <interval> <prompt>` \u3067\u958B\u59CB\u3057\u3066\u304F\u3060\u3055\u3044\uFF08\u4F8B: /loop 30s npm test\uFF09\u3002\n\u505C\u6B62\u6761\u4EF6: /loop stop \xB7 Esc \xB7 /clear /new \xB7 \u4EFB\u610F\u306E\u30E6\u30FC\u30B6\u30FC\u5165\u529B\u30D7\u30ED\u30F3\u30D7\u30C8\u3002",
      loopStarted: '\u25B8 \u30EB\u30FC\u30D7\u3092\u958B\u59CB\u3057\u307E\u3057\u305F \u2014 "{prompt}" \u3092 {duration} \u3054\u3068\u306B\u518D\u9001\u4FE1\u3057\u307E\u3059\u3002\u4F55\u304B\u5165\u529B\u3059\u308B\u304B /loop stop \u3067\u30AD\u30E3\u30F3\u30BB\u30EB\u3002',
    ...
    qq: {
      ...
      promptAppId: "QQ\u8A2D\u5B9A: QQ Open Platform \u306E App ID \u3092\u5165\u529B\u3057\u3001Enter \u3092\u62BC\u3057\u3066\u304F\u3060\u3055\u3044\u3002/cancel \u3067\u4E2D\u65AD\u3002",
      promptAppSecret: "QQ\u8A2D\u5B9A: QQ Open Platform \u306E App Secret \u3092\u5165\u529B\u3057\u3001Enter \u3092\u62BC\u3057\u3066\u304F\u3060\u3055\u3044\u3002/cancel \u3067\u4E2D\u65AD\u3002",
      ...
      status: "QQ: {connected}, \u81EA\u52D5\u8D77\u52D5 {enabled}, \u8A8D\u8A3C\u60C5\u5831 {configured}, appId {appId}, {sandbox}, \u30A2\u30AF\u30BB\u30B9 {access}, \u73FE\u5728\u306E\u30E2\u30FC\u30C9 {mode}\u3002",
      ...
      lockAlreadyRunning: "QQ\u30C1\u30E3\u30F3\u30CD\u30EB\u306F\u65E2\u306B\u30D7\u30ED\u30BB\u30B9 {pid} \u3067\u5B9F\u884C\u4E2D\u3067\u3059\u3002\u5225\u306EQQ\u30C1\u30E3\u30F3\u30CD\u30EB\u3092\u958B\u59CB\u3059\u308B\u524D\u306B\u305D\u306E\u30D7\u30ED\u30BB\u30B9\u3092\u505C\u6B62\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      unauthorizedMessage: "QQ \u304C\u672A\u8A8D\u8A3C\u306E openid {openid} \u304B\u3089\u306E\u30E1\u30C3\u30BB\u30FC\u30B8\u3092\u7121\u8996\u3057\u307E\u3057\u305F\u3002\u73FE\u5728\u306E\u30A2\u30AF\u30BB\u30B9: {access}\u3002",
      runtimeBound: "QQ \u306F\u3053\u306E\u5B9F\u884C\u3092\u6700\u521D\u306E\u9001\u4FE1\u8005 {openid} \u306B\u4E00\u6642\u7684\u306B\u30D0\u30A4\u30F3\u30C9\u3057\u307E\u3057\u305F\u3002\u30A2\u30AF\u30BB\u30B9\u3092\u6C38\u7D9A\u5316\u3059\u308B\u306B\u306F\u8A2D\u5B9A\u3067 `qq.ownerOpenId` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    ...
    admin: {
      ...
      hooksReloadUnavailable: "/hooks reload \u306F\u3053\u306E\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u3067\u306F\u5229\u7528\u3067\u304D\u307E\u305B\u3093\uFF08reload \u30B3\u30FC\u30EB\u30D0\u30C3\u30AF\u304C\u672A\u63A5\u7D9A\uFF09\u3002",
      hooksReloaded: "\u25B8 \u30D5\u30C3\u30AF\u3092\u518D\u8AAD\u307F\u8FBC\u307F\u3057\u307E\u3057\u305F \xB7 {count} \u500B\u30A2\u30AF\u30C6\u30A3\u30D6",
      hooksUsage: "\u4F7F\u3044\u65B9: /hooks            \u30A2\u30AF\u30C6\u30A3\u30D6\u306A\u30D5\u30C3\u30AF\u3092\u4E00\u89A7\n       /hooks reload     settings.json \u30D5\u30A1\u30A4\u30EB\u3092\u518D\u8AAD\u8FBC",
      hooksNone: "\u30D5\u30C3\u30AF\u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002",
      hooksDropHint: "`hooks` \u30AD\u30FC\u3092\u6301\u3064 settings.json \u3092\u4EE5\u4E0B\u306E\u3044\u305A\u308C\u304B\u306B\u914D\u7F6E\u3057\u3066\u304F\u3060\u3055\u3044:",
      hooksProject: "  \xB7 {path}\uFF08\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\uFF09",
      hooksProjectFallback: "  \xB7 <project>/.reasonix/settings.json\uFF08\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\uFF09",
      hooksGlobal: "  \xB7 {path}\uFF08\u30B0\u30ED\u30FC\u30D0\u30EB\uFF09",
      hooksEvents: "\u30A4\u30D9\u30F3\u30C8: PreToolUse, PostToolUse, UserPromptSubmit, Stop",
      hooksExitCodes: "exit 0 = \u901A\u904E \xB7 exit 2 = \u30D6\u30ED\u30C3\u30AF (Pre*) \xB7 \u305D\u306E\u4ED6 = \u8B66\u544A",
      hooksLoaded: "\u25B8 {count} \u500B\u306E\u30D5\u30C3\u30AF\u3092\u8AAD\u307F\u8FBC\u307F\u307E\u3057\u305F",
      hooksSources: "\u30BD\u30FC\u30B9: project={project} \xB7 global={global}",
      ...
      updateInSessionDisabled: "\u30BB\u30C3\u30B7\u30E7\u30F3\u5185\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB\u306F\u610F\u56F3\u7684\u306B\u7121\u52B9\u5316\u3055\u308C\u3066\u3044\u307E\u3059 \u2014 \u30A4\u30F3\u30B9\u30C8\u30FC\u30EB\u306E\u30B9\u30DD\u30FC\u30F3\u306B\u3088\u308A",
      updateInSessionDisabled2: "\u3053\u306ETUI\u306E\u30EC\u30F3\u30C0\u30EA\u30F3\u30B0\u304C\u7834\u640D\u3057\u3001Windows\u3067\u306F\u5B9F\u884C\u4E2D\u30D0\u30A4\u30CA\u30EA\u304C\u30ED\u30C3\u30AF\u3055\u308C\u308B\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002",
    ...
    edits: {
      ...EN.handlers.edits,
      undoCodeOnly: "/undo \u306F `reasonix code` \u5185\u3067\u306E\u307F\u5229\u7528\u53EF\u80FD\u3067\u3059 \u2014 \u30C1\u30E3\u30C3\u30C8\u30E2\u30FC\u30C9\u3067\u306F\u7DE8\u96C6\u3092\u9069\u7528\u3057\u307E\u305B\u3093\u3002",
      ...
      planCodeOnly: "/plan \u306F `reasonix code` \u5185\u3067\u306E\u307F\u5229\u7528\u53EF\u80FD\u3067\u3059 \u2014 \u30C1\u30E3\u30C3\u30C8\u30E2\u30FC\u30C9\u3067\u306F\u30C4\u30FC\u30EB\u66F8\u304D\u8FBC\u307F\u3092\u5236\u5FA1\u3057\u307E\u305B\u3093\u3002",
      planOn: "\u25B8 \u30D7\u30E9\u30F3\u30E2\u30FC\u30C9 ON \u2014 \u66F8\u304D\u8FBC\u307F\u30C4\u30FC\u30EB\u304C\u5236\u5FA1\u3055\u308C\u307E\u3059; \u30E2\u30C7\u30EB\u306F\u5B9F\u884C\u524D\u306B `submit_plan` \u3092\u547C\u3073\u51FA\u3059\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u3002\uFF08\u30D7\u30E9\u30F3\u30E2\u30FC\u30C9\u304C\u30AA\u30D5\u3067\u3082\u3001\u5927\u304D\u306A\u30BF\u30B9\u30AF\u3067\u306F\u30E2\u30C7\u30EB\u304C\u81EA\u4E3B\u7684\u306B submit_plan \u3092\u547C\u3073\u51FA\u305B\u307E\u3059 \u2014 \u3053\u306E\u30C8\u30B0\u30EB\u306F\u3088\u308A\u5F37\u3044\u660E\u793A\u7684\u306A\u5236\u7D04\u3067\u3059\u3002\uFF09/plan off \u3067\u7D42\u4E86\u3002",
      planOff: "\u25B8 \u30D7\u30E9\u30F3\u30E2\u30FC\u30C9 OFF \u2014 \u66F8\u304D\u8FBC\u307F\u30C4\u30FC\u30EB\u304C\u518D\u6709\u52B9\u5316\u3055\u308C\u307E\u3057\u305F\u3002\u5927\u304D\u306A\u30BF\u30B9\u30AF\u3067\u306F\u30E2\u30C7\u30EB\u304C\u81EA\u4E3B\u7684\u306B\u30D7\u30E9\u30F3\u3092\u63D0\u6848\u3067\u304D\u307E\u3059\u3002",
      modeCodeOnly: "/mode \u306F `reasonix code` \u5185\u3067\u306E\u307F\u5229\u7528\u53EF\u80FD\u3067\u3059\u3002",
      modeUsage: "\u4F7F\u3044\u65B9: /mode <review|auto|yolo>   \uFF08Shift+Tab \u3067\u3082\u5207\u308A\u66FF\u3048\u53EF\u80FD\uFF09",
      modeYolo: "\u25B8 \u7DE8\u96C6\u30E2\u30FC\u30C9: YOLO \u2014 \u7DE8\u96C6\u3068\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u304C\u30D7\u30ED\u30F3\u30D7\u30C8\u306A\u3057\u3067\u81EA\u52D5\u5B9F\u884C\u3055\u308C\u307E\u3059\u3002/undo \u3067\u7DE8\u96C6\u306E\u30ED\u30FC\u30EB\u30D0\u30C3\u30AF\u306F\u53EF\u80FD\u3067\u3059\u3002\u6CE8\u610F\u3057\u3066\u4F7F\u7528\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      modeAuto: "\u25B8 \u7DE8\u96C6\u30E2\u30FC\u30C9: AUTO \u2014 \u7DE8\u96C6\u304C\u5373\u6642\u9069\u7528\u3055\u308C\u307E\u3059; 5\u79D2\u4EE5\u5185\u306B u \u3092\u62BC\u3059\u304B\u3001\u5F8C\u3067 /undo \u3067\u5143\u306B\u623B\u305B\u307E\u3059\u3002\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u306F\u78BA\u8A8D\u3042\u308A\u3002",
      ...
      commitUsage: '\u4F7F\u3044\u65B9: /commit "\u30B3\u30DF\u30C3\u30C8\u30E1\u30C3\u30BB\u30FC\u30B8"  \u2014 {root} \u3067 `git add -A && git commit -m "\u2026"` \u3092\u5B9F\u884C\u3057\u307E\u3059',
      walkCodeOnly: "/walk \u306F `reasonix code` \u5185\u3067\u306E\u307F\u5229\u7528\u53EF\u80FD\u3067\u3059\u3002",
      checkpointCodeOnly: "/checkpoint \u306F `reasonix code` \u5185\u3067\u306E\u307F\u5229\u7528\u53EF\u80FD\u3067\u3059 \u2014 \u30C1\u30E3\u30C3\u30C8\u30E2\u30FC\u30C9\u3067\u306F\u7DE8\u96C6\u3092\u9069\u7528\u3057\u307E\u305B\u3093\u3002",
      checkpointNone: "\u307E\u3060\u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8\u306F\u3042\u308A\u307E\u305B\u3093 \u2014 `/checkpoint <name>` \u3067\u30BB\u30C3\u30B7\u30E7\u30F3\u304C\u89E6\u308C\u305F\u5168\u30D5\u30A1\u30A4\u30EB\u306E\u30B9\u30CA\u30C3\u30D7\u30B7\u30E7\u30C3\u30C8\u3092\u4FDD\u5B58\u3057\u307E\u3059\u3002\u5F8C\u3067 `/restore <name>` \u3067\u5FA9\u5143\u3067\u304D\u307E\u3059\u3002",
      checkpointHeader: "\u25C8 \u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8 \xB7 {count} \u4EF6\u4FDD\u5B58",
      checkpointRestoreHint: "  /restore <name|id> \xB7 /checkpoint forget <id> \xB7 /checkpoint <name> \u3067\u8FFD\u52A0",
      ...
      checkpointSavedEmpty: '\u25B8 \u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8 "{name}" \u3092\u4FDD\u5B58\u3057\u307E\u3057\u305F ({id}) \u2014 \u3057\u304B\u3057\u3001\u307E\u3060\u30D5\u30A1\u30A4\u30EB\u304C\u89E6\u3089\u308C\u3066\u3044\u306A\u3044\u305F\u3081\u7A7A\u306E\u30D9\u30FC\u30B9\u30E9\u30A4\u30F3\u3067\u3059\u3002\u3053\u306E\u5F8C\u306E\u7DE8\u96C6\u306F\u5FA9\u5143\u53EF\u80FD\u306B\u306A\u308A\u307E\u3059\u3002',
      checkpointSaved: '\u25B8 \u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8 "{name}" \u3092\u4FDD\u5B58\u3057\u307E\u3057\u305F ({id}) \u2014 {files} \u30D5\u30A1\u30A4\u30EB, {size} KB\u3002\u5FA9\u5143: /restore {name}',
      ...
      restoreWrote: "  \xB7 {count} \u30D5\u30A1\u30A4\u30EB\u3092\u66F8\u304D\u623B\u3057\u307E\u3057\u305F",
      restoreRemoved: "  \xB7 {count} \u30D5\u30A1\u30A4\u30EB\u3092\u524A\u9664\u3057\u307E\u3057\u305F\uFF08\u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8\u6642\u70B9\u3067\u306F\u5B58\u5728\u3057\u307E\u305B\u3093\u3067\u3057\u305F\uFF09",
      restoreSkipped: "  \u2717 {count} \u30D5\u30A1\u30A4\u30EB\u3092\u30B9\u30AD\u30C3\u30D7\u3057\u307E\u3057\u305F:",
      cwdCodeOnly: "/cwd \u306F `reasonix code` \u5185\u3067\u306E\u307F\u5229\u7528\u53EF\u80FD\u3067\u3059\u3002",
      cwdUsage: "\u4F7F\u3044\u65B9: /cwd <path>   \uFF08\u73FE\u5728\u306E\u30EB\u30FC\u30C8: {current}\uFF09\u3002\u30D5\u30A1\u30A4\u30EB\u30B7\u30B9\u30C6\u30E0 / \u30B7\u30A7\u30EB / \u30E1\u30E2\u30EA\u30C4\u30FC\u30EB\u306E\u53C2\u7167\u5148\u3092 <path> \u306B\u5909\u66F4\u3057\u307E\u3059\u3002",
    ...
    model: {
      ...
      modelNotInCatalog: "model \u2192 {id}   \uFF08\u26A0 \u53D6\u5F97\u6E08\u307F\u30AB\u30BF\u30ED\u30B0\u306B\u3042\u308A\u307E\u305B\u3093: {list}\u3002\u9593\u9055\u3044\u306E\u5834\u5408\u3001\u6B21\u306E\u547C\u3073\u51FA\u3057\u304C400\u306B\u306A\u308A\u307E\u3059 \u2014 /models \u3067\u66F4\u65B0\u3057\u3066\u304F\u3060\u3055\u3044\u3002\uFF09",
      modelSet: "model \u2192 {id}",
      ...
      effortSet: "effort \u2192 {effort}",
      budgetNoCap: "\u30BB\u30C3\u30B7\u30E7\u30F3\u4E88\u7B97\u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093 \u2014 \u505C\u6B62\u3059\u308B\u307E\u3067\u7D9A\u884C\u3057\u307E\u3059\u3002\u8A2D\u5B9A: /budget <usd>   \uFF08\u4F8B: /budget 5\uFF09",
      budgetStatus: "budget: ${spent} / ${cap} ({pct}%) \xB7 /budget off \u3067\u89E3\u9664\u3001/budget <usd> \u3067\u5909\u66F4",
      budgetOff: "budget \u2192 off\uFF08\u4E0A\u9650\u306A\u3057\uFF09",
      budgetUsage: '\u4F7F\u3044\u65B9: /budget <usd>   \uFF08"{arg}" \u304C\u6307\u5B9A\u3055\u308C\u307E\u3057\u305F \u2014 \u6B63\u306E\u6570\u5024\u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u3002\u4F8B: /budget 5 \u307E\u305F\u306F /budget 12.50\uFF09',
      budgetExhausted: "\u25B2 budget \u2192 ${cap} \u3067\u3059\u304C\u65E2\u306B ${spent} \u6D88\u8CBB\u3057\u3066\u3044\u307E\u3059\u3002\u6B21\u306E\u30BF\u30FC\u30F3\u306F\u62D2\u5426\u3055\u308C\u307E\u3059 \u2014 \u4E0A\u9650\u3092\u4E0A\u3052\u308B\u304B\u3001\u30BB\u30C3\u30B7\u30E7\u30F3\u3092\u7D42\u4E86\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      budgetSet: "budget \u2192 ${cap}  \uFF08\u73FE\u5728\u307E\u3067: ${spent} \xB7 80%\u3067\u8B66\u544A\u3001100%\u3067\u6B21\u306E\u30BF\u30FC\u30F3\u3092\u62D2\u5426 \xB7 /budget off \u3067\u89E3\u9664\uFF09"
    },
    permissions: {
      ...EN.handlers.permissions,
      mutateCodeOnly: "/permissions add / remove / clear \u306F `reasonix code` \u5185\u3067\u306E\u307F\u5229\u7528\u53EF\u80FD\u3067\u3059 \u2014 \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30B9\u30B3\u30FC\u30D7\u306E\u8A31\u53EF\u30EA\u30B9\u30C8\u3092\u7DE8\u96C6\u3057\u307E\u3059\uFF08`~/.reasonix/config.json` projects[<root>].shellAllowed\uFF09\u3002",
      addUsage: '\u4F7F\u3044\u65B9: /permissions add <prefix>   \uFF08\u8907\u6570\u30C8\u30FC\u30AF\u30F3\u53EF: /permissions add "git push origin"\uFF09',
      addAlready: "\u25B8 \u65E2\u306B\u8A31\u53EF\u6E08\u307F: {prefix}",
      addBuiltin: "\u25B8 `{prefix}` \u306F\u65E2\u306B\u30D3\u30EB\u30C8\u30A4\u30F3\u8A31\u53EF\u30EA\u30B9\u30C8\u306B\u542B\u307E\u308C\u3066\u3044\u307E\u3059 \u2014 \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u56FA\u6709\u306E\u30A8\u30F3\u30C8\u30EA\u306F\u4E0D\u8981\u3067\u3059\u3002\uFF08\u30D3\u30EB\u30C8\u30A4\u30F3\u30A8\u30F3\u30C8\u30EA\u306F\u5E38\u306B\u6709\u52B9\u3067\u3059\u3002\uFF09",
      addInfo: "\u25B8 \u8FFD\u52A0\u3057\u307E\u3057\u305F: {prefix}\n  \u2192 \u6B21\u56DE\u306E `{prefix}` \u547C\u3073\u51FA\u3057\u306F\u3053\u306E\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3067\u30D7\u30ED\u30F3\u30D7\u30C8\u306A\u3057\u3067\u5B9F\u884C\u3055\u308C\u307E\u3059\u3002",
      removeUsage: "\u4F7F\u3044\u65B9: /permissions remove <prefix-or-index>   \uFF08\u4F8B: /permissions remove 3\u3001\u307E\u305F\u306F /permissions remove npm\uFF09",
      ...
      removeBuiltin: "\u25B8 `{prefix}` \u306F\u30D3\u30EB\u30C8\u30A4\u30F3\u8A31\u53EF\u30EA\u30B9\u30C8\u306B\u542B\u307E\u308C\u3066\u3044\u307E\u3059\uFF08\u8AAD\u307F\u53D6\u308A\u5C02\u7528\uFF09\u3002\u30D3\u30EB\u30C8\u30A4\u30F3\u30A8\u30F3\u30C8\u30EA\u306F\u5B9F\u884C\u6642\u306B\u524A\u9664\u3067\u304D\u307E\u305B\u3093 \u2014 \u30D0\u30A4\u30CA\u30EA\u306B\u7D44\u307F\u8FBC\u307E\u308C\u3066\u3044\u307E\u3059\u3002",
      removeInfo: "\u25B8 \u524A\u9664\u3057\u307E\u3057\u305F: {prefix}",
      removeNotFound: "\u25B8 \u305D\u306E\u3088\u3046\u306A\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30A8\u30F3\u30C8\u30EA\u306F\u3042\u308A\u307E\u305B\u3093: {prefix}   \uFF08/permissions list \u3067\u4FDD\u5B58\u5185\u5BB9\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\uFF09",
      clearAlready: "\u25B8 \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u8A31\u53EF\u30EA\u30B9\u30C8\u306F\u65E2\u306B\u7A7A\u3067\u3059\u3002",
      clearConfirm: "{root} \u306E\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u8A31\u53EF\u30EA\u30B9\u30C8 {count} \u30A8\u30F3\u30C8\u30EA\u3092\u524A\u9664\u3057\u3088\u3046\u3068\u3057\u3066\u3044\u307E\u3059\u3002'confirm' \u3092\u4ED8\u3051\u3066\u518D\u5B9F\u884C\u3059\u308B\u3068\u7D9A\u884C\u3057\u307E\u3059: /permissions clear confirm",
      clearedNone: "\u25B8 \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u8A31\u53EF\u30EA\u30B9\u30C8\u306F\u65E2\u306B\u7A7A\u3067\u3057\u305F \u2014 \u5909\u66F4\u306F\u3042\u308A\u307E\u305B\u3093\u3002",
      cleared: "\u25B8 \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u8A31\u53EF\u30EA\u30B9\u30C8 {count} \u30A8\u30F3\u30C8\u30EA\u3092\u30AF\u30EA\u30A2\u3057\u307E\u3057\u305F\u3002",
      usage: '\u4F7F\u3044\u65B9: /permissions [list]                   \u73FE\u5728\u306E\u72B6\u614B\u3092\u8868\u793A\n       /permissions add <prefix>            \u6C38\u7D9A\u5316\uFF08\u4F8B: "npm run build"\uFF09\n       /permissions remove <prefix-or-N>    1\u30A8\u30F3\u30C8\u30EA\u524A\u9664\n       /permissions clear confirm           \u5168\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30A8\u30F3\u30C8\u30EA\u3092\u6D88\u53BB',
      modeYolo: "\u25B8 \u7DE8\u96C6\u30E2\u30FC\u30C9: YOLO \u2014 \u3059\u3079\u3066\u306E\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u304C\u81EA\u52D5\u5B9F\u884C\u3055\u308C\u3001\u8A31\u53EF\u30EA\u30B9\u30C8\u306F\u30D0\u30A4\u30D1\u30B9\u3055\u308C\u307E\u3059\u3002/mode review \u3067\u30D7\u30ED\u30F3\u30D7\u30C8\u3092\u518D\u6709\u52B9\u5316\u3002",
      modeAuto: "\u25B8 \u7DE8\u96C6\u30E2\u30FC\u30C9: auto \u2014 \u7DE8\u96C6\u306F\u81EA\u52D5\u9069\u7528\u3001\u30B7\u30A7\u30EB\u306F\u8A31\u53EF\u30EA\u30B9\u30C8\uFF08\u307E\u305F\u306F\u672A\u8A31\u53EF\u306E\u5834\u5408\u306FShellConfirm\u30D7\u30ED\u30F3\u30D7\u30C8\uFF09\u3067\u5236\u5FA1\u3002",
      modeReview: "\u25B8 \u7DE8\u96C6\u30E2\u30FC\u30C9: review \u2014 \u7DE8\u96C6\u3068\u672A\u8A31\u53EF\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u306E\u4E21\u65B9\u304C\u5B9F\u884C\u524D\u306B\u78BA\u8A8D\u3092\u6C42\u3081\u307E\u3059\u3002",
      ...
      addGlobalInfo: "\u25B8 \u30B0\u30ED\u30FC\u30D0\u30EB\u8A31\u53EF\u30EA\u30B9\u30C8\u306B\u8FFD\u52A0: {prefix}\n  \u2192 \u4EE5\u964D `{prefix}` \u306F\u3059\u3079\u3066\u306E\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3067\u78BA\u8A8D\u306A\u3057\u306B\u5B9F\u884C\u3055\u308C\u307E\u3059\u3002",
      removeGlobalEmpty: "\u25B8 \u524A\u9664\u3067\u304D\u308B\u30B0\u30ED\u30FC\u30D0\u30EB\u8A31\u53EF\u30EA\u30B9\u30C8\u306E\u9805\u76EE\u304C\u3042\u308A\u307E\u305B\u3093\u3002",
      clearGlobalConfirm: "\u30B0\u30ED\u30FC\u30D0\u30EB\u8A31\u53EF\u30EA\u30B9\u30C8\u306E {count} \u4EF6\u3092\u524A\u9664\u3057\u3088\u3046\u3068\u3057\u3066\u3044\u307E\u3059\u3002'confirm' \u3092\u4ED8\u3051\u3066\u518D\u5B9F\u884C\u3057\u3066\u304F\u3060\u3055\u3044: /permissions clear --global confirm",
      builtinHeader: "\u30D3\u30EB\u30C8\u30A4\u30F3\u8A31\u53EF\u30EA\u30B9\u30C8 ({count}) \u2014 \u8AAD\u307F\u53D6\u308A\u5C02\u7528\u3001\u7D44\u307F\u8FBC\u307F",
      subcommands: "\u30B5\u30D6\u30B3\u30DE\u30F3\u30C9: /permissions add <prefix> \xB7 /permissions remove <prefix-or-N> \xB7 /permissions clear confirm"
    },
    dashboard: {
      ...EN.handlers.dashboard,
      notAvailable: "/dashboard \u306F\u3053\u306E\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u3067\u306F\u5229\u7528\u3067\u304D\u307E\u305B\u3093\uFF08startDashboard \u30B3\u30FC\u30EB\u30D0\u30C3\u30AF\u304C\u672A\u63A5\u7D9A\uFF09\u3002",
      ...
      ready: "\u25B8 \u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u6E96\u5099\u5B8C\u4E86:",
      readyHint: "127.0.0.1 \u306E\u307F \xB7 \u30C8\u30FC\u30AF\u30F3\u8A8D\u8A3C\u3002`/dashboard stop` \u3067\u30B7\u30E3\u30C3\u30C8\u30C0\u30A6\u30F3\u3002",
    ...
    observability: {
      ...
      contextInfo: "context: ~{total} / {max} ({pct}%) \xB7 system {sys} \xB7 tools {tools} \xB7 log {log}",
      ...
      costNoPricing: '\u25B8 /cost: \u30E2\u30C7\u30EB "{model}" \u306E\u4FA1\u683C\u30C6\u30FC\u30D6\u30EB\u304C\u3042\u308A\u307E\u305B\u3093\u3002telemetry/stats.ts \u306B\u8FFD\u52A0\u3057\u3066\u304F\u3060\u3055\u3044\u3002',
      costEstimate: "\u25B8 /cost \u898B\u7A4D\u3082\u308A \xB7 {model} \xB7 {prompt} \u30D7\u30ED\u30F3\u30D7\u30C8\u30C8\u30FC\u30AF\u30F3\uFF08sys {sys} + tools {tools} + log {log} + msg {msg}\uFF09",
      costWorstCase: "  \u6700\u60AA\u30B1\u30FC\u30B9\uFF08\u5B8C\u5168\u30DF\u30B9\uFF09: {input} \u5165\u529B + ~{output} \u51FA\u529B\uFF08{avg} \u5E73\u5747\uFF09\u2248 {total}",
      ...
      statusCost: "  cost    ${cost} \xB7 cache {bar} {pct}% \xB7 turns {turns}",
      statusCostCold: "  cost    ${cost} \xB7 turns {turns}\uFF08\u30AD\u30E3\u30C3\u30B7\u30E5\u6E96\u5099\u4E2D\uFF09",
      statusBudget: "  budget  ${spent} / ${cap} ({pct}%){tag}",
      statusSession: '  session "{name}" \xB7 {count} \u30E1\u30C3\u30BB\u30FC\u30B8\uFF08\u518D\u958B {resumed}\uFF09',
      statusSessionEphemeral: "  session\uFF08\u30A8\u30D5\u30A7\u30E1\u30E9\u30EB \u2014 \u6C38\u7D9A\u5316\u306A\u3057\uFF09",
      statusWorkspace: "  workspace {path} \xB7 \u8D77\u52D5\u6642\u306B\u56FA\u5B9A\uFF08--dir <path> \u3067\u518D\u8D77\u52D5\u3059\u308B\u3068\u5207\u308A\u66FF\u3048\uFF09",
      ...
      lifecycleRepeatedRejected: "lifecycle: {tool} \u306E\u7E70\u308A\u8FD4\u3057\u62D2\u5426 \u2014 \u540C\u4E00\u5F15\u6570\u3067\u518D\u8A66\u884C\u3057\u306A\u3044\u3067\u304F\u3060\u3055\u3044",
      statusModeYolo: "  mode    YOLO \u2014 \u7DE8\u96C6+\u30B7\u30A7\u30EB\u304C\u30D7\u30ED\u30F3\u30D7\u30C8\u306A\u3057\u3067\u81EA\u52D5\u5B9F\u884C\uFF08/undo \u3067\u30ED\u30FC\u30EB\u30D0\u30C3\u30AF \xB7 Shift+Tab \u3067\u5207\u66FF\uFF09",
      statusModeAuto: "  mode    AUTO \u2014 \u7DE8\u96C6\u304C\u5373\u6642\u9069\u7528\uFF085\u79D2\u4EE5\u5185\u306B u \u3067\u53D6\u6D88 \xB7 Shift+Tab \u3067\u5207\u66FF\uFF09",
      statusModeReview: "  mode    review \u2014 \u7DE8\u96C6\u306F /apply \u307E\u305F\u306F y \u306E\u30AD\u30E5\u30FC\uFF08Shift+Tab \u3067\u5207\u66FF\uFF09",
      statusDash: "  dash    {url}\uFF08\u30D6\u30E9\u30A6\u30B6\u3067\u958B\u304F \xB7 /dashboard stop\uFF09"
    },
    plans: {
      ...EN.handlers.plans,
      noSession: "\u30BB\u30C3\u30B7\u30E7\u30F3\u304C\u63A5\u7D9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093 \u2014 `/plans` \u306F\u30BB\u30C3\u30B7\u30E7\u30F3\u3054\u3068\u3067\u3059\u3002\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3067 `reasonix code` \u3092\u5B9F\u884C\u3059\u308B\u3068\u30BB\u30C3\u30B7\u30E7\u30F3\u304C\u53D6\u5F97\u3067\u304D\u307E\u3059\u3002",
      activePlan: "\u25B8 \u30A2\u30AF\u30C6\u30A3\u30D6\u30D7\u30E9\u30F3{label} \u2014 {done}/{total} \u30B9\u30C6\u30C3\u30D7\u5B8C\u4E86 \xB7 \u6700\u7D42\u66F4\u65B0 {when}",
      activeNone: "\u25B8 \u30A2\u30AF\u30C6\u30A3\u30D6\u30D7\u30E9\u30F3: \uFF08\u306A\u3057\uFF09",
      noArchives: "\u3053\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u306B\u306F\u307E\u3060\u30A2\u30FC\u30AB\u30A4\u30D6\u6E08\u307F\u30D7\u30E9\u30F3\u304C\u3042\u308A\u307E\u305B\u3093 \u2014 \u5168\u30B9\u30C6\u30C3\u30D7\u5B8C\u4E86\u6642\u306B\u81EA\u52D5\u30A2\u30FC\u30AB\u30A4\u30D6\u3055\u308C\u307E\u3059",
      archivedHeader: "\u30A2\u30FC\u30AB\u30A4\u30D6 ({count}):",
      evidencePending: "  ! \u30A8\u30D3\u30C7\u30F3\u30B9\u4FDD\u7559\u4E2D \u2014 \u73FE\u5728\u306E\u30B9\u30C6\u30C3\u30D7\u306B\u691C\u8A3C/\u5DEE\u5206/\u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8/\u624B\u52D5\u30A8\u30D3\u30C7\u30F3\u30B9\u304C\u5FC5\u8981\u3067\u3059",
      evidenceLine: "  \u30A8\u30D3\u30C7\u30F3\u30B9 {stepId}: {summary}",
      archivedEvidenceLine: "    \u30A8\u30D3\u30C7\u30F3\u30B9: {summary}",
      replayNoSession: "\u30BB\u30C3\u30B7\u30E7\u30F3\u304C\u63A5\u7D9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093 \u2014 `/replay` \u306F\u30BB\u30C3\u30B7\u30E7\u30F3\u3054\u3068\u3067\u3059\u3002\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3067 `reasonix code` \u3092\u5B9F\u884C\u3059\u308B\u3068\u30BB\u30C3\u30B7\u30E7\u30F3\u304C\u53D6\u5F97\u3067\u304D\u307E\u3059\u3002",
      replayNoArchives: "\u3053\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u306B\u306F\u307E\u3060\u30A2\u30FC\u30AB\u30A4\u30D6\u6E08\u307F\u30D7\u30E9\u30F3\u304C\u3042\u308A\u307E\u305B\u3093 \u2014 \u30D7\u30E9\u30F3\u304C\u5B8C\u4E86\u3059\u308B\u3068 `/replay` \u304C\u4F7F\u3048\u308B\u3088\u3046\u306B\u306A\u308A\u307E\u3059\uFF08\u5168\u30B9\u30C6\u30C3\u30D7\u5B8C\u4E86\u6642\u306B\u81EA\u52D5\u30A2\u30FC\u30AB\u30A4\u30D6\uFF09\u3002",
      replayInvalidIndex: "\u7121\u52B9\u306A\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9 \u2014 `/replay` \u306F 1..{max} \u3092\u53D6\u308A\u307E\u3059\uFF08\u6700\u65B0 = 1\uFF09\u3002`/plans` \u3067\u4E00\u89A7\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      archivedRow: "  \u2713 {when}  {total} \u30B9\u30C6\u30C3\u30D7 \xB7 {completion}  {label}",
      completionComplete: "\u5B8C\u4E86",
      stopAborted: "\u25B8 \u30D7\u30E9\u30F3\u304C\u505C\u6B62\u3057\u307E\u3057\u305F \u2014 \u30E2\u30C7\u30EB\u304C\u4E2D\u65AD\u3055\u308C\u307E\u3057\u305F; \u30D5\u30A9\u30ED\u30FC\u30A2\u30C3\u30D7\u3092\u5165\u529B\u3057\u3066\u7D9A\u884C\u3059\u308B\u304B\u3001\u65B0\u3057\u3044\u30BF\u30B9\u30AF\u3092\u958B\u59CB\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      doneUsage: "\u4F7F\u3044\u65B9: /plans done <stepId>  \xB7  /plans done all \u2014 \u30E2\u30C7\u30EB\u304C mark_step_complete \u306E\u547C\u3073\u51FA\u3057\u3092\u5FD8\u308C\u305F\u5834\u5408\u306E\u624B\u52D5\u4E0A\u66F8\u304D",
    ...
    memory: {
      ...EN.handlers.memory,
      disabled: "\u30E1\u30E2\u30EA\u304C\u7121\u52B9\u3067\u3059\uFF08REASONIX_MEMORY=off \u304C\u74B0\u5883\u5909\u6570\u306B\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u3059\uFF09\u3002\u5909\u6570\u3092\u89E3\u9664\u3057\u3066\u518D\u6709\u52B9\u5316\u3057\u3066\u304F\u3060\u3055\u3044 \u2014 \u305D\u306E\u9593\u3001REASONIX.md \u3084 ~/.reasonix/memory \u306E\u5185\u5BB9\u306F\u30D4\u30F3\u7559\u3081\u3055\u308C\u307E\u305B\u3093\u3002",
      noRoot: "\u3053\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u306B\u306F\u4F5C\u696D\u30C7\u30A3\u30EC\u30AF\u30C8\u30EA\u304C\u3042\u308A\u307E\u305B\u3093 \u2014 `/memory` \u306F REASONIX.md \u3092\u89E3\u6C7A\u3059\u308B\u305F\u3081\u306E\u30EB\u30FC\u30C8\u304C\u5FC5\u8981\u3067\u3059\u3002\uFF08\u30C6\u30B9\u30C8\u30CF\u30FC\u30CD\u30B9\u3067\u5B9F\u884C\u4E2D\u3067\u3059\u304B\uFF1F\uFF09",
      listEmpty: "\u307E\u3060\u30E6\u30FC\u30B6\u30FC\u30E1\u30E2\u30EA\u304C\u3042\u308A\u307E\u305B\u3093\u3002\u30E2\u30C7\u30EB\u304C `remember` \u3092\u547C\u3073\u51FA\u3057\u3066\u4FDD\u5B58\u3059\u308B\u304B\u3001~/.reasonix/memory/global/ \u307E\u305F\u306F\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u3054\u3068\u306E\u30B5\u30D6\u30C7\u30A3\u30EC\u30AF\u30C8\u30EA\u306B\u624B\u52D5\u3067\u30D5\u30A1\u30A4\u30EB\u3092\u4F5C\u6210\u3067\u304D\u307E\u3059\u3002",
      ...
      clearConfirm: "scope={scope} \u306E\u3059\u3079\u3066\u306E\u30E1\u30E2\u30EA\u3092\u524A\u9664\u3057\u3088\u3046\u3068\u3057\u3066\u3044\u307E\u3059\u3002'confirm' \u3092\u4ED8\u3051\u3066\u518D\u5B9F\u884C\u3059\u308B\u3068\u7D9A\u884C\u3057\u307E\u3059: /memory clear {scope} confirm",
      ...
      changesNote: "\u5909\u66F4\u306F\u6B21\u56DE\u306E /new \u307E\u305F\u306F\u8D77\u52D5\u6642\u306B\u53CD\u6620\u3055\u308C\u307E\u3059 \u2014 \u30D7\u30EC\u30D5\u30A3\u30C3\u30AF\u30B9\u30AD\u30E3\u30C3\u30B7\u30E5\u3092\u4FDD\u6E29\u3059\u308B\u305F\u3081\u3001\u30B7\u30B9\u30C6\u30E0\u30D7\u30ED\u30F3\u30D7\u30C8\u306F\u30BB\u30C3\u30B7\u30E7\u30F3\u3054\u3068\u306B1\u56DE\u30CF\u30C3\u30B7\u30E5\u5316\u3055\u308C\u307E\u3059\u3002",
      subcommands: "\u30B5\u30D6\u30B3\u30DE\u30F3\u30C9: /memory list | /memory show <name> | /memory forget <name> | /memory clear <scope> confirm",
      changesNoteShort: "\u5909\u66F4\u306F\u6B21\u56DE\u306E /new \u307E\u305F\u306F\u8D77\u52D5\u6642\u306B\u53CD\u6620\u3055\u308C\u307E\u3059\u3002\u30B5\u30D6\u30B3\u30DE\u30F3\u30C9: /memory list | show | forget | clear"
    },
    mcp: {
      ...EN.handlers.mcp,
      noServers: 'MCP\u30B5\u30FC\u30D0\u30FC\u304C\u63A5\u7D9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002`reasonix setup` \u3092\u5B9F\u884C\u3057\u3066\u9078\u629E\u3059\u308B\u304B\u3001--mcp "<spec>" \u3067\u8D77\u52D5\u3057\u3066\u304F\u3060\u3055\u3044\u3002`reasonix mcp list` \u3067\u30AB\u30BF\u30ED\u30B0\u3092\u8868\u793A\u3057\u307E\u3059\u3002\u6CE8\u610F: \u30E2\u30C7\u30EB\u8D77\u52D5\u306E\u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u306F\u547C\u3073\u51FA\u3057\u3054\u3068\u306B\u5236\u5FA1\u3055\u308C\u307E\u3059\uFF08allow once / allow always / deny\uFF09\u2014 \u5168\u8A31\u53EF\u30D5\u30E9\u30B0\u306F\u3042\u308A\u307E\u305B\u3093\u3002',
      toolsLabel: "  tools     {count}",
      resourcesHint: "`/resource` \u3067\u95B2\u89A7+\u8AAD\u53D6",
      promptsHint: "`/prompt` \u3067\u95B2\u89A7+\u53D6\u5F97",
      awarenessOnly: "\u30C1\u30E3\u30C3\u30C8\u30E2\u30FC\u30C9\u306F\u73FE\u5728\u30C4\u30FC\u30EB\u306E\u307F\u5229\u7528; \u30EA\u30BD\u30FC\u30B9\u3068\u30D7\u30ED\u30F3\u30D7\u30C8\u306F\u53C2\u7167\u7528\u306B\u3053\u3053\u306B\u8868\u793A\u3055\u308C\u3066\u3044\u307E\u3059\u3002",
      catalogHint: "\u5B8C\u5168\u306A\u30AB\u30BF\u30ED\u30B0: `reasonix mcp list` \xB7 \u8A73\u7D30\u8A3A\u65AD: `reasonix mcp inspect <spec>`\u3002",
      fallbackServers: "MCP\u30B5\u30FC\u30D0\u30FC ({count}):",
      fallbackTools: "\u767B\u9332\u6E08\u307F\u30C4\u30FC\u30EB ({count}):",
      fallbackChange: "\u3053\u306E\u30BB\u30C3\u30C8\u3092\u5909\u66F4\u3059\u308B\u306B\u306F\u3001\u7D42\u4E86\u3057\u3066 `reasonix setup` \u3092\u5B9F\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      usageDisableEnable: "\u4F7F\u3044\u65B9: /mcp {action} <name>  \xB7  /mcp \u306B\u8868\u793A\u3055\u308C\u308B\u540D\u524D\u3092\u9078\u629E\uFF08\u533F\u540D\u30B5\u30FC\u30D0\u30FC\u306F\u540D\u524D\u3067\u5207\u308A\u66FF\u3048\u4E0D\u53EF\uFF09\u3002",
      usageReconnect: "\u4F7F\u3044\u65B9: /mcp reconnect <name>  \xB7  /mcp \u306B\u8868\u793A\u3055\u308C\u308B\u540D\u524D\u3092\u9078\u629E\u3002",
    ...
    webSearchEngine: {
      ...
      usageHeader: "\u4F7F\u3044\u65B9:",
      usageBing: "  /search-engine bing              Bing\u3092\u4F7F\u7528\uFF08\u30C7\u30D5\u30A9\u30EB\u30C8\u3001\u30D7\u30ED\u30AD\u30B7\u306A\u3057\u3067\u4E2D\u56FD\u304B\u3089\u5229\u7528\u53EF\uFF09",
      ...
      usageMetaso: "  /search-engine metaso              Metaso API\u3092\u4F7F\u7528\uFF08100\u56DE/\u65E5\u7121\u6599\u3001\u72EC\u81EAAPI\u30AD\u30FC\u3067\u4E0A\u9650\u5897\uFF09",
      usageBaidu: "  /search-engine baidu               Baidu AI Search API\u3092\u4F7F\u7528\uFF08\u516C\u5F0F\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u3067\u306F1500\u56DE/\u6708\u7121\u6599 \u2014 BAIDU_API_KEY \u307E\u305F\u306F QIANFAN_API_KEY \u3092\u8A2D\u5B9A\uFF09",
      usageTavily: "  /search-engine tavily              Tavily API\u3092\u4F7F\u7528\uFF08LLM\u5411\u3051\u3001\u7121\u65991000\u56DE/\u6708 \u2014 TAVILY_API_KEY \u307E\u305F\u306F tavilyApiKey \u3092\u8A2D\u5B9A; https://tavily.com \u3067\u53D6\u5F97\uFF09",
      usagePerplexity: "  /search-engine perplexity          Perplexity AI\u3092\u4F7F\u7528\uFF08AI\u30CD\u30A4\u30C6\u30A3\u30D6\u56DE\u7B54+\u5F15\u7528 \u2014 PERPLEXITY_API_KEY \u307E\u305F\u306F perplexityApiKey \u3092\u8A2D\u5B9A; https://perplexity.ai/settings/api \u3067\u53D6\u5F97\uFF09",
      usageExa: "  /search-engine exa                 Exa API\u3092\u4F7F\u7528\uFF08AI\u30CD\u30A4\u30C6\u30A3\u30D6\u56DE\u7B54+\u5F15\u7528\u3001\u7121\u65991000\u56DE/\u6708 \u2014 EXA_API_KEY \u307E\u305F\u306F exaApiKey \u3092\u8A2D\u5B9A; https://exa.ai \u3067\u767B\u9332\uFF09",
      usageBingIntl: "  /search-engine bing-intl          Bing\u56FD\u969B\u7248\u3092\u4F7F\u7528\uFF08www.bing.com\u3001GitHub/Wikipedia/Stack Overflow\u3092\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9\uFF09",
      usageOllama: "  /search-engine ollama              Ollama\u30AF\u30E9\u30A6\u30C9Web\u691C\u7D22\u3092\u4F7F\u7528 \u2014 OLLAMA_API_KEY \u307E\u305F\u306F config\u306EollamaApiKey\u3092\u8A2D\u5B9A; https://ollama.com/settings/keys \u3067\u53D6\u5F97",
      usageBrave: "  /search-engine brave               Brave Search API\u3092\u4F7F\u7528\uFF08\u72EC\u7ACB\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9\u3001\u67082000\u56DE\u7121\u6599 \u2014 BRAVE_SEARCH_API_KEY \u307E\u305F\u306F braveApiKey \u3092\u8A2D\u5B9A; https://brave.com/search/api/ \u3067\u53D6\u5F97\uFF09",
      alias: "\u30A8\u30A4\u30EA\u30A2\u30B9: /se",
      searxngInfo: "SearXNG \u306F\u30BB\u30EB\u30D5\u30DB\u30B9\u30C8\u306E\u30E1\u30BF\u30B5\u30FC\u30C1\u30A8\u30F3\u30B8\u30F3\u3067\u3059\uFF08https://github.com/searxng/searxng\uFF09\u3002",
      ...
      switchedBaiduNote: " BAIDU_API_KEY\u3001QIANFAN_API_KEY\u3001\u307E\u305F\u306F config \u306E `baiduApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002Baidu\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u306B\u306F\u67081500\u56DE\u7121\u6599\u3068\u8A18\u8F09\u3055\u308C\u3066\u3044\u307E\u3059\u3002",
      switchedTavilyNote: " TAVILY_API_KEY \u307E\u305F\u306F `tavilyApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044; \u7121\u65991000\u56DE/\u6708 https://tavily.com\u3002",
      switchedPerplexityNote: " PERPLEXITY_API_KEY \u307E\u305F\u306F `perplexityApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044; https://perplexity.ai/settings/api \u3067\u53D6\u5F97\u3002",
      switchedExaNote: " EXA_API_KEY \u307E\u305F\u306F `exaApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044; https://exa.ai \u3067\u767B\u9332\u3002",
      switchedOllamaNote: " OLLAMA_API_KEY \u307E\u305F\u306F config\u306E `ollamaApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044; https://ollama.com/settings/keys \u3067\u53D6\u5F97\u3002",
      switchedBraveNote: " BRAVE_SEARCH_API_KEY (\u307E\u305F\u306F BRAVE_API_KEY) \u307E\u305F\u306F `braveApiKey` \u3092config\u306B\u8A2D\u5B9A; https://brave.com/search/api/ \u3067\u67082000\u56DE\u7121\u6599\u3002",
      keyNeeded: '"{engine}" \u306EAPI\u30AD\u30FC\u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002\n\n  1. {envVar} \u74B0\u5883\u5909\u6570\u3092\u8A2D\u5B9A\n  2. \u307E\u305F\u306F\u30A4\u30F3\u30E9\u30A4\u30F3\u3067\u63D0\u4F9B:  /search-engine {engine} <your-key>\n  3. \u307E\u305F\u306F "{engine}ApiKey" \u3092 ~/.reasonix/config.json \u306B\u8FFD\u52A0\n\n\u305D\u306E\u5F8C /search-engine {engine} \u3092\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002',
      keySaved: " API\u30AD\u30FC\u3092\u8A2D\u5B9A\u306B\u4FDD\u5B58\u3057\u307E\u3057\u305F\u3002",
      confirmed: 'Web\u691C\u7D22\u30A8\u30F3\u30B8\u30F3\u3092 "{engine}"{detail} \u306B\u8A2D\u5B9A\u3057\u307E\u3057\u305F\u3002\u6B21\u306E\u30A2\u30B7\u30B9\u30BF\u30F3\u30C8\u30BF\u30FC\u30F3\u3067\u53CD\u6620\u3055\u308C\u307E\u3059\u3002',
      confirmedDetail: " ({endpoint})"
    },
    skill: {
      ...EN.handlers.skill,
      listEmpty: "\u30B9\u30AD\u30EB\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002Reasonix \u306F\u4EE5\u4E0B\u304B\u3089\u30B9\u30AD\u30EB\u3092\u8AAD\u307F\u53D6\u308A\u307E\u3059:",
      listProjectScope: "  \xB7 <project>/.reasonix/skills/<name>/SKILL.md  \uFF08\u307E\u305F\u306F <name>.md\uFF09 \u2014 \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30B9\u30B3\u30FC\u30D7",
      listGlobalScope: "  \xB7 ~/.reasonix/skills/<name>/SKILL.md  \uFF08\u307E\u305F\u306F <name>.md\uFF09 \u2014 \u30B0\u30ED\u30FC\u30D0\u30EB\u30B9\u30B3\u30FC\u30D7",
      listProjectOnly: "  \uFF08\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30B9\u30B3\u30FC\u30D7\u306F `reasonix code` \u5185\u3067\u306E\u307F\u30A2\u30AF\u30C6\u30A3\u30D6\uFF09",
      listFrontmatter: "\u5404\u30D5\u30A1\u30A4\u30EB\u306E\u30D5\u30ED\u30F3\u30C8\u30DE\u30BF\u30FC\u306B\u306F\u5C11\u306A\u304F\u3068\u3082 `name` \u3068 `description` \u304C\u5FC5\u8981\u3067\u3059\u3002",
      listInvoke: "\u30B9\u30AD\u30EB\u306F `/skill <name> [args]` \u3067\u547C\u3073\u51FA\u3059\u304B\u3001\u30E2\u30C7\u30EB\u306B `run_skill` \u306E\u547C\u3073\u51FA\u3057\u3092\u4F9D\u983C\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      listHeader: "\u30E6\u30FC\u30B6\u30FC\u30B9\u30AD\u30EB ({count}):",
      listFooter: "\u8868\u793A: /skill show <name>   \u5B9F\u884C: /skill <name> [args]   \u65B0\u898F: /skill new <name>",
      listEmptyNewHint: "/skill new <name> \u3067\u96DB\u5F62\u3092\u4F5C\u6210\uFF08\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u30B9\u30B3\u30FC\u30D7\uFF09\u2014 \u30EA\u30E2\u30FC\u30C8\u30EC\u30B8\u30B9\u30C8\u30EA\u306F\u307E\u3060\u3042\u308A\u307E\u305B\u3093; \u30B9\u30AD\u30EB\u306F\u76F4\u63A5\u4F5C\u6210\u3057\u307E\u3059\u3002",
      ...
      pathsPriority: "\u512A\u5148\u9806: \u30D7\u30ED\u30B8\u30A7\u30AF\u30C8 > \u8A2D\u5B9A\u306E\u30AB\u30B9\u30BF\u30E0\u30D1\u30B9\u9806 > \u30B0\u30ED\u30FC\u30D0\u30EB > \u30D3\u30EB\u30C8\u30A4\u30F3\u3002\u5909\u66F4\u306F\u6B21\u56DE /new \u307E\u305F\u306F\u65B0\u898F\u30BB\u30C3\u30B7\u30E7\u30F3\u3067\u30B7\u30B9\u30C6\u30E0\u30D7\u30ED\u30F3\u30D7\u30C8\u306B\u53CD\u6620\u3055\u308C\u307E\u3059\u3002",
      pathsUsage: "\u4F7F\u3044\u65B9: /skill paths [list]\n       /skill paths add <path>\n       /skill paths remove <path|N>",
      ...
      pathsRestartHint: "\u73FE\u5728\u306E\u30BB\u30C3\u30B7\u30E7\u30F3\u306E\u30B7\u30B9\u30C6\u30E0\u30D7\u30ED\u30F3\u30D7\u30C8\u306F\u5909\u66F4\u3055\u308C\u3066\u3044\u307E\u305B\u3093; /new \u3092\u5B9F\u884C\u3059\u308B\u304B\u65B0\u898F\u30BB\u30C3\u30B7\u30E7\u30F3\u3092\u958B\u59CB\u3057\u3066\u30B9\u30AD\u30EB\u30A4\u30F3\u30C7\u30C3\u30AF\u30B9\u3092\u66F4\u65B0\u3057\u3066\u304F\u3060\u3055\u3044\u3002"
    }
  },
  statusBar: {
    ...EN.statusBar,
  ...
  editMode: {
    ...
    auto: "AUTO",
    review: "REVIEW",
    writesGated: "   \u66F8\u304D\u8FBC\u307F\u5236\u5FA1\u4E2D \xB7 /plan off \u3067\u89E3\u9664",
    editsShellAuto: "\u7DE8\u96C6+\u30B7\u30A7\u30EB\u81EA\u52D5 \xB7 /undo \u3067\u30ED\u30FC\u30EB\u30D0\u30C3\u30AF",
    editsLandNow: "\u7DE8\u96C6\u5373\u6642\u9069\u7528 \xB7 u \u3067\u53D6\u6D88",
    queuedApplyDiscard: "{count} \u4EF6\u30AD\u30E5\u30FC \xB7 y \u9069\u7528 \xB7 n \u7834\u68C4",
    editsQueued: "\u7DE8\u96C6\u4E2D \xB7 y \u9069\u7528 \xB7 n \u7834\u68C4",
    shiftTabFlip: "   {mid} \xB7 Shift+Tab \u3067\u5207\u66FF",
    queuedDots: "\u30AD\u30E5\u30FC\u4E2D\u2026"
  },
  composer: {
    ...EN.composer,
    placeholder: "\u4F55\u3067\u3082\u805E\u3044\u3066\u304F\u3060\u3055\u3044  \xB7  \u30B9\u30E9\u30C3\u30B7\u30E5\u3067\u30B3\u30DE\u30F3\u30C9  \xB7  \u30A2\u30C3\u30C8\u30DE\u30FC\u30AF\u3067\u30D5\u30A1\u30A4\u30EB",
    ...
    hintAbort: "\u4E2D\u65AD",
    hintQuit: "\u7D42\u4E86",
    abortedHint: "\u30E6\u30FC\u30B6\u30FC\u306B\u3088\u308A\u30BF\u30FC\u30F3\u4E2D\u65AD \xB7 \u3082\u3046\u4E00\u5EA6esc\u3067\u30AF\u30EA\u30A2 \xB7 \u23CE \u3067\u30D5\u30A9\u30ED\u30FC\u30A2\u30C3\u30D7",
    editorNoRawMode: "\u5916\u90E8\u30A8\u30C7\u30A3\u30BF\u304C\u5229\u7528\u3067\u304D\u307E\u305B\u3093 \u2014 \u3053\u306E\u7AEF\u672B\u3067\u306Fstdin\u306Eraw-mode\u5207\u66FF\u304C\u30B5\u30DD\u30FC\u30C8\u3055\u308C\u3066\u3044\u307E\u305B\u3093",
    editorFailed: "\u5916\u90E8\u30A8\u30C7\u30A3\u30BF:",
    editorMissing: "$EDITOR / $VISUAL / $GIT_EDITOR \u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093 \u2014 \u3044\u305A\u308C\u304B\u3092\u30A8\u30AF\u30B9\u30DD\u30FC\u30C8\u3057\u3066\uFF08\u4F8B: `export EDITOR=nano`\uFF09\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    editorExited: "\u30A8\u30C7\u30A3\u30BF\u304C\u30B3\u30FC\u30C9 {code} \u3067\u7D42\u4E86\u3057\u307E\u3057\u305F",
    typeaheadStaged: "\u25B8 {count} \u884C\u3092\u30B9\u30C6\u30FC\u30B8\u30F3\u30B0 \xB7 esc \u3067\u547C\u3073\u623B\u3057",
  ...
  pathConfirm: {
    ...
    optional: "\u4EFB\u610F",
    denyFooter: "\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u3092\u5165\u529B  \xB7  \u23CE \u7406\u7531\u3092\u6DFB\u3048\u3066\u9001\u4FE1  \xB7  esc \u30B9\u30AD\u30C3\u30D7\uFF08\u7406\u7531\u306A\u3057\u3067\u62D2\u5426\uFF09",
    pickFooter: "\u2191\u2193 \u9078\u629E  \xB7  \u23CE \u78BA\u5B9A  \xB7  Tab \u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u8FFD\u52A0  \xB7  esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    allowOnce: "\u4E00\u5EA6\u3060\u3051\u8A31\u53EF",
  ...
  editConfirm: {
    ...EN.editConfirm,
    footer: "[y/Enter] \u9069\u7528  \xB7  [n] \u7406\u7531\u3092\u6DFB\u3048\u3066\u62D2\u5426  \xB7  [a] \u6B8B\u308A\u3092\u9069\u7528  \xB7  [A] AUTO\u306B\u5207\u66FF  \xB7  [\u2191\u2193/Space] \u30B9\u30AF\u30ED\u30FC\u30EB  \xB7  [Esc] \u4E2D\u65AD",
    newTag: "\u65B0\u898F",
    editTag: "\u7DE8\u96C6",
    linesCount: "-{removed} +{added} \u884C",
    viewingRange: "{start}-{end}/{total} \u3092\u8868\u793A\u4E2D",
    denyFooter: "\u23CE \u9001\u4FE1  \xB7  esc \u30B9\u30AD\u30C3\u30D7\uFF08\u7406\u7531\u306A\u3057\u3067\u62D2\u5426\uFF09",
    oldLabel: "  - \u65E7",
    newLabel: "  + \u65B0",
    sideBySide: "   \u30B5\u30A4\u30C9\u30D0\u30A4\u30B5\u30A4\u30C9 \xB7 \u5DE6\u304C\u524A\u9664\u884C\u3001\u53F3\u304C\u8FFD\u52A0\u884C \xB7 \u30AA\u30D5\u30BB\u30C3\u30C8\u3067\u30DA\u30A2\u30EA\u30F3\u30B0",
  ...
  editPicker: {
    ...EN.editPicker,
    title: "\u524D\u306E\u30E1\u30C3\u30BB\u30FC\u30B8\u3092\u7DE8\u96C6",
    hint: "\u2191\u2193 \u9078\u629E \xB7 Enter \u3067 composer \u306B\u8AAD\u307F\u8FBC\u307F \xB7 Esc \u3067\u30AD\u30E3\u30F3\u30BB\u30EB",
  ...
  sessionPicker: {
    ...EN.sessionPicker,
    header: " \u25C8 REASONIX \xB7 \u30BB\u30C3\u30B7\u30E7\u30F3\u3092\u9078\u629E ",
    title: "\u30BB\u30C3\u30B7\u30E7\u30F3\u3092\u9078\u629E \u2014 {workspace}",
    messages: "{count} \u30E1\u30C3\u30BB\u30FC\u30B8",
    messagesPlural: "{count} \u30E1\u30C3\u30BB\u30FC\u30B8",
    turns: "{count} \u30BF\u30FC\u30F3",
    pickerHint: "\u2191\u2193 \u9078\u629E \xB7 / \u691C\u7D22 \xB7 \u23CE \u958B\u304F \xB7 [n] \u65B0\u898F \xB7 [d] \u524A\u9664 \xB7 [r] \u540D\u524D\u5909\u66F4 \xB7 esc \u7D42\u4E86",
    empty: "  \u3053\u306E\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u306B\u4FDD\u5B58\u6E08\u307F\u30BB\u30C3\u30B7\u30E7\u30F3\u306F\u307E\u3060\u3042\u308A\u307E\u305B\u3093 \u2014 ",
    emptyNew: " \u3092\u62BC\u3057\u3066\u65B0\u898F\u4F5C\u6210",
    renamePrompt: '  "{from}" \u306E\u540D\u524D\u5909\u66F4 \u2192 ',
    renameHint: "  \u23CE \u540D\u524D\u5909\u66F4\u3092\u78BA\u5B9A  \xB7  esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    searchPrompt: "  \u30BB\u30C3\u30B7\u30E7\u30F3\u691C\u7D22: /",
    searchHint: "  \u5165\u529B\u3067\u30D5\u30A3\u30EB\u30BF  \xB7  \u23CE \u4E00\u81F4\u3092\u958B\u304F  \xB7  esc \u30AF\u30EA\u30A2",
    searchEmpty: "  \u691C\u7D22\u306B\u4E00\u81F4\u3059\u308B\u30BB\u30C3\u30B7\u30E7\u30F3\u306F\u3042\u308A\u307E\u305B\u3093",
    emptyHint: "  \u23CE \u65B0\u898F\u30BB\u30C3\u30B7\u30E7\u30F3  \xB7  esc \u7D42\u4E86",
    justNow: "\u305F\u3063\u305F\u4ECA",
    minAgo: "{count} \u5206\u524D",
    yesterday: "\u6628\u65E5",
    hoursAgo: "{count}\u6642\u9593\u524D",
  ...
  workspacePicker: {
    ...EN.workspacePicker,
    header: " \u25C8 REASONIX \xB7 \u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u3092\u9078\u629E ",
    title: "\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u3092\u9078\u629E \u2014 {workspace}",
    sessions: "{count} \u30BB\u30C3\u30B7\u30E7\u30F3",
    sessionsPlural: "{count} \u30BB\u30C3\u30B7\u30E7\u30F3",
    current: "\u73FE\u5728",
    pickerHint: "\u2191\u2193 \u9078\u629E \xB7 / \u691C\u7D22 \xB7 \u23CE \u5207\u66FF+\u30BB\u30C3\u30B7\u30E7\u30F3\u9078\u629E \xB7 esc \u7D42\u4E86 \xB7 /cwd <path> \u3067\u8FFD\u52A0",
    empty: "  \u65E2\u77E5\u306E\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u306F\u307E\u3060\u3042\u308A\u307E\u305B\u3093 \u2014 /cwd <path> \u3092\u5B9F\u884C\u3057\u3066\u8FFD\u52A0\u3057\u3066\u304F\u3060\u3055\u3044",
    searchPrompt: "  \u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u691C\u7D22: /",
    searchHint: "  \u5165\u529B\u3067\u30D5\u30A3\u30EB\u30BF  \xB7  \u23CE \u5207\u66FF+\u30BB\u30C3\u30B7\u30E7\u30F3\u9078\u629E  \xB7  esc \u30AF\u30EA\u30A2",
    searchEmpty: "  \u691C\u7D22\u306B\u4E00\u81F4\u3059\u308B\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u306F\u3042\u308A\u307E\u305B\u3093"
  },
  modelPicker: {
    ...EN.modelPicker,
    header: " \u25C8 REASONIX \xB7 \u8A2D\u5B9A\u3092\u9078\u629E ",
    loading: "  \xB7  \u30AB\u30BF\u30ED\u30B0\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026",
    catalogEmpty: "  \xB7  \u30AB\u30BF\u30ED\u30B0\u304C\u7A7A\u3067\u3059 \u2014 \u65E2\u77E5\u306E\u30D5\u30A9\u30FC\u30EB\u30D0\u30C3\u30AF\u3092\u4F7F\u7528",
    modelsAvailable: "  \xB7  {count} \u30E2\u30C7\u30EB\u5229\u7528\u53EF\u80FD",
    effortHeader: "    EFFORT  \xB7  reasoning_effort \u4E0A\u9650",
    modelsHeader: "    MODELS  \xB7  DeepSeek\u4E92\u63DBID",
    effortDesc: {
    ...
    pickerFooter: "  \u2191\u2193 \u9078\u629E  \xB7  \u23CE \u78BA\u5B9A  \xB7  [r] \u66F4\u65B0  \xB7  esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    currentLabel: "  \xB7 \u73FE\u5728"
  },
  slashSuggestions: {
    ...EN.slashSuggestions,
    ...
    advancedHint: "  + {count} \u4EF6\u306E\u8A73\u7D30  \xB7  \u6587\u5B57\u3092\u5165\u529B\u3057\u3066\u691C\u7D22",
    footerHint: "  \u2191\u2193 \u79FB\u52D5 \xB7 Tab / \u23CE \u9078\u629E \xB7 esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    groupChat: "\u30C1\u30E3\u30C3\u30C8",
    groupSetup: "\u8A2D\u5B9A",
    groupInfo: "\u60C5\u5831",
    groupSession: "\u30BB\u30C3\u30B7\u30E7\u30F3",
  ...
  atMentions: {
    ...
    emptyDir: "\u7A7A\u306E\u30C7\u30A3\u30EC\u30AF\u30C8\u30EA",
    scanning: "\u30C4\u30EA\u30FC\u3092\u30B9\u30AD\u30E3\u30F3\u4E2D\u2026",
    footerBrowse: "\u2191\u2193 \u79FB\u52D5 \xB7 Tab \u30D5\u30A9\u30EB\u30C0\u5C55\u958B \xB7 \u23CE \u633F\u5165 \xB7 esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    footerBrowseSearch: "\u2191\u2193 \u79FB\u52D5 \xB7 Tab / \u23CE @path \u3068\u3057\u3066\u633F\u5165 \xB7 esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    footerInsert: "\u2191\u2193 \u79FB\u52D5 \xB7 Tab / \u23CE @path \u3068\u3057\u3066\u633F\u5165 \xB7 esc \u30AD\u30E3\u30F3\u30BB\u30EB"
  },
  statsPanel: {
    ...EN.statsPanel,
    modePlan: "PLAN",
  ...
  ctxBreakdown: {
    ...EN.ctxBreakdown,
    title: "\u25A3 \u30B3\u30F3\u30C6\u30AD\u30B9\u30C8",
    compactHint: "  /compact \u3067\u6298\u308A\u305F\u305F\u307F\uFF0850%\u3067\u81EA\u52D5\uFF09\xB7 /new \u3067\u30ED\u30B0\u6D88\u53BB",
  ...
  startup: {
    ...EN.startup,
    codeRooted: '\u25B8 reasonix code: \u30EB\u30FC\u30C8 {rootDir}, \u30BB\u30C3\u30B7\u30E7\u30F3 "{session}" \xB7 {tools} \u30CD\u30A4\u30C6\u30A3\u30D6\u30C4\u30FC\u30EB{semantic}',
    ephemeral: "\uFF08\u30A8\u30D5\u30A7\u30E1\u30E9\u30EB\uFF09",
    semanticOn: " \xB7 semantic_search \u30AA\u30F3"
  },
  doctorErrors: {
    ...EN.doctorErrors,
  ...
  webErrors: {
    ...EN.webErrors,
    status: "web_search {status} \u2014 \u5BFE\u51E6: \u691C\u7D22\u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u304C\u30A8\u30E9\u30FC\u3092\u8FD4\u3057\u307E\u3057\u305F\u3002\u30AF\u30A8\u30EA\u3092\u8A00\u3044\u63DB\u3048\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    rateLimit429: "web_search 429 \u2014 \u5BFE\u51E6: 10\u79D2\u5F85\u3063\u3066\u304B\u3089\u518D\u8A66\u884C\u3059\u308B\u304B\u3001\u30AF\u30A8\u30EA\u3092\u8A00\u3044\u63DB\u3048\u3066\u304F\u3060\u3055\u3044\u3002\u691C\u7D22\u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u304C\u3053\u306E\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u3092\u30EC\u30FC\u30C8\u5236\u9650\u3057\u3066\u3044\u307E\u3059",
    forbidden403: "web_search 403 \u2014 \u5BFE\u51E6: \u691C\u7D22\u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u304C\u3053\u306E\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u3092\u30D6\u30ED\u30C3\u30AF\u3057\u3066\u3044\u307E\u3059\u3002/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u308B\u304B\u3001\u3057\u3070\u3089\u304F\u5F85\u3063\u3066\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    serverError5xx: "web_search {status} \u2014 \u5BFE\u51E6: \u691C\u7D22URL\u3092\u30D6\u30E9\u30A6\u30B6\u3067\u958B\u3044\u3066\u307F\u3066\u304F\u3060\u3055\u3044\u3002\u8AAD\u307F\u8FBC\u3081\u308B\u5834\u5408\u306F\u4E00\u6642\u7684\u306A\u554F\u984C\u3067\u300130\u79D2\u5F8C\u306B\u518D\u8A66\u884C\u3059\u308B\u3068\u6539\u5584\u3059\u308B\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059",
    bingBlocked: "web_search: Bing\u306E\u30A2\u30F3\u30C1\u30DC\u30C3\u30C8\u30DA\u30FC\u30B8 \u2014 \u30EC\u30FC\u30C8\u5236\u9650\u307E\u305F\u306F\u30D6\u30ED\u30C3\u30AF\u3055\u308C\u307E\u3057\u305F \u2014 \u5BFE\u51E6: 30\u79D2\u5F85\u3063\u3066\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    bingNoResults: "web_search: 0\u4EF6\u306E\u7D50\u679C\u3067\u3059\u304C\u3001\u30EC\u30B9\u30DD\u30F3\u30B9\u304C\u5B9F\u969B\u306E\u7A7A\u30DA\u30FC\u30B8\u3068\u306F\u7570\u306A\u308A\u307E\u3059\uFF08{chars}\u6587\u5B57\u3001\u5148\u982D120: {preview}\uFF09\u2014 \u5BFE\u51E6: \u3088\u308A\u7C21\u5358\u306A\u7528\u8A9E\u3067\u30AF\u30A8\u30EA\u3092\u8A00\u3044\u63DB\u3048\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    invalidEndpoint: 'web_search: \u7121\u52B9\u306ASearXNG\u30A8\u30F3\u30C9\u30DD\u30A4\u30F3\u30C8 "{endpoint}" \u2014 \u5BFE\u51E6: /search-endpoint http://host:port \u3067\u6709\u52B9\u306AURL\u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044',
    endpointMustBeHttp: "web_search: SearXNG\u30A8\u30F3\u30C9\u30DD\u30A4\u30F3\u30C8\u306Fhttp(s)\u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u304C\u3001{protocol} \u304C\u6307\u5B9A\u3055\u308C\u307E\u3057\u305F \u2014 \u5BFE\u51E6: /search-endpoint http://host:port \u3067\u6709\u52B9\u306AURL\u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044",
    cannotReach: "web_search: {endpoint} \u306ESearXNG\u30B5\u30FC\u30D0\u30FC\u306B\u5230\u9054\u3067\u304D\u307E\u305B\u3093 \u2014 \u5BFE\u51E6: SearXNG\u3092\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB\u3057\u3066\u8D77\u52D5\u3059\u308B\u304B\uFF08https://github.com/searxng/searxng, \u4F8B: `docker run -d -p 8080:8080 searxng/searxng`\uFF09\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u5225\u306E\u30A8\u30F3\u30B8\u30F3\u306B\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    searxngNoResults: "web_search: 0\u4EF6\u306E\u7D50\u679C\u3067\u3059\u304C\u3001SearXNG\u306E\u30EC\u30B9\u30DD\u30F3\u30B9\u304C\u7A7A\u306E\u7D50\u679C\u30DA\u30FC\u30B8\u3068\u306F\u7570\u306A\u308A\u307E\u3059\uFF08{chars}\u6587\u5B57\uFF09\u2014 \u5BFE\u51E6: \u3088\u308A\u7C21\u5358\u306A\u7528\u8A9E\u3067\u30AF\u30A8\u30EA\u3092\u8A00\u3044\u63DB\u3048\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    metasoMissingKey: "web_search: Metaso\u306B\u306FAPI\u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 METASO_API_KEY \u3092\u8A2D\u5B9A\u3059\u308B\u304B\u3001/search-engine metaso <key> \u3067\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002https://metaso.cn/search-api/playground \u304B\u3089\u53D6\u5F97\u3067\u304D\u307E\u3059",
    metasoDailyLimit: "web_search: Metaso\u306E1\u65E5\u3042\u305F\u308A\u306E\u691C\u7D22\u5236\u9650\u306B\u9054\u3057\u307E\u3057\u305F \u2014 METASO_API_KEY \u3092\u8A2D\u5B9A\u3059\u308B\u304B\u3001https://metaso.cn/search-api/playground \u304B\u3089\u30AD\u30FC\u3092\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    metasoUnauthorized: "web_search: Metaso API\u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 METASO_API_KEY \u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001https://metaso.cn/search-api/playground \u304B\u3089\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    metasoRateLimit: "web_search: Metaso\u304C\u30EC\u30FC\u30C8\u5236\u9650\u3055\u308C\u307E\u3057\u305F \u2014 \u5F85\u3063\u3066\u518D\u8A66\u884C\u3059\u308B\u304B\u3001https://metaso.cn/search-api/playground \u304B\u3089\u72EC\u81EA\u306EAPI\u30AD\u30FC\u3092\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    metasoServerError: "web_search: Metaso\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    metasoParseError: "web_search: Metaso\u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    metasoApiError: "web_search: Metaso API\u30A8\u30E9\u30FC (\u30B3\u30FC\u30C9 {code}: {message}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    baiduMissingKey: "web_search: Baidu AI Search\u306B\u306FAPI\u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 BAIDU_API_KEY \u307E\u305F\u306F QIANFAN_API_KEY \u74B0\u5883\u5909\u6570\u3001~/.reasonix/config.json \u306E `baiduApiKey`\u3001\u307E\u305F\u306F /search-engine baidu <key> \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044",
    baiduUnauthorized: "web_search: Baidu AI Search API\u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 BAIDU_API_KEY\u3001QIANFAN_API_KEY\u3001\u307E\u305F\u306F `baiduApiKey` \u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044",
    baiduRateLimit: "web_search: Baidu AI Search\u304C\u30EC\u30FC\u30C8\u5236\u9650\u4E2D\u307E\u305F\u306F\u30AF\u30A9\u30FC\u30BF\u3092\u8D85\u904E\u3057\u307E\u3057\u305F \u2014 \u5F85\u3063\u3066\u304B\u3089\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    baiduServerError: "web_search: Baidu AI Search\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    baiduParseError: "web_search: Baidu AI Search\u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    tavilyMissingKey: "web_search: Tavily\u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u306B\u306FAPI\u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 TAVILY_API_KEY \u74B0\u5883\u5909\u6570\u307E\u305F\u306F ~/.reasonix/config.json \u306E `tavilyApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u7121\u65991000\u56DE/\u6708\u306E\u767B\u9332\u306F https://tavily.com \u304B\u3089",
    tavilyUnauthorized: "web_search: Tavily API\u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 TAVILY_API_KEY \u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001https://tavily.com \u304B\u3089\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    tavilyRateLimit: "web_search: Tavily\u304C\u30EC\u30FC\u30C8\u5236\u9650\u307E\u305F\u306F\u6708\u9593\u30AF\u30A9\u30FC\u30BF\u3092\u8D85\u904E\u3057\u307E\u3057\u305F \u2014 \u5F85\u3064\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u308B\u304B\u3001Tavily\u30D7\u30E9\u30F3\u3092\u30A2\u30C3\u30D7\u30B0\u30EC\u30FC\u30C9\u3057\u3066\u304F\u3060\u3055\u3044",
    tavilyServerError: "web_search: Tavily\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    tavilyParseError: "web_search: Tavily\u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    perplexityMissingKey: "web_search: Perplexity\u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u306B\u306FAPI\u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 PERPLEXITY_API_KEY \u74B0\u5883\u5909\u6570\u307E\u305F\u306F ~/.reasonix/config.json \u306E `perplexityApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002https://perplexity.ai/settings/api \u304B\u3089\u53D6\u5F97\u3067\u304D\u307E\u3059",
    perplexityUnauthorized: "web_search: Perplexity API\u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 PERPLEXITY_API_KEY \u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001https://perplexity.ai/settings/api \u304B\u3089\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    perplexityRateLimit: "web_search: Perplexity\u304C\u30EC\u30FC\u30C8\u5236\u9650\u3055\u308C\u307E\u3057\u305F \u2014 \u5F85\u3063\u3066\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    perplexityServerError: "web_search: Perplexity\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    perplexityParseError: "web_search: Perplexity\u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    exaMissingKey: "web_search: Exa\u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u306B\u306FAPI\u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 EXA_API_KEY \u74B0\u5883\u5909\u6570\u307E\u305F\u306F ~/.reasonix/config.json \u306E `exaApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u7121\u65991000\u56DE/\u6708\u306E\u767B\u9332\u306F https://exa.ai \u304B\u3089",
    exaUnauthorized: "web_search: Exa API\u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 EXA_API_KEY \u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001https://exa.ai \u304B\u3089\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    exaRateLimit: "web_search: Exa API\u304C\u30EC\u30FC\u30C8\u5236\u9650\u307E\u305F\u306F\u6708\u9593\u30AF\u30A9\u30FC\u30BF\u3092\u8D85\u904E\u3057\u307E\u3057\u305F \u2014 \u5F85\u3064\u304B\u3001https://exa.ai/pricing \u3067\u30A2\u30C3\u30D7\u30B0\u30EC\u30FC\u30C9\u3057\u3066\u304F\u3060\u3055\u3044",
    exaServerError: "web_search: Exa\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    exaParseError: "web_search: Exa\u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    braveMissingKey: "web_search: Brave Search\u306B\u306FAPI\u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 BRAVE_SEARCH_API_KEY\uFF08\u307E\u305F\u306F BRAVE_API_KEY\uFF09\u74B0\u5883\u5909\u6570\u3001\u307E\u305F\u306F ~/.reasonix/config.json \u306E `braveApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002https://brave.com/search/api/ \u3067\u67082000\u56DE\u307E\u3067\u7121\u6599\u767B\u9332\u3067\u304D\u307E\u3059",
    braveUnauthorized: "web_search: Brave Search API\u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 BRAVE_SEARCH_API_KEY \u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001https://brave.com/search/api/ \u304B\u3089\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    braveRateLimit: "web_search: Brave Search API\u304C\u30EC\u30FC\u30C8\u5236\u9650\u307E\u305F\u306F\u6708\u9593\u30AF\u30A9\u30FC\u30BF\u3092\u8D85\u904E\u3057\u307E\u3057\u305F \u2014 \u5F85\u3064\u304B\u3001https://brave.com/search/api/ \u3067\u30A2\u30C3\u30D7\u30B0\u30EC\u30FC\u30C9\u3057\u3066\u304F\u3060\u3055\u3044",
    braveServerError: "web_search: Brave Search\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    braveParseError: "web_search: Brave Search\u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    ollamaMissingKey: "Ollama \u306B\u306F API \u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 OLLAMA_API_KEY \u74B0\u5883\u5909\u6570\u3092\u8A2D\u5B9A\u3059\u308B\u304B\u3001~/.reasonix/config.json \u306B `ollamaApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002https://ollama.com/settings/keys \u3067\u53D6\u5F97\u3067\u304D\u307E\u3059",
    ollamaUnauthorized: "Ollama API \u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 OLLAMA_API_KEY \u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001https://ollama.com/settings/keys \u3067\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    ollamaRateLimit: "Ollama \u304C\u30EC\u30FC\u30C8\u5236\u9650\u4E2D\u307E\u305F\u306F\u30AF\u30A9\u30FC\u30BF\u3092\u8D85\u904E\u3057\u307E\u3057\u305F \u2014 \u5F85\u3063\u3066\u304B\u3089\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    ollamaServerError: "Ollama \u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) ({url}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3059\u308B\u304B\u3001/search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u3067\u30A8\u30F3\u30B8\u30F3\u3092\u5207\u308A\u66FF\u3048\u3066\u304F\u3060\u3055\u3044",
    ollamaParseError: "Ollama \u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) ({url}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    fetchOllamaMissingKey: "web_fetch: Ollama \u53D6\u5F97\u306B\u306F API \u30AD\u30FC\u304C\u5FC5\u8981\u3067\u3059 \u2014 OLLAMA_API_KEY \u74B0\u5883\u5909\u6570\u3092\u8A2D\u5B9A\u3059\u308B\u304B\u3001~/.reasonix/config.json \u306B `ollamaApiKey` \u3092\u8A2D\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002https://ollama.com/settings/keys \u3067\u53D6\u5F97\u3067\u304D\u307E\u3059",
    fetchOllamaUnauthorized: "web_fetch: Ollama API \u30AD\u30FC\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F \u2014 OLLAMA_API_KEY \u3092\u78BA\u8A8D\u3059\u308B\u304B\u3001https://ollama.com/settings/keys \u3067\u53D6\u5F97\u3057\u3066\u304F\u3060\u3055\u3044",
    fetchOllamaRateLimit: "web_fetch: Ollama \u53D6\u5F97\u304C\u30EC\u30FC\u30C8\u5236\u9650\u4E2D\u307E\u305F\u306F\u30AF\u30A9\u30FC\u30BF\u3092\u8D85\u904E\u3057\u307E\u3057\u305F \u2014 \u5F85\u3063\u3066\u304B\u3089\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    fetchOllamaServerError: "web_fetch: Ollama \u53D6\u5F97\u30B5\u30FC\u30D0\u30FC\u30A8\u30E9\u30FC ({status}) ({url}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    fetchOllamaParseError: "web_fetch: Ollama \u53D6\u5F97\u304C\u89E3\u6790\u4E0D\u80FD\u306A\u30EC\u30B9\u30DD\u30F3\u30B9\u3092\u8FD4\u3057\u307E\u3057\u305F (HTTP {status}) ({url}) \u2014 \u5F8C\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    fetchStatus: "web_fetch {status} ({url}) \u2014 \u5BFE\u51E6: \u30D6\u30E9\u30A6\u30B6\u3067URL\u304C\u89E3\u6C7A\u3067\u304D\u308B\u304B\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u30B9\u30C6\u30FC\u30BF\u30B9\u306F\u30DB\u30B9\u30C8\u304C\u30A8\u30E9\u30FC\u30DA\u30FC\u30B8\u3092\u8FD4\u3057\u305F\u3053\u3068\u3092\u793A\u3057\u3066\u3044\u307E\u3059",
    fetchRateLimit429: "web_fetch 429 ({url}) \u2014 \u5BFE\u51E6: 10\u79D2\u5F85\u3063\u3066\u304B\u3089\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u30DB\u30B9\u30C8\u304C\u3053\u306E\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u3092\u30EC\u30FC\u30C8\u5236\u9650\u3057\u3066\u3044\u307E\u3059",
    fetchForbidden403: "web_fetch 403 ({url}) \u2014 \u5BFE\u51E6: \u30DB\u30B9\u30C8\u304C\u3053\u306E\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u3092\u30D6\u30ED\u30C3\u30AF\u3057\u3066\u3044\u307E\u3059\u3002\u30DA\u30FC\u30B8\u304C\u30ED\u30B0\u30A4\u30F3\u3092\u5FC5\u8981\u3068\u3059\u308B\u304B\u3001\u30DC\u30C3\u30C8\u3092\u30D6\u30ED\u30C3\u30AF\u3057\u3066\u3044\u308B\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059 \u2014 \u4EE3\u308F\u308A\u306Bweb_search\u306E\u30B9\u30CB\u30DA\u30C3\u30C8\u3092\u4F7F\u7528\u3057\u3066\u304F\u3060\u3055\u3044",
    fetchServerError5xx: "web_fetch {status} ({url}) \u2014 \u5BFE\u51E6: \u30D6\u30E9\u30A6\u30B6\u3067URL\u3092\u958B\u3044\u3066\u307F\u3066\u304F\u3060\u3055\u3044\u3002\u8AAD\u307F\u8FBC\u3081\u308B\u5834\u5408\u306F\u4E00\u6642\u7684\u306A\u554F\u984C\u3067\u300130\u79D2\u5F8C\u306B\u518D\u8A66\u884C\u3059\u308B\u3068\u6539\u5584\u3059\u308B\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059",
    fetchTimeout: "web_fetch: {url} \u304C {ms}ms \u3067\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8\u3057\u307E\u3057\u305F \u2014 \u5BFE\u51E6: \u3088\u308A\u77ED\u3044URL\u304B\u5C0F\u3055\u306A\u30B3\u30F3\u30C6\u30F3\u30C4\u3092\u8A66\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u9045\u3044CDN\u306E\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002\u3082\u3046\u4E00\u5EA6\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044",
    fetchTooLarge: "web_fetch\u62D2\u5426: content-length {len} \u30D0\u30A4\u30C8\u304C {cap} \u30D0\u30A4\u30C8\u306E\u4E0A\u9650\u3092\u8D85\u904E ({url}) \u2014 \u5BFE\u51E6: \u3088\u308A\u5C0F\u3055\u3044\u30B3\u30F3\u30C6\u30F3\u30C4\u306E\u5225\u306EURL\u3092\u8A66\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u3053\u306E\u30DA\u30FC\u30B8\u306F\u5927\u304D\u3059\u304E\u3066\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093",
    fetchBodyTooLarge: "web_fetch\u62D2\u5426: \u30EC\u30B9\u30DD\u30F3\u30B9\u30DC\u30C7\u30A3\u304C {cap} \u30D0\u30A4\u30C8\u306E\u4E0A\u9650\u3092\u8D85\u904E\uFF08{seen} \u30D0\u30A4\u30C8\u78BA\u8A8D\uFF09\u2014 \u5BFE\u51E6: \u3088\u308A\u5C0F\u3055\u3044\u30B3\u30F3\u30C6\u30F3\u30C4\u306E\u5225\u306EURL\u3092\u8A66\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u3053\u306E\u30DA\u30FC\u30B8\u306F\u30B5\u30A4\u30BA\u4E0A\u9650\u3092\u8D85\u3048\u3066\u30B9\u30C8\u30EA\u30FC\u30DF\u30F3\u30B0\u3055\u308C\u307E\u3057\u305F",
    fetchInvalidUrl: "web_fetch: URL\u306F http:// \u307E\u305F\u306F https:// \u3067\u59CB\u307E\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059 \u2014 \u5BFE\u51E6: \u7D76\u5BFEhttp(s) URL\u3092\u6E21\u3057\u3066\u304F\u3060\u3055\u3044\uFF08URL\u304C\u4E0D\u6B63\u304B\u3001\u672A\u5BFE\u5FDC\u306E\u30B9\u30AD\u30FC\u30E0\u3092\u4F7F\u7528\u3057\u3066\u3044\u307E\u3059\uFF09"
  },
  choiceConfirm: {
    ...EN.choiceConfirm,
    customLabel: "\u81EA\u7531\u306B\u56DE\u7B54\u3092\u5165\u529B",
    customDesc: "\u4E0A\u8A18\u306E\u3044\u305A\u308C\u3082\u5F53\u3066\u306F\u307E\u3089\u306A\u3044 \u2014 \u81EA\u7531\u5F62\u5F0F\u3067\u8FD4\u4FE1\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u30E2\u30C7\u30EB\u306F\u305D\u308C\u3092\u305D\u306E\u307E\u307E\u8AAD\u307F\u53D6\u308A\u307E\u3059\u3002",
  ...
  cardLabels: {
    ...
    topTools: "\u4E0A\u4F4D\u30C4\u30FC\u30EB",
    logMsgs: "\u30ED\u30B0\u30E1\u30C3\u30BB\u30FC\u30B8",
    hitSingular: "{count} \u30D2\u30C3\u30C8 \xB7 {files} \u30D5\u30A1\u30A4\u30EB",
    hitsPlural: "{count} \u30D2\u30C3\u30C8 \xB7 {files} \u30D5\u30A1\u30A4\u30EB",
    ...
    stackTrace: "\u30B9\u30BF\u30C3\u30AF\u30C8\u30EC\u30FC\u30B9",
    retries: "\u30EA\u30C8\u30E9\u30A4",
    reasoningLabel: "\u63A8\u8AD6 \xB7 {count} \xB6",
    runningLabel: "\u5B9F\u884C\u4E2D",
    workingLabel: "\u51E6\u7406\u4E2D",
    defaultFooter: "\u2191\u2193 \u9078\u629E  \xB7  \u23CE \u78BA\u5B9A  \xB7  esc \u30AD\u30E3\u30F3\u30BB\u30EB",
    applyAction: "[a] \u9069\u7528",
    skipAction: "[s] \u30B9\u30AD\u30C3\u30D7",
    rejectAction: "[r] \u62D2\u5426",
    levelOk: "OK",
  ...
  mcpHealth: {
    ...
    slow: "\u4F4E\u901F \xB7 {ms}ms",
    verySlow: "\u975E\u5E38\u306B\u4F4E\u901F \xB7 {ms}ms",
    slowToast: "\u26A0 MCP `{name}` \u304C\u4F4E\u901F \xB7 \u76F4\u8FD1 {sampleSize} \u56DE\u306E\u547C\u3073\u51FA\u3057\u3067 p95 {seconds}\u79D2",
    emptyHint: "\u2139 MCP\u30B5\u30FC\u30D0\u30FC\u304C\u8A2D\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093 \u2014 \u5BFE\u51E6: `reasonix setup` \u3067\u518D\u9078\u629E\u3059\u308B\u304B\u3001`reasonix mcp install filesystem` \xB7 \u30B7\u30A7\u30EB\u30B3\u30DE\u30F3\u30C9\u306F\u6BCE\u56DE\u78BA\u8A8D\uFF08allow once / allow always / deny\uFF09\u3001\u5168\u8A31\u53EF\u30D5\u30E9\u30B0\u306A\u3057"
  },
  denyContextInput: {
    ...EN.denyContextInput,
    description: "\u62D2\u5426\u3057\u305F\u7406\u7531\u3092\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8\u306B\u4F1D\u3048\u3066\u304F\u3060\u3055\u3044\u3002\u6B21\u306E\u8A66\u884C\u3067\u306F\u3042\u306A\u305F\u306E\u7406\u7531\u304C\u8FFD\u52A0\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u3068\u3057\u3066\u53C2\u7167\u3055\u308C\u307E\u3059\u3002"
  },
  cardStream: {
    ...EN.cardStream,
    ...
    scrollPgUp: " \xB7 PgUp / \u30DB\u30A4\u30FC\u30EB",
    scrollCopy: " \xB7 /copy \u3067\u30B3\u30D4\u30FC\u30E2\u30FC\u30C9"
  },
  slashArgPicker: {
    ...EN.slashArgPicker,
    ...
    above: "   \u2191 \u4E0A\u306B {hidden} \u4EF6",
    below: "   \u2193 \u4E0B\u306B {hidden} \u4EF6",
    footer: "  \u2191\u2193 \u79FB\u52D5 \xB7 Tab / \u23CE \u9078\u629E \xB7 esc \u30AD\u30E3\u30F3\u30BB\u30EB"
  },
  mcpMarketplace: {
    ...EN.mcpMarketplace,
    title: "MCP \u30DE\u30FC\u30B1\u30C3\u30C8\u30D7\u30EC\u30A4\u30B9",
    ...
    bridgeReloadFailed: "\u2713 {name} \u3092\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB - `reasonix code` \u3092\u518D\u8D77\u52D5\u3057\u3066\u30D6\u30EA\u30C3\u30B8\uFF08\u518D\u8AAD\u8FBC\u5931\u6557: {message}\uFF09",
    restartBridge: "\u2713 {name} \u3092\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB - `reasonix code` \u3092\u518D\u8D77\u52D5\u3057\u3066\u30D6\u30EA\u30C3\u30B8",
    needsEnv: "  \xB7  \u8981\u74B0\u5883\u5909\u6570: {env}",
    badgeOfficial: "[\u516C\u5F0F]",
    badgeSmithery: "[smt]",
    badgeLocal: "[\u30ED\u30FC\u30AB\u30EB]",
    footerHint: "\u30D5\u30A3\u30EB\u30BF\u5165\u529B \xB7 \u2191\u2193 \u9078\u629E \xB7 \u23CE \u30A4\u30F3\u30B9\u30C8\u30FC\u30EB/\u5207\u66FF \xB7 PgDn \u3055\u3089\u306B\u8AAD\u8FBC \xB7 esc \u9589\u3058\u308B",
    specLine: "\u4ED5\u69D8: {runtime} {id} \xB7 {transport}",
  ...
  mcpBrowser: {
    ...
    footer: "\u2191\u2193 \u9078\u629E \xB7 [r] \u518D\u63A5\u7D9A \xB7 [d] \u7121\u52B9\u5316 \xB7 esc \u7D42\u4E86"
  },
  mcpBrowse: {
    ...EN.mcpBrowse,
    noResources: "\u63A5\u7D9A\u3055\u308C\u305FMCP\u30B5\u30FC\u30D0\u30FC\u306B\u30EA\u30BD\u30FC\u30B9\u304C\u3042\u308A\u307E\u305B\u3093\uFF08\u307E\u305F\u306F\u30B5\u30FC\u30D0\u30FC\u304C\u63A5\u7D9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\uFF09\u3002`/mcp` \u3067\u73FE\u5728\u306E\u8A2D\u5B9A\u3092\u8868\u793A\u3057\u307E\u3059\u3002",
    readOne: "\u8AAD\u307F\u53D6\u308A: `/resource <uri>` \u2014 \u307E\u305F\u306F\u30D4\u30C3\u30AB\u30FC\u3067Tab\u3092\u4F7F\u7528\u3002",
    noPrompts: "\u63A5\u7D9A\u3055\u308C\u305FMCP\u30B5\u30FC\u30D0\u30FC\u306B\u30D7\u30ED\u30F3\u30D7\u30C8\u304C\u3042\u308A\u307E\u305B\u3093\uFF08\u307E\u305F\u306F\u30B5\u30FC\u30D0\u30FC\u304C\u63A5\u7D9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093\uFF09\u3002`/mcp` \u3067\u73FE\u5728\u306E\u8A2D\u5B9A\u3092\u8868\u793A\u3057\u307E\u3059\u3002",
    fetchOne: "\u53D6\u5F97: `/prompt <name>` \u2014 \u5F15\u6570\u306F\u307E\u3060\u30B5\u30DD\u30FC\u30C8\u3055\u308C\u3066\u3044\u307E\u305B\u3093\u3002\u5FC5\u9808\u5F15\u6570\u304C\u3042\u308B\u30D7\u30ED\u30F3\u30D7\u30C8\u306F\u30B5\u30FC\u30D0\u30FC\u304B\u3089\u30A8\u30E9\u30FC\u304C\u8FD4\u308A\u307E\u3059\u3002",
  ...
  mcpLifecycle: {
    ...
    reconnectDetail: "\u5207\u65AD\u4E2D \xB7 \u518D\u30CF\u30F3\u30C9\u30B7\u30A7\u30A4\u30AF \xB7 \u30C4\u30FC\u30EB\u4E00\u89A7\u53D6\u5F97",
    disabledDetail: "/mcp disable {name} \u7D4C\u7531",
    failedSetupHint: "\u2192 `reasonix setup` \u3092\u5B9F\u884C\u3057\u3066\u3053\u306E\u30A8\u30F3\u30C8\u30EA\u3092\u524A\u9664\u3059\u308B\u304B\u3001\u6839\u672C\u7684\u306A\u554F\u984C\uFF08npm\u30D1\u30C3\u30B1\u30FC\u30B8\u4E0D\u8DB3\u3001\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u306A\u3069\uFF09\u3092\u4FEE\u6B63\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    failedSetupConfigHint: "\u2192 `reasonix setup` \u3092\u5B9F\u884C\u3057\u3066\u3001\u4FDD\u5B58\u3055\u308C\u305F\u8A2D\u5B9A\u304B\u3089\u58CA\u308C\u305F\u30A8\u30F3\u30C8\u30EA\u3092\u524A\u9664\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    abortedHint: "MCP\u8D77\u52D5\u304C\u4E2D\u65AD\u3055\u308C\u307E\u3057\u305F \u2014 {count} \u30B5\u30FC\u30D0\u30FC\u304C\u30B9\u30AD\u30C3\u30D7\u3055\u308C\u307E\u3057\u305F\u3002\u6839\u672C\u7684\u306A\u554F\u984C\u3092\u4FEE\u6B63\u3057\u305F\u5F8C\u3001/mcp \u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
    toolsReady: "\u30C4\u30FC\u30EB\u6E96\u5099\u5B8C\u4E86",
    warnLabel: "\u8B66\u544A"
  },
  checkpointPicker: {
    ...
    header: " \u25C8 REASONIX \xB7 \u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8\u3092\u9078\u629E ",
    empty: "  \u3053\u306E\u30EF\u30FC\u30AF\u30B9\u30DA\u30FC\u30B9\u306B\u306F\u307E\u3060\u30C1\u30A7\u30C3\u30AF\u30DD\u30A4\u30F3\u30C8\u304C\u3042\u308A\u307E\u305B\u3093 - /checkpoint \u3067\u4F5C\u6210\u3057\u3066\u304F\u3060\u3055\u3044",
    more: "     \u2026 \u3055\u3089\u306B {hidden} \u4EF6",
    footer: "  \u2191\u2193 \u9078\u629E  \xB7  \u23CE \u5FA9\u5143  \xB7  [d] \u524A\u9664  \xB7  esc \u7D42\u4E86",
    footerEmpty: "  esc \u7D42\u4E86"
  },
  planReviseConfirm: {
    ...EN.planReviseConfirm,
    title: "\u30D7\u30E9\u30F3\u4FEE\u6B63\u6848",
    metaRight: "\u2212{removed}  +{added}  \xB7  {kept} \u4FDD\u6301",
  ...
  replayApp: {
    ...
    noRecords: "\u30EC\u30B3\u30FC\u30C9\u306A\u3057",
    untracked: "\uFF08\u672A\u8FFD\u8DE1\uFF09",
    churned: "\uFF08\u30C1\u30E3\u30FC\u30F3 \xD7{count}\uFF09"
  },
  builtinSkills: {
    ...EN.builtinSkills,
    explore: "\u30B3\u30FC\u30C9\u30D9\u30FC\u30B9\u3092\u5206\u96E2\u30B5\u30D6\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8\u3067\u8ABF\u67FB \u2014 \u5E83\u7BC4\u56F2\u306E\u8AAD\u307F\u53D6\u308A\u5C02\u7528\u8ABF\u67FB\u30671\u3064\u306E\u8981\u7D04\u3055\u308C\u305F\u56DE\u7B54\u3092\u8FD4\u3057\u307E\u3059\u3002\u6700\u9069: \u300C\u301C\u3092\u4F7F\u7528\u3057\u3066\u3044\u308B\u5834\u6240\u3092\u3059\u3079\u3066\u898B\u3064\u3051\u3066\u300D\u300CX\u306F\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u5168\u4F53\u3067\u3069\u306E\u3088\u3046\u306B\u52D5\u4F5C\u3059\u308B\u304B\u300D\u300CY\u306E\u30B3\u30FC\u30C9\u3092\u8ABF\u67FB\u3057\u3066\u300D\u3002",
    research: "Web\u691C\u7D22\u3068\u30B3\u30FC\u30C9\u8AAD\u307F\u53D6\u308A\u3092\u7D44\u307F\u5408\u308F\u305B\u3066\u5206\u96E2\u30B5\u30D6\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8\u3067\u8CEA\u554F\u3092\u8ABF\u67FB\u3057\u307E\u3059\u3002\u6700\u9069: \u300CX\u6A5F\u80FD\u306F\u30E9\u30A4\u30D6\u30E9\u30EAY\u3067\u30B5\u30DD\u30FC\u30C8\u3055\u308C\u3066\u3044\u308B\u304B\u300D\u300CZ\u306E\u6A19\u6E96\u7684\u306A\u65B9\u6CD5\u306F\u300D\u300C\u79C1\u305F\u3061\u306E\u5B9F\u88C5\u3092\u4ED5\u69D8\u3068\u6BD4\u8F03\u3057\u3066\u300D\u3002",
    review: "\u4FDD\u7559\u4E2D\u306E\u5909\u66F4\uFF08\u30C7\u30D5\u30A9\u30EB\u30C8\u3067\u306F\u73FE\u5728\u306E\u30D6\u30E9\u30F3\u30C1\u5DEE\u5206\uFF09\u3092\u5206\u96E2\u30B5\u30D6\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8\u3067\u30EC\u30D3\u30E5\u30FC \u2014 \u6B63\u78BA\u6027\u3001\u30BB\u30AD\u30E5\u30EA\u30C6\u30A3\u3001\u4E0D\u8DB3\u30C6\u30B9\u30C8\u3001\u96A0\u308C\u305F\u52D5\u4F5C\u5909\u66F4\u3092\u6307\u6458\u3002\u5224\u5B9A\u3068\u554F\u984C\u3054\u3068\u306E\u30D5\u30A1\u30A4\u30EB:\u884C\u3092\u5831\u544A\u3002\u8AAD\u307F\u53D6\u308A\u5C02\u7528\u3002\u89AA\u304C\u5BFE\u5FDC\u3092\u6C7A\u5B9A\u3057\u307E\u3059\u3002",
    securityReview: "\u73FE\u5728\u306E\u30D6\u30E9\u30F3\u30C1\u5DEE\u5206\u306E\u30BB\u30AD\u30E5\u30EA\u30C6\u30A3\u91CD\u8996\u30EC\u30D3\u30E5\u30FC\u3092\u5206\u96E2\u30B5\u30D6\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8\u3067\u5B9F\u884C \u2014 \u30A4\u30F3\u30B8\u30A7\u30AF\u30B7\u30E7\u30F3/\u8A8D\u8A3C/\u30B7\u30FC\u30AF\u30EC\u30C3\u30C8/\u30C7\u30B7\u30EA\u30A2\u30E9\u30A4\u30BC\u30FC\u30B7\u30E7\u30F3/\u30D1\u30B9\u30C8\u30E9\u30D0\u30FC\u30B5\u30EB/\u6697\u53F7\u306E\u554F\u984C\u3092\u91CD\u8981\u5EA6\u30BF\u30B0\u4ED8\u304D\u3067\u6307\u6458\u3002\u8AAD\u307F\u53D6\u308A\u5C02\u7528\u3002\u8A8D\u8A3C\u3001\u5165\u529B\u89E3\u6790\u3001\u30D5\u30A1\u30A4\u30EBIO\u3001\u5916\u90E8\u30EA\u30AF\u30A8\u30B9\u30C8\u306B\u95A2\u308F\u308B\u5909\u66F4\u3092\u30EA\u30EA\u30FC\u30B9\u3059\u308B\u969B\u306B\u4F7F\u7528\u3057\u307E\u3059\u3002",
  ...
  mcpCli: {
    ...
    allLoaded: "\u5168\u4EF6\u8AAD\u307F\u8FBC\u307F\u6E08\u307F",
    morePagesAvailable: "\u25B8 \u3055\u3089\u306B\u30DA\u30FC\u30B8\u304C\u3042\u308A\u307E\u3059 \u2014 `reasonix mcp list --pages <n>` \u307E\u305F\u306F --all",
    ...
    installed: "\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB\u6E08\u307F: {spec}",
    noServerFound: '{source} \u30EC\u30B8\u30B9\u30C8\u30EA\u306E {pages} \u30DA\u30FC\u30B8\u3092\u8D70\u67FB\u3057\u307E\u3057\u305F\u304C\u3001"{target}" \u3068\u3044\u3046\u540D\u524D\u306EMCP\u30B5\u30FC\u30D0\u30FC\u306F\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F\u3002',
    noServerTryMore: "\u8A66\u3059: reasonix mcp install {target} --max-pages 100",
    noInstallMeta: '"{name}" \u306E\u30A4\u30F3\u30B9\u30C8\u30FC\u30EB\u30E1\u30BF\u30C7\u30FC\u30BF\u3092\u5C0E\u51FA\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F \u2014 `npx -y @smithery/cli install {name}` \u3092\u76F4\u63A5\u8A66\u3057\u3066\u304F\u3060\u3055\u3044\u3002',
...
var de = {
  ...
  slash: {
    ...
    "max-tokens": {
      ...EN.slash["max-tokens"],
      description: "Ausgabe-Token pro Turn begrenzen \u2014 verhindert ausufernde Reasoning-Schleifen. Standardm\xE4\xDFig aus. Allein zeigt Status."
    },
    ...
    "cache-miss-report": {
      ...
      description: "Erkl\xE4rt j\xFCngste Prompt-Cache-Misses anhand lokaler Prefix-Evidenz"
    },
    context: {
      ...EN.slash.context,
    ...
    "search-engine": {
      ...
      description: "Web-Search-Backend wechseln \u2014 bing (Standard, funktioniert von CN ohne Proxy), bing-intl (internationaler Index), searxng (selbst gehostet), metaso (kostenlos 100/Tag), tavily (kostenlos 1000/Monat), perplexity (AI-native), exa (AI-native), brave (unabh\xE4ngiger Index) oder ollama (Ollama Cloud-Websuche)"
    },
    theme: {
      ...EN.slash.theme,
      argsHint: "[auto|graphite|ember|aurora|sandstone|porcelain|linen|glacier|midnight]",
  ...
  wizard: {
    ...
    themeCaption: {
      ...EN.wizard.themeCaption,
      graphite: "Originale dunkle Palette mit neutralen Graphit-Fl\xE4chen",
      ember: "Warmes dunkles Theme mit st\xE4rkerem Reasonix-Orange",
      aurora: "T\xFCrkisgr\xFCnes dunkles Theme f\xFCr weicheres Arbeiten bei wenig Licht",
      sandstone: "Originale warme helle Palette",
      porcelain: "Klares helles Theme mit ruhigem Kontrast",
      linen: "Redaktionelles warmes helles Theme mit papierartigen Fl\xE4chen",
      glacier: "K\xFChles helles Theme mit klaren blauen Akzenten",
      midnight: "Marineblaues dunkles Theme mit k\xFChlen blauen Fl\xE4chen",
      dark: "K\xFChle dunkle T\xF6ne (Legacy-Alias)",
  ...
  handlers: {
    ...
    permissions: {
      ...
      globalHeader: "Globale Allowlist ({count}) \u2014 gilt f\xFCr alle Projekte",
      globalNone: "  (keine \u2014 mit `/permissions add --global <prefix>` hinzuf\xFCgen.)",
      addGlobalInfo: "\u25B8 zur globalen Allowlist hinzugef\xFCgt: {prefix}\n  \u2192 der n\xE4chste Aufruf von `{prefix}` l\xE4uft in jedem Projekt ohne R\xFCckfrage.",
      removeGlobalEmpty: "\u25B8 keine Eintr\xE4ge in der globalen Allowlist zum Entfernen.",
      clearGlobalConfirm: "{count} Eintr\xE4ge der globalen Allowlist werden entfernt. Mit dem Wort 'confirm' erneut ausf\xFChren: /permissions clear --global confirm",
    ...
    webSearchEngine: {
      ...
      usageBingIntl: "  /search-engine bing-intl          Bing International verwenden (www.bing.com, indexiert GitHub/Wikipedia/Stack Overflow)",
      ...
      usageBaidu: "  /search-engine baidu               Baidu AI Search API verwenden (laut Baidu-Doku 1500/Monat kostenlos \u2014 BAIDU_API_KEY oder QIANFAN_API_KEY setzen)",
      ...
      usageOllama: "  /search-engine ollama                Ollama Cloud-Web-Suche verwenden \u2014 setze OLLAMA_API_KEY oder ollamaApiKey in der Konfiguration; Schl\xFCssel unter https://ollama.com/settings/keys",
      ...
      switchedBaiduNote: " Setze BAIDU_API_KEY, QIANFAN_API_KEY oder `baiduApiKey` in der Konfiguration; die Baidu-Doku nennt 1500 kostenlose Suchen pro Monat.",
  ...
  webErrors: {
    ...EN.webErrors,
    status: "web_search {status} \u2014 versuche: Das Such-Backend hat einen Fehler zur\xFCckgegeben; formuliere die Abfrage um oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    forbidden403: "web_search 403 \u2014 versuche: Das Such-Backend blockiert diesen Client; wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama oder warte und versuche es sp\xE4ter erneut",
    ...
    bingBlocked: "web_search: Bing-Anti-Bot-Seite \u2014 Rate-Limit erreicht oder blockiert \u2014 versuche: 30s warten und erneut versuchen, oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    bingNoResults: "web_search: 0 Ergebnisse, aber die Antwort sieht nicht wie eine echte leere Seite aus ({chars} Zeichen, erste 120: {preview}) \u2014 versuche: formuliere die Abfrage mit einfacheren Begriffen um oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    cannotReach: "web_search: SearXNG-Server unter {endpoint} nicht erreichbar \u2014 versuche: SearXNG installieren und starten (https://github.com/searxng/searxng, z.B. `docker run -d -p 8080:8080 searxng/searxng`), oder wechsle zu einer anderen Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    searxngNoResults: "web_search: 0 Ergebnisse, aber SearXNG-Antwort sieht nicht wie eine leere Ergebnisseite aus ({chars} Zeichen) \u2014 versuche: formuliere die Abfrage mit einfacheren Begriffen um oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    metasoServerError: "web_search: Metaso-Serverfehler ({status}) \u2014 versuche es sp\xE4ter erneut oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    tavilyRateLimit: "web_search: Tavily-Rate-Limit erreicht oder monatliches Kontingent \xFCberschritten \u2014 warte, wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama oder upgrade deinen Tavily-Plan",
    tavilyServerError: "web_search: Tavily-Serverfehler ({status}) \u2014 versuche es sp\xE4ter erneut oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    perplexityRateLimit: "web_search: Perplexity-Rate-Limit erreicht \u2014 warte und versuche es erneut, oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    perplexityServerError: "web_search: Perplexity-Serverfehler ({status}) \u2014 versuche es sp\xE4ter erneut oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    exaServerError: "web_search: Exa-Serverfehler ({status}) \u2014 versuche es sp\xE4ter erneut oder wechsle die Engine mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    braveServerError: "web_search: Fehler beim Brave-Suchserver ({status}) \u2014 sp\xE4ter erneut versuchen oder die Engine wechseln mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ...
    ollamaMissingKey: "Ollama ben\xF6tigt einen API-Schl\xFCssel \u2014 setze die Umgebungsvariable OLLAMA_API_KEY oder `ollamaApiKey` in ~/.reasonix/config.json; Schl\xFCssel unter https://ollama.com/settings/keys",
    ollamaUnauthorized: "Ollama API-Schl\xFCssel abgelehnt \u2014 OLLAMA_API_KEY pr\xFCfen oder neuen Schl\xFCssel unter https://ollama.com/settings/keys holen",
    ollamaRateLimit: "Ollama ist ratenbegrenzt oder das Kontingent ist \xFCberschritten \u2014 warten und erneut versuchen oder Engine wechseln mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ollamaServerError: "Ollama-Serverfehler ({status}) f\xFCr {url} \u2014 sp\xE4ter erneut versuchen oder Engine wechseln mit /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ollamaParseError: "Ollama hat eine nicht auswertbare Antwort zur\xFCckgegeben (HTTP {status}) f\xFCr {url} \u2014 sp\xE4ter erneut versuchen",
    fetchOllamaMissingKey: "web_fetch: Ollama-Abruf ben\xF6tigt einen API-Schl\xFCssel \u2014 OLLAMA_API_KEY Umgebungsvariable oder `ollamaApiKey` in der Konfiguration setzen; Schl\xFCssel unter https://ollama.com/settings/keys",
    fetchOllamaUnauthorized: "web_fetch: Ollama API-Schl\xFCssel abgelehnt \u2014 OLLAMA_API_KEY pr\xFCfen oder neuen Schl\xFCssel unter https://ollama.com/settings/keys holen",
    fetchOllamaRateLimit: "web_fetch: Ollama-Abruf ist ratenbegrenzt oder Kontingent \xFCberschritten \u2014 warten und erneut versuchen",
    fetchOllamaServerError: "web_fetch: Ollama-Abruf Serverfehler ({status}) f\xFCr {url} \u2014 sp\xE4ter erneut versuchen",
    fetchOllamaParseError: "web_fetch: Ollama-Abruf hat eine nicht auswertbare Antwort zur\xFCckgegeben (HTTP {status}) f\xFCr {url} \u2014 sp\xE4ter erneut versuchen",
...
var ru = {
  ...
  webErrors: {
    ...
    braveServerError: "web_search: \u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 Brave Search ({status}) \u2014 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435 \u0438\u043B\u0438 \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u0440\u0443\u0433\u043E\u0439 \u043F\u043E\u0438\u0441\u043A\u043E\u0432\u0438\u043A \u0441 \u043F\u043E\u043C\u043E\u0449\u044C\u044E /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    braveParseError: "web_search: Brave Search \u0432\u0435\u0440\u043D\u0443\u043B \u043D\u0435\u0440\u0430\u0437\u0431\u043E\u0440\u0447\u0438\u0432\u044B\u0439 \u043E\u0442\u0432\u0435\u0442 (HTTP {status}) \u2014 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435",
    ollamaMissingKey: "web_search: \u0414\u043B\u044F Ollama \u0442\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044F \u043A\u043B\u044E\u0447 API \u2014 \u0437\u0430\u0434\u0430\u0439\u0442\u0435 \u043F\u0435\u0440\u0435\u043C\u0435\u043D\u043D\u0443\u044E \u0441\u0440\u0435\u0434\u044B OLLAMA_API_KEY \u0438\u043B\u0438 \u043F\u0430\u0440\u0430\u043C\u0435\u0442\u0440 `ollamaApiKey` \u0432 ~/.reasonix/config.json; \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043A\u043B\u044E\u0447 \u043C\u043E\u0436\u043D\u043E \u043D\u0430 https://ollama.com/settings/keys",
    ollamaUnauthorized: "web_search: \u041A\u043B\u044E\u0447 API Ollama \u043E\u0442\u043A\u043B\u043E\u043D\u0451\u043D \u2014 \u043F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 OLLAMA_API_KEY \u0438\u043B\u0438 \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u0435 \u043D\u043E\u0432\u044B\u0439 \u043D\u0430 https://ollama.com/settings/keys",
    ollamaRateLimit: "web_search: Ollama \u043F\u0440\u0435\u0432\u044B\u0441\u0438\u043B \u043B\u0438\u043C\u0438\u0442 \u0438\u043B\u0438 \u043A\u0432\u043E\u0442\u0443 \u2014 \u043F\u043E\u0434\u043E\u0436\u0434\u0438\u0442\u0435 \u0438 \u043F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u0435 \u0438\u043B\u0438 \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u0440\u0443\u0433\u043E\u0439 \u043F\u043E\u0438\u0441\u043A\u043E\u0432\u0438\u043A: /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ollamaServerError: "web_search: \u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 Ollama ({status}) ({url}) \u2014 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435 \u0438\u043B\u0438 \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u0440\u0443\u0433\u043E\u0439 \u043F\u043E\u0438\u0441\u043A\u043E\u0432\u0438\u043A \u0441 \u043F\u043E\u043C\u043E\u0449\u044C\u044E /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama",
    ollamaParseError: "web_search: Ollama \u0432\u0435\u0440\u043D\u0443\u043B \u043D\u0435\u0440\u0430\u0437\u0431\u043E\u0440\u0447\u0438\u0432\u044B\u0439 \u043E\u0442\u0432\u0435\u0442 (HTTP {status}) ({url}) \u2014 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435",
    fetchOllamaMissingKey: "web_fetch: \u0414\u043B\u044F \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u044F \u0447\u0435\u0440\u0435\u0437 Ollama \u0442\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044F \u043A\u043B\u044E\u0447 API \u2014 \u0437\u0430\u0434\u0430\u0439\u0442\u0435 OLLAMA_API_KEY \u0438\u043B\u0438 `ollamaApiKey` \u0432 \u043A\u043E\u043D\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u0438; \u043A\u043B\u044E\u0447 \u043D\u0430 https://ollama.com/settings/keys",
    fetchOllamaUnauthorized: "web_fetch: \u041A\u043B\u044E\u0447 API Ollama \u043E\u0442\u043A\u043B\u043E\u043D\u0451\u043D \u2014 \u043F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 OLLAMA_API_KEY \u0438\u043B\u0438 \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u0435 \u043D\u043E\u0432\u044B\u0439 \u043D\u0430 https://ollama.com/settings/keys",
    fetchOllamaRateLimit: "web_fetch: \u041F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u0435 \u0447\u0435\u0440\u0435\u0437 Ollama \u043F\u0440\u0435\u0432\u044B\u0441\u0438\u043B\u043E \u043B\u0438\u043C\u0438\u0442 \u0438\u043B\u0438 \u043A\u0432\u043E\u0442\u0443 \u2014 \u043F\u043E\u0434\u043E\u0436\u0434\u0438\u0442\u0435 \u0438 \u043F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u0435 \u043F\u043E\u043F\u044B\u0442\u043A\u0443",
    fetchOllamaServerError: "web_fetch: \u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 Ollama \u043F\u0440\u0438 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u0438 ({status}) ({url}) \u2014 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435",
    fetchOllamaParseError: "web_fetch: Ollama \u0432\u0435\u0440\u043D\u0443\u043B \u043D\u0435\u0440\u0430\u0437\u0431\u043E\u0440\u0447\u0438\u0432\u044B\u0439 \u043E\u0442\u0432\u0435\u0442 \u043F\u0440\u0438 \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u0438 (HTTP {status}) ({url}) \u2014 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043F\u043E\u0437\u0436\u0435"
  },
  handlers: {
    ...EN.handlers,
    webSearchEngine: {
      ...EN.handlers.webSearchEngine,
      usageBingIntl: "  /search-engine bing-intl          \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u044C Bing International (www.bing.com, \u0438\u043D\u0434\u0435\u043A\u0441\u0438\u0440\u0443\u0435\u0442 GitHub/Wikipedia/Stack Overflow)",
      usageOllama: "  /search-engine ollama              \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u044C \u043E\u0431\u043B\u0430\u0447\u043D\u044B\u0439 \u0432\u0435\u0431-\u043F\u043E\u0438\u0441\u043A Ollama \u2014 \u0437\u0430\u0434\u0430\u0439\u0442\u0435 OLLAMA_API_KEY \u0438\u043B\u0438 ollamaApiKey \u0432 \u043A\u043E\u043D\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u0438; \u043A\u043B\u044E\u0447 \u043D\u0430 https://ollama.com/settings/keys",
      ...
      switchedOllamaNote: " \u0423\u043A\u0430\u0436\u0438\u0442\u0435 OLLAMA_API_KEY \u0438\u043B\u0438 `ollamaApiKey` \u0432 \u0444\u0430\u0439\u043B\u0435 \u043A\u043E\u043D\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u0438; \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043A\u043B\u044E\u0447 \u043C\u043E\u0436\u043D\u043E \u043D\u0430 https://ollama.com/settings/keys.",
...
var zhCN = {
  ...
  ui: {
    ...
    systemPromptChangedDetail: "REASONIX.md \u6216\u8BB0\u5FC6\u6587\u4EF6\u53D1\u751F\u4E86\u66F4\u6539 \u2014 \u672C\u8F6E\u5C06\u4EA7\u751F\u5B8C\u6574\u7F13\u5B58 miss\u3002\u53EF\u4F7F\u7528 /new \u4EE5\u66F4\u65B0\u540E\u7684\u4E0A\u4E0B\u6587\u5F00\u59CB\u65B0\u4F1A\u8BDD\u3002",
  ...
  slash: {
    ...
    diff: {
      description: "\u914D\u7F6E edit_file / write_file diff \u7684\u663E\u793A\u65B9\u5F0F\uFF1Asummary\uFF08\u8DEF\u5F84 +\u7EDF\u8BA1\uFF0C\u9ED8\u8BA4\uFF09\xB7 full\uFF08unified diff\uFF09\xB7 none\uFF08\u4EC5\u52FE\u9009\uFF09",
      argsHint: "[summary|full|none]"
    },
    ...
    "search-engine": {
      description: "\u5207\u6362\u7F51\u7EDC\u641C\u7D22\u540E\u7AEF \u2014 bing\uFF08\u9ED8\u8BA4\uFF0C\u56FD\u5185\u88F8 IP \u76F4\u8FDE\uFF09\u3001bing-intl\uFF08\u56FD\u9645\u7248\u7D22\u5F15\uFF09\u3001searxng\uFF08\u81EA\u6258\u7BA1\uFF09\u3001metaso\uFF08\u6BCF\u65E5 100 \u6B21\uFF09\u3001baidu\uFF08\u767E\u5EA6 AI Search\uFF0C\u5B98\u65B9\u6587\u6863\u5199\u6709\u6BCF\u6708 1500 \u6B21\u514D\u8D39\u989D\u5EA6\uFF09\u3001tavily\uFF08\u6BCF\u6708 1000 \u6B21\u514D\u8D39\uFF09\u3001perplexity\uFF08AI \u76F4\u63A5\u56DE\u7B54\uFF09\u3001exa\uFF08AI \u76F4\u63A5\u56DE\u7B54\uFF09\u3001brave\uFF08\u72EC\u7ACB\u7D22\u5F15\uFF09\u6216 ollama\uFF08Ollama \u4E91\u7AEF\u641C\u7D22\uFF09",
      argsHint: "<bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama> [<key>]"
    }
  },
  wizard: {
  ...
  app: {
    ...
    explicitPlanIntentArmed: "\u25B8 \u68C0\u6D4B\u5230\u660E\u786E\u7684\u5148\u89C4\u5212\u8BF7\u6C42 \u2014 \u5DF2\u542F\u7528 strict lifecycle\u3002\u53EF\u7528 /plan off \u9000\u51FA\u3002",
  ...
  loop: {
    ...
    iterLimitReached: "\u5DF2\u8FBE\u5230\u5355\u8F6E\u8FED\u4EE3\u4E0A\u9650\uFF08{max} \u6B21\u5DE5\u5177\u8C03\u7528\u8F6E\u6B21\uFF09\u3002\u6B63\u5728\u5F3A\u5236\u603B\u7ED3\u5DF2\u6536\u96C6\u7684\u5185\u5BB9\u3002\u53EF\u901A\u8FC7\u914D\u7F6E maxIterPerTurn \u6216 REASONIX_MAX_ITER \u73AF\u5883\u53D8\u91CF\u8C03\u6574\u4E0A\u9650\u3002"
  },
  errors: {
  ...
  handlers: {
    ...
    sessions: {
      ...
      persistSetOff: "\u25B8 session-persist \u5DF2\u8BBE\u4E3A off \u2014 \u4E0B\u6B21\u542F\u52A8\u5C06\u5F00\u542F\u65B0\u4F1A\u8BDD\u3002\u4F7F\u7528 -c/--continue \u53EF\u663E\u5F0F\u6062\u590D\u3002",
    ...
    qq: {
      ...
      runtimeBound: "QQ \u5DF2\u5728\u672C\u6B21\u8FD0\u884C\u4E2D\u4E34\u65F6\u7ED1\u5B9A\u5230\u9996\u4E2A\u53D1\u9001\u8005 {openid}\u3002\u5982\u679C\u4F60\u5E0C\u671B\u56FA\u5B9A\u7ED1\u5B9A\u5230\u8FD9\u4E2A\u8D26\u53F7\uFF0C\u53EF\u4EE5\u5728 QQ \u8BBE\u7F6E\u4E2D\u624B\u52A8\u6307\u5B9A\u3002",
    ...
    telegram: {
      ...
      promptBotToken: "Telegram \u9996\u6B21\u914D\u7F6E\uFF1A\u8BF7\u8F93\u5165 BotFather \u63D0\u4F9B\u7684 bot token \u540E\u56DE\u8F66\u3002\u8F93\u5165 /cancel \u53EF\u53D6\u6D88\u3002",
      ...
      status: "Telegram\uFF1A{connected}\uFF0C\u81EA\u52A8\u542F\u52A8{enabled}\uFF0C\u51ED\u636E{configured}\uFF0CbotToken {botToken}\uFF0C\u8BBF\u95EE\u63A7\u5236 {access}\uFF0C\u5F53\u524D\u6A21\u5F0F {mode}\u3002",
      ...
      lockAlreadyRunning: "Telegram \u901A\u9053\u5DF2\u5728\u8FDB\u7A0B {pid} \u4E2D\u8FD0\u884C\u3002\u8BF7\u5148\u505C\u6B62\u8BE5\u8FDB\u7A0B\uFF0C\u518D\u542F\u52A8\u65B0\u7684 Telegram \u901A\u9053\u3002",
      unauthorizedMessage: "Telegram \u5FFD\u7565\u4E86\u672A\u6388\u6743\u7528\u6237 {userId} \u7684\u6D88\u606F\u3002\u5F53\u524D\u8BBF\u95EE\u63A7\u5236\uFF1A{access}\u3002",
      runtimeBound: "Telegram \u5DF2\u5728\u672C\u6B21\u8FD0\u884C\u4E2D\u4E34\u65F6\u7ED1\u5B9A\u5230\u9996\u4E2A\u53D1\u9001\u8005 {userId}\u3002\u5982\u9700\u6301\u4E45\u5316\uFF0C\u8BF7\u5728\u914D\u7F6E\u4E2D\u8BBE\u7F6E `telegram.ownerUserId`\u3002",
      missingBotToken: "\u7F3A\u5C11 Telegram bot token\u3002\u8BF7\u5148\u8FD0\u884C `/telegram connect` \u5B8C\u6210\u914D\u7F6E\u3002",
      accessRequired: "Telegram \u542F\u52A8\u524D\u5FC5\u987B\u914D\u7F6E\u8BBF\u95EE\u63A7\u5236\u3002\u8BF7\u5728\u914D\u7F6E\u4E2D\u8BBE\u7F6E `telegram.ownerUserId` \u6216 `telegram.allowlist`\u3002",
    ...
    weixin: {
      ...
      usage: "\u7528\u6CD5\uFF1A/weixin connect | /weixin connect manual [token accountId [baseUrl]] | /weixin status | /weixin disconnect",
      promptCredentials: "\u5FAE\u4FE1\u624B\u52A8\u914D\u7F6E\uFF1A\u8BF7\u8F93\u5165 iLink token \u548C\u8D26\u53F7 id\uFF0C\u4E2D\u95F4\u7528\u7A7A\u683C\u5206\u9694\u540E\u56DE\u8F66\u3002\u8F93\u5165 /cancel \u53EF\u53D6\u6D88\u3002",
      ...
      status: "\u5FAE\u4FE1\uFF1A{connected}\uFF0C\u81EA\u52A8\u542F\u52A8{enabled}\uFF0C\u51ED\u636E{configured}\uFF0Ctoken {token}\uFF0C\u8D26\u53F7 {accountId}\uFF0C\u8BBF\u95EE\u63A7\u5236 {access}\uFF0C\u5F53\u524D\u6A21\u5F0F {mode}\u3002",
      ...
      runtimeBound: "\u5FAE\u4FE1\u5DF2\u5728\u672C\u6B21\u8FD0\u884C\u4E2D\u4E34\u65F6\u7ED1\u5B9A\u5230\u9996\u4E2A\u53D1\u9001\u8005 {userId}\u3002\u5982\u9700\u6301\u4E45\u5316\uFF0C\u8BF7\u5728\u914D\u7F6E\u4E2D\u8BBE\u7F6E `weixin.ownerUserId`\u3002",
      missingToken: "\u7F3A\u5C11\u5FAE\u4FE1 iLink token\u3002\u8BF7\u5148\u8FD0\u884C `/weixin connect` \u5B8C\u6210\u914D\u7F6E\u3002",
      missingAccountId: "\u7F3A\u5C11\u5FAE\u4FE1\u8D26\u53F7 id\u3002\u8BF7\u5148\u8FD0\u884C `/weixin connect` \u5B8C\u6210\u914D\u7F6E\u3002",
      accessRequired: "\u5FAE\u4FE1\u542F\u52A8\u524D\u5FC5\u987B\u914D\u7F6E\u8BBF\u95EE\u63A7\u5236\u3002\u8BF7\u5728\u914D\u7F6E\u4E2D\u8BBE\u7F6E `weixin.ownerUserId` \u6216 `weixin.allowlist`\u3002",
    ...
    model: {
      ...
      maxTokensNoCap: "max-tokens \u2192 \u65E0\u9650\u5236\uFF08\u4F7F\u7528\u670D\u52A1\u7AEF\u9ED8\u8BA4\u503C \xB7 /max-tokens <N> \u8BBE\u7F6E\u4E0A\u9650\uFF09",
      ...
      maxTokensUsage: "\u7528\u6CD5\uFF1A/max-tokens <\u6B63\u6574\u6570>   \u4F8B\u5982 /max-tokens 4096  \xB7  /max-tokens off"
    },
    diff: {
    ...
    permissions: {
      ...
      addGlobalInfo: "\u25B8 \u5DF2\u6DFB\u52A0\u5230\u5168\u5C40\u5141\u8BB8\u5217\u8868\uFF1A{prefix}\n  \u2192 \u4E4B\u540E `{prefix}` \u5728\u6240\u6709\u9879\u76EE\u4E2D\u6267\u884C\u90FD\u4E0D\u518D\u8BE2\u95EE\u3002",
      removeGlobalEmpty: "\u25B8 \u5168\u5C40\u5141\u8BB8\u5217\u8868\u6CA1\u6709\u53EF\u5220\u9664\u7684\u6761\u76EE\u3002",
      clearGlobalConfirm: "\u5C06\u6E05\u9664 {count} \u6761\u5168\u5C40\u5141\u8BB8\u5217\u8868\u6761\u76EE\u3002\u8BF7\u52A0\u4E0A 'confirm' \u91CD\u65B0\u6267\u884C\uFF1A/permissions clear --global confirm",
    ...
    webSearchEngine: {
      ...
      usageBingIntl: "  /search-engine bing-intl          \u4F7F\u7528 Bing \u56FD\u9645\u7248\uFF08www.bing.com\uFF0C\u53EF\u641C GitHub/Wikipedia/Stack Overflow\uFF09",
      ...
      usageBaidu: "  /search-engine baidu               \u4F7F\u7528\u767E\u5EA6 AI Search API\uFF08\u5B98\u65B9\u6587\u6863\u5199\u6709\u6BCF\u6708 1500 \u6B21\u514D\u8D39\u989D\u5EA6 \u2014 \u8BBE\u7F6E BAIDU_API_KEY \u6216 QIANFAN_API_KEY\uFF09",
      ...
      switchedBaiduNote: " \u8BF7\u8BBE\u7F6E BAIDU_API_KEY\u3001QIANFAN_API_KEY \u6216 config \u4E2D\u7684 `baiduApiKey`\uFF1B\u767E\u5EA6\u5B98\u65B9\u6587\u6863\u5199\u6709\u6BCF\u6708 1500 \u6B21\u514D\u8D39\u989D\u5EA6\u3002",
  ...
  webErrors: {
    status: "web_search {status} \u2014 try: \u641C\u7D22\u540E\u7AEF\u8FD4\u56DE\u9519\u8BEF\uFF1B\u8BF7\u6539\u5199\u67E5\u8BE2\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    rateLimit429: "web_search 429 \u2014 try: \u7B49\u5F85 10 \u79D2\u540E\u91CD\u8BD5\uFF0C\u6216\u6539\u5199\u67E5\u8BE2\uFF1B\u641C\u7D22\u540E\u7AEF\u6B63\u5728\u5BF9\u8BE5\u5BA2\u6237\u7AEF\u8FDB\u884C\u9650\u6D41",
    forbidden403: "web_search 403 \u2014 try: \u641C\u7D22\u540E\u7AEF\u62D2\u7EDD\u8BE5\u5BA2\u6237\u7AEF\u8BBF\u95EE\uFF1B\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE\uFF0C\u6216\u7A0D\u540E\u91CD\u8BD5",
    serverError5xx: "web_search {status} \u2014 try: \u5728\u6D4F\u89C8\u5668\u4E2D\u6253\u5F00\u641C\u7D22 URL\uFF1B\u82E5\u80FD\u52A0\u8F7D\u5219\u5C5E\u4E34\u65F6\u6545\u969C\uFF0C\u7B49 30 \u79D2\u91CD\u8BD5\u5373\u53EF",
    bingBlocked: "web_search: Bing \u53CD\u722C\u9875\u9762 \u2014 \u9891\u7387\u9650\u5236\u6216\u88AB\u5C4F\u853D \u2014 try: \u7B49\u5F85 30 \u79D2\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    bingNoResults: "web_search: \u8FD4\u56DE 0 \u6761\u7ED3\u679C\u4F46\u54CD\u5E94\u770B\u8D77\u6765\u4E0D\u662F\u6B63\u5E38\u7A7A\u7ED3\u679C\u9875\uFF08{chars} \u5B57\u7B26\uFF0C\u524D 120 \u5B57\u7B26\uFF1A{preview}\uFF09\u2014 try: \u4F7F\u7528\u66F4\u7B80\u5355\u7684\u5173\u952E\u8BCD\u6539\u5199\u67E5\u8BE2\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ...
    cannotReach: "web_search: \u65E0\u6CD5\u8BBF\u95EE SearXNG \u670D\u52A1\u5668 {endpoint} \u2014 try: \u5B89\u88C5\u5E76\u542F\u52A8 SearXNG\uFF08https://github.com/searxng/searxng\uFF0C\u4F8B\u5982 `docker run -d -p 8080:8080 searxng/searxng`\uFF09\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    searxngNoResults: "web_search: \u8FD4\u56DE 0 \u6761\u7ED3\u679C\u4F46 SearXNG \u54CD\u5E94\u770B\u8D77\u6765\u4E0D\u662F\u6B63\u5E38\u7A7A\u7ED3\u679C\u9875\uFF08{chars} \u5B57\u7B26\uFF09\u2014 try: \u4F7F\u7528\u66F4\u7B80\u5355\u7684\u5173\u952E\u8BCD\u6539\u5199\u67E5\u8BE2\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ...
    metasoServerError: "web_search: Metaso \u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 \u7A0D\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ...
    baiduMissingKey: "web_search: \u767E\u5EA6 AI Search \u9700\u8981 API \u5BC6\u94A5 \u2014 \u8BBE\u7F6E BAIDU_API_KEY \u6216 QIANFAN_API_KEY \u73AF\u5883\u53D8\u91CF\uFF0C\u5728 ~/.reasonix/config.json \u914D\u7F6E `baiduApiKey`\uFF0C\u6216\u8FD0\u884C /search-engine baidu <key>\uFF1B\u53EF\u5728\u767E\u5EA6\u667A\u80FD\u4E91\u5343\u5E06\u83B7\u53D6\u5BC6\u94A5",
    baiduUnauthorized: "web_search: \u767E\u5EA6 AI Search API \u5BC6\u94A5\u88AB\u62D2\u7EDD \u2014 \u68C0\u67E5 BAIDU_API_KEY\u3001QIANFAN_API_KEY \u6216 `baiduApiKey`",
    baiduRateLimit: "web_search: \u767E\u5EA6 AI Search \u8BF7\u6C42\u9891\u7387\u9650\u5236\u6216\u914D\u989D\u7528\u5C3D \u2014 \u7B49\u5F85\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    baiduServerError: "web_search: \u767E\u5EA6 AI Search \u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 \u7A0D\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ...
    tavilyRateLimit: "web_search: Tavily \u8BF7\u6C42\u9891\u7387\u9650\u5236\u6216\u6708\u5EA6\u914D\u989D\u7528\u5C3D \u2014 \u7B49\u5F85\u3001\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE\uFF0C\u6216\u5347\u7EA7 Tavily \u8BA1\u5212",
    tavilyServerError: "web_search: Tavily \u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 \u7A0D\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ...
    perplexityRateLimit: "web_search: Perplexity \u8BF7\u6C42\u9891\u7387\u9650\u5236 \u2014 \u7B49\u5F85\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    perplexityServerError: "web_search: Perplexity \u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 \u7A0D\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ...
    exaServerError: "web_search: Exa \u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 \u7A0D\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ...
    braveServerError: "web_search: Brave Search \u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 \u7A0D\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    braveParseError: "web_search: Brave Search \u8FD4\u56DE\u65E0\u6CD5\u89E3\u6790\u7684\u54CD\u5E94\uFF08HTTP {status}\uFF09\u2014 \u7A0D\u540E\u91CD\u8BD5",
    ollamaMissingKey: "Ollama \u9700\u8981 API \u5BC6\u94A5 \u2014 \u8BBE\u7F6E OLLAMA_API_KEY \u73AF\u5883\u53D8\u91CF\uFF0C\u6216\u5728 ~/.reasonix/config.json \u4E2D\u914D\u7F6E `ollamaApiKey`\uFF1B\u5728 https://ollama.com/settings/keys \u83B7\u53D6\u5BC6\u94A5",
    ollamaUnauthorized: "Ollama API \u5BC6\u94A5\u88AB\u62D2\u7EDD \u2014 \u68C0\u67E5 OLLAMA_API_KEY \u6216\u5728 https://ollama.com/settings/keys \u83B7\u53D6\u5BC6\u94A5",
    ollamaRateLimit: "Ollama \u8BF7\u6C42\u9891\u7387\u9650\u5236\u6216\u914D\u989D\u7528\u5C3D \u2014 \u7B49\u5F85\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ollamaServerError: "Ollama \u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 {url} \u2014 \u7A0D\u540E\u91CD\u8BD5\uFF0C\u6216\u4F7F\u7528 /search-engine bing|bing-intl|searxng|metaso|baidu|tavily|perplexity|exa|brave|ollama \u5207\u6362\u5F15\u64CE",
    ollamaParseError: "Ollama \u8FD4\u56DE\u65E0\u6CD5\u89E3\u6790\u7684\u54CD\u5E94\uFF08HTTP {status}\uFF09\u2014 {url} \u2014 \u7A0D\u540E\u91CD\u8BD5",
    fetchOllamaMissingKey: "web_fetch: Ollama \u6293\u53D6\u9700\u8981 API \u5BC6\u94A5 \u2014 \u8BBE\u7F6E OLLAMA_API_KEY \u73AF\u5883\u53D8\u91CF\uFF0C\u6216\u5728 ~/.reasonix/config.json \u4E2D\u914D\u7F6E `ollamaApiKey`\uFF1B\u5728 https://ollama.com/settings/keys \u83B7\u53D6\u5BC6\u94A5",
    fetchOllamaUnauthorized: "web_fetch: Ollama API \u5BC6\u94A5\u88AB\u62D2\u7EDD \u2014 \u68C0\u67E5 OLLAMA_API_KEY \u6216\u5728 https://ollama.com/settings/keys \u83B7\u53D6\u5BC6\u94A5",
    fetchOllamaRateLimit: "web_fetch: Ollama \u6293\u53D6\u8FBE\u5230\u901F\u7387\u9650\u5236\u6216\u914D\u989D\u7528\u5C3D \u2014 \u7B49\u5F85\u540E\u91CD\u8BD5",
    fetchOllamaServerError: "web_fetch: Ollama \u6293\u53D6\u670D\u52A1\u5668\u9519\u8BEF\uFF08{status}\uFF09\u2014 {url} \u2014 \u7A0D\u540E\u91CD\u8BD5",
    fetchOllamaParseError: "web_fetch: Ollama \u6293\u53D6\u8FD4\u56DE\u65E0\u6CD5\u89E3\u6790\u7684\u54CD\u5E94\uFF08HTTP {status}\uFF09\u2014 {url} \u2014 \u7A0D\u540E\u91CD\u8BD5",
  ...
  builtinSkills: {
    explore: "\u7528\u9694\u79BB\u5B50 agent \u63A2\u7D22\u6574\u4E2A\u4EE3\u7801\u5E93\uFF0C\u505A\u5E7F\u8986\u76D6\u3001\u53EA\u8BFB\u5F0F\u8C03\u67E5\uFF0C\u5E76\u8FD4\u56DE\u4E00\u6761\u63D0\u70BC\u540E\u7684\u7ED3\u8BBA\u3002\u9002\u5408\uFF1A\u67E5\u627E\u67D0\u7C7B\u5B9E\u73B0\u4F4D\u7F6E\u3001\u7406\u89E3\u67D0\u4E2A\u673A\u5236\u5728\u9879\u76EE\u4E2D\u7684\u6574\u4F53\u8109\u7EDC\u3001\u5FEB\u901F\u626B\u6E05\u67D0\u4E2A\u4E3B\u9898\u3002",
    research: "\u7528\u9694\u79BB\u5B50 agent \u7ED3\u5408\u7F51\u9875\u641C\u7D22\u548C\u4EE3\u7801\u9605\u8BFB\u6765\u7814\u7A76\u95EE\u9898\u3002\u9002\u5408\uFF1A\u786E\u8BA4\u67D0\u4E2A\u5E93\u662F\u5426\u652F\u6301\u67D0\u80FD\u529B\u3001\u67E5\u5B98\u65B9\u505A\u6CD5\u3001\u628A\u5F53\u524D\u5B9E\u73B0\u4E0E\u89C4\u8303\u6216\u6700\u4F73\u5B9E\u8DF5\u5BF9\u7167\u3002",
    review: "\u7528\u9694\u79BB\u5B50 agent \u5BA1\u67E5\u5F53\u524D\u5F85\u53D8\u66F4\u5185\u5BB9\uFF0C\u91CD\u70B9\u627E\u6B63\u786E\u6027\u95EE\u9898\u3001\u5B89\u5168\u98CE\u9669\u3001\u7F3A\u5931\u6D4B\u8BD5\u548C\u9690\u85CF\u884C\u4E3A\u53D8\u5316\uFF0C\u5E76\u7ED9\u51FA\u7ED3\u8BBA\u4E0E\u6587\u4EF6\u4F4D\u7F6E\u3002\u53EA\u8BFB\uFF1B\u662F\u5426\u91C7\u7EB3\u7531\u4E3B\u4F1A\u8BDD\u51B3\u5B9A\u3002",
    securityReview: "\u7528\u9694\u79BB\u5B50 agent \u505A\u5B89\u5168\u4E13\u9879\u5BA1\u67E5\uFF0C\u91CD\u70B9\u68C0\u67E5\u6CE8\u5165\u3001\u9274\u6743\u3001\u5BC6\u94A5\u6CC4\u9732\u3001\u53CD\u5E8F\u5217\u5316\u3001\u8DEF\u5F84\u7A7F\u8D8A\u548C\u52A0\u5BC6\u76F8\u5173\u95EE\u9898\uFF0C\u5E76\u6309\u4E25\u91CD\u6027\u6807\u8BB0\u3002\u9002\u5408\u6D89\u53CA\u9274\u6743\u3001\u8F93\u5165\u89E3\u6790\u3001\u6587\u4EF6 IO \u6216\u5916\u90E8\u8BF7\u6C42\u7684\u6539\u52A8\u3002",
...
//# sourceMappingURL=chunk-4ETZ2I36.js.map