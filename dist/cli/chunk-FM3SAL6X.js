...
function SingleSelect({
  ...
  )), footer ? /* @__PURE__ */ import_react2.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react2.default.createElement(Text, { color: FG.faint }, footer)) : null);
}
...
function SelectRow({
  ...
  if (inlineHint) {
    return /* @__PURE__ */ import_react2.default.createElement(Box_default, { flexDirection: "row", flexWrap: "nowrap", minHeight: 1 }, /* @__PURE__ */ import_react2.default.createElement(Text, { color: item.disabled ? FG.faint : rowColor, bold: active, wrap: "truncate" }, labelText), item.hint ? /* @__PURE__ */ import_react2.default.createElement(Text, { color: FG.faint, wrap: "truncate" }, `  ${item.hint}`) : null);
  }
  return /* @__PURE__ */ import_react2.default.createElement(Box_default, { flexDirection: "column" }, /* @__PURE__ */ import_react2.default.createElement(Box_default, null, /* @__PURE__ */ import_react2.default.createElement(Text, { color: item.disabled ? FG.faint : rowColor, bold: active }, labelText)), item.hint ? /* @__PURE__ */ import_react2.default.createElement(Box_default, { paddingLeft: marker.length + 1 }, /* @__PURE__ */ import_react2.default.createElement(Text, { color: FG.faint }, item.hint)) : null);
}
...
//# sourceMappingURL=chunk-FM3SAL6X.js.map