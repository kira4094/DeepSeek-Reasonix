...
function RecordView({ rec, compact = false }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(Box_default, null, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, "[", rec.role, "] ", rec.content));
}
function CacheBadge({ usage }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(Text, null, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("recordView.cache")), /* @__PURE__ */ import_react.default.createElement(Text, { color }, pct.toFixed(1), "%"));
}
...
//# sourceMappingURL=chunk-RSQEXXP3.js.map