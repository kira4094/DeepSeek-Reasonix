...
import {
  ...
  SingleSelect,
  themeChoiceLabel
} from "./chunk-FM3SAL6X.js";
import {
  ThemeProvider,
  useTheme
} from "./chunk-AZCMURQM.js";
import {
  Box_default,
  Text,
  TextInput,
  ...
  const content = (() => {
    ...
    if (step === "review") {
      ...
      return /* @__PURE__ */ import_react.default.createElement(StepFrame, { title: t("wizard.reviewTitle"), step: 2, total: 2 }, /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column" }, /* @__PURE__ */ import_react.default.createElement(
        ...
        /* @__PURE__ */ import_react.default.createElement(Box_default, { key: i, paddingLeft: 14 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, "\xB7 ", spec))
      )), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, null, t("wizard.reviewSavesTo", { path: defaultConfigPath() }))), error ? /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: "ansi:red" }, error)) : null, /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.reviewFooter")))), /* @__PURE__ */ import_react.default.createElement(
        ReviewConfirm,
        {
          onConfirm: () => {
            try {
    ...
    return /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column", borderStyle: "round", borderColor: "ansi:green", paddingX: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { bold: true, color: "ansi:green" }, t("wizard.savedTitle")), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, null, t("ui.welcome"))), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.savedShellHint"))), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.savedFooter"))), /* @__PURE__ */ import_react.default.createElement(ExitOnEnter, { onExit: exit }));
  })();
...
function ThemeStep({
  ...
  const initialIndex = Math.max(
    0,
    THEME_NAMES.indexOf(resolvedInitial)
  );
  ...
  return /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column", borderStyle: "round", borderColor: theme.tone.brand, paddingX: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { bold: true, color: theme.tone.brand }, t("wizard.themeTitle")), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.themeSubtitle"))), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1, flexDirection: "column" }, THEME_NAMES.map((name, i) => /* @__PURE__ */ import_react.default.createElement(Box_default, { key: name }, /* @__PURE__ */ import_react.default.createElement(Text, { color: i === index ? theme.tone.brand : void 0 }, i === index ? "\u25B8 " : "  "), /* @__PURE__ */ import_react.default.createElement(Text, { bold: i === index, color: i === index ? theme.fg.strong : theme.fg.body }, themeChoiceLabel(name)), /* @__PURE__ */ import_react.default.createElement(Text, { color: theme.fg.meta }, " \u2014 "), /* @__PURE__ */ import_react.default.createElement(Text, { color: theme.fg.meta }, t(`wizard.themeCaption.${name}`))))), /* @__PURE__ */ import_react.default.createElement(
    Box_default,
    {
      marginTop: 1,
  ...
  ), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.themeFooter"))));
}
function LanguageStep({
  ...
  return /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column", borderStyle: "round", borderColor: "ansi:cyan", paddingX: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { bold: true, color: "ansi:cyan" }, t("wizard.languageTitle")), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.languageSubtitle"))), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(
    SingleSelect,
    {
      items,
      initialValue,
...
function ApiKeyStep({
  ...
  return /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column", borderStyle: "round", borderColor: "ansi:cyan", paddingX: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { bold: true, color: "ansi:cyan" }, t("wizard.welcomeTitle")), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, null, t("wizard.apiKeyPrompt"))), /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.apiKeyGetOne")), /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.apiKeySavedLocally", { path: defaultConfigPath() })), initialValue ? /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.apiKeyPreview", { redacted: redactKey(initialValue) })) : null, /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { bold: true, color: "ansi:cyan" }, t("wizard.apiKeyInputLabel")), /* @__PURE__ */ import_react.default.createElement(
    TextInput,
    {
      value,
      onChange: setValue,
  ...
  )), checking ? /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: "ansi:yellow" }, t("wizard.apiKeyChecking"))) : error ? /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: "ansi:red" }, error)) : value ? /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.apiKeyPreview", { redacted: redactKey(value) }))) : null);
}
...
function McpArgsStep({
  ...
  if (pendingCreate) {
    return /* @__PURE__ */ import_react.default.createElement(StepFrame, { title: t("wizard.mcpArgsTitle", { name: entry.name }), step: 2, total: 3 }, /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column" }, /* @__PURE__ */ import_react.default.createElement(Text, null, t("wizard.mcpArgsDirMissing", { path: pendingCreate })), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.mcpArgsDirCreateHint"))), error ? /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: "ansi:red" }, error)) : null));
  }
  return /* @__PURE__ */ import_react.default.createElement(StepFrame, { title: t("wizard.mcpArgsTitle", { name: entry.name }), step: 2, total: 3 }, /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column" }, /* @__PURE__ */ import_react.default.createElement(Text, null, entry.summary), entry.note ? /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, entry.note)) : null, /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, null, t("wizard.mcpArgsRequiredParam")), /* @__PURE__ */ import_react.default.createElement(Text, { bold: true }, entry.userArgs)), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1 }, /* @__PURE__ */ import_react.default.createElement(Text, { bold: true, color: "ansi:cyan" }, entry.userArgs, " \u203A "), /* @__PURE__ */ import_react.default.createElement(
    TextInput,
    {
      value,
      onChange: setValue,
...
function StepFrame({
  ...
  return /* @__PURE__ */ import_react.default.createElement(Box_default, { flexDirection: "column", borderStyle: "round", borderColor: "ansi:cyan", paddingX: 1 }, /* @__PURE__ */ import_react.default.createElement(Box_default, null, /* @__PURE__ */ import_react.default.createElement(Text, { color: FG.faint }, t("wizard.stepCounter", { step, total })), /* @__PURE__ */ import_react.default.createElement(Text, { bold: true, color: "ansi:cyan" }, title)), /* @__PURE__ */ import_react.default.createElement(Box_default, { marginTop: 1, flexDirection: "column" }, children));
}
...
//# sourceMappingURL=setup-Y7BI2XCJ.js.map